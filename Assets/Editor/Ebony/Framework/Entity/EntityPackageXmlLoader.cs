...
namespace Ebony.Framework.Entity
{
    public class EntityPackageXmlLoader
    {
        ...
        /// The load result.
        /// </summary>
        private EntityPackageCreatingResult Result { get; } = new EntityPackageCreatingResult();
        ...
        public EntityPackage CreateEntityPackage(byte[] xmbDoc)
        {
            ...
            this.SetCurrentDocument(xmbDoc);
        ...
        private void SetCurrentDocument(byte[] xmbDoc)
        {
            ...
            this.CurrentDocument = xmbDoc;
            this.SetupSourceElements();
        }
        ...
        {
            if (this.ObjectIndexMap.ContainsKey(objectIndex))
            {
                return this.ObjectElementList[this.ObjectIndexMap[objectIndex]];
            }

            throw null;
        }

        private Luminous.Core.Object.Object GetObjectByIndex(int objectIndex)
        {
            if (this.ObjectIndexMap.ContainsKey(objectIndex))
            {
                return this.Objects[this.ObjectIndexMap[objectIndex]];
            }
