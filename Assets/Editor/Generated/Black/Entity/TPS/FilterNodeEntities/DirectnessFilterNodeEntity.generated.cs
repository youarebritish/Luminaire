...
namespace Black.Entity.TPS.FilterNodeEntities
{
    public partial class DirectnessFilterNodeEntity : Black.Entity.TPS.FilterDescriptorNodeEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.TPS.FilterNodeEntities.DirectnessFilterNodeEntity", 0, Black.Entity.TPS.FilterNodeEntities.DirectnessFilterNodeEntity.ObjectType, Construct, properties, 0, 328);
        }
        ...
        {
            return new DirectnessFilterNodeEntity();
        }
