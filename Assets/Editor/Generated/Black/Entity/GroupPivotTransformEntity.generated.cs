...
namespace Black.Entity
{
    public partial class GroupPivotTransformEntity : Black.Entity.TransformEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.GroupPivotTransformEntity", 0, Black.Entity.GroupPivotTransformEntity.ObjectType, Construct, properties, 0, 256);
        }
        ...
        {
            return new GroupPivotTransformEntity();
        }
