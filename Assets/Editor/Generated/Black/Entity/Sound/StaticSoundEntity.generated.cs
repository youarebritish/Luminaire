...
namespace Black.Entity.Sound
{
    ...
    public partial class StaticSoundEntity : Black.Entity.TransformEntity
    {
		...
		[UnityEngine.SerializeReference] public List<Black.Entity.Sound.StaticSoundPositionArrayItem> positionEntityList_= new List<Black.Entity.Sound.StaticSoundPositionArrayItem>();
		public float pan;
		public float frpan;
		public float udpan;
