...
namespace Black.Entity.Menu
{
    public partial class StatusMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.StatusMenuEntity", 0, Black.Entity.Menu.StatusMenuEntity.ObjectType, Construct, properties, 0, 704);
        }
