...
namespace Black.Entity.Menu
{
    public partial class ImageSelectMenuEntityBase : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ImageSelectMenuEntityBase", 0, Black.Entity.Menu.ImageSelectMenuEntityBase.ObjectType, Construct, properties, 0, 544);
        }
        ...
        {
            return new ImageSelectMenuEntityBase();
        }
