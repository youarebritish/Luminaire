...
namespace Black.Entity.Menu
{
    public partial class PhotoMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.PhotoMenuEntity", 0, Black.Entity.Menu.PhotoMenuEntity.ObjectType, Construct, properties, 0, 816);
        }
