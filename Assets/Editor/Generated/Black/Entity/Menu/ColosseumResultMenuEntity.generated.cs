...
namespace Black.Entity.Menu
{
    public partial class ColosseumResultMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ColosseumResultMenuEntity", 0, Black.Entity.Menu.ColosseumResultMenuEntity.ObjectType, Construct, properties, 0, 496);
        }
        ...
        {
            return new ColosseumResultMenuEntity();
        }
