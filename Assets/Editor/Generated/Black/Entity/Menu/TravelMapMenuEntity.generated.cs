...
namespace Black.Entity.Menu
{
    public partial class TravelMapMenuEntity : Black.Entity.Menu.MapMenuEntityBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.TravelMapMenuEntity", 0, Black.Entity.Menu.TravelMapMenuEntity.ObjectType, Construct, properties, 0, 816);
        }
        ...
        {
            return new TravelMapMenuEntity();
        }
