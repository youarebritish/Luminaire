...
namespace Black.Entity.Menu
{
    public partial class TitleMasterEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.TitleMasterEntity", 0, Black.Entity.Menu.TitleMasterEntity.ObjectType, Construct, properties, 0, 512);
        }
