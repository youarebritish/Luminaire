...
namespace Black.Entity.Menu
{
    public partial class RefuelGaugeEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.RefuelGaugeEntity", 0, Black.Entity.Menu.RefuelGaugeEntity.ObjectType, Construct, properties, 0, 512);
        }
