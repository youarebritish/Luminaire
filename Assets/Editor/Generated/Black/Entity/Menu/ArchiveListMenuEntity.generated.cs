...
namespace Black.Entity.Menu
{
    public partial class ArchiveListMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ArchiveListMenuEntity", 0, Black.Entity.Menu.ArchiveListMenuEntity.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new ArchiveListMenuEntity();
        }
