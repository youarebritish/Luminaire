...
namespace Black.Entity.Menu
{
    public partial class PDTitleOptionMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.PDTitleOptionMenuEntity", 0, Black.Entity.Menu.PDTitleOptionMenuEntity.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new PDTitleOptionMenuEntity();
        }
