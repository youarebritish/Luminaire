...
namespace Black.Entity.Menu
{
    public partial class CertificateMenuEntityEPI : Black.Entity.Menu.CertificateMenuEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.CertificateMenuEntityEPI", 0, Black.Entity.Menu.CertificateMenuEntityEPI.ObjectType, Construct, properties, 0, 3712);
        }
        ...
        {
            return new CertificateMenuEntityEPI();
        }
