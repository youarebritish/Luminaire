...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerEquipMenuEntity : Black.Entity.Menu.StateMenuBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerEquipMenuEntity", 0, Black.Entity.Menu.MultiPlayerEquipMenuEntity.ObjectType, Construct, properties, 0, 832);
        }
        ...
        {
            return new MultiPlayerEquipMenuEntity();
        }
