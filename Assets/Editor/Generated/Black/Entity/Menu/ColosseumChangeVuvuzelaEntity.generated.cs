...
namespace Black.Entity.Menu
{
    public partial class ColosseumChangeVuvuzelaEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ColosseumChangeVuvuzelaEntity", 0, Black.Entity.Menu.ColosseumChangeVuvuzelaEntity.ObjectType, Construct, properties, 0, 592);
        }
        ...
        {
            return new ColosseumChangeVuvuzelaEntity();
        }
