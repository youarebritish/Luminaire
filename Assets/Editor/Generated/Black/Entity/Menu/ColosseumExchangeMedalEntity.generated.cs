...
namespace Black.Entity.Menu
{
    public partial class ColosseumExchangeMedalEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ColosseumExchangeMedalEntity", 0, Black.Entity.Menu.ColosseumExchangeMedalEntity.ObjectType, Construct, properties, 0, 528);
        }
        ...
        {
            return new ColosseumExchangeMedalEntity();
        }
