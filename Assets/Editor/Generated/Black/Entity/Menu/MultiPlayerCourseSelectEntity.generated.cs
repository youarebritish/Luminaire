...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerCourseSelectEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerCourseSelectEntity", 0, Black.Entity.Menu.MultiPlayerCourseSelectEntity.ObjectType, Construct, properties, 0, 784);
        }
        ...
        {
            return new MultiPlayerCourseSelectEntity();
        }
