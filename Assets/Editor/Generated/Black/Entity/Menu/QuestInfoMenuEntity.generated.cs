...
namespace Black.Entity.Menu
{
    public partial class QuestInfoMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.QuestInfoMenuEntity", 0, Black.Entity.Menu.QuestInfoMenuEntity.ObjectType, Construct, properties, 0, 576);
        }
        ...
        {
            return new QuestInfoMenuEntity();
        }
