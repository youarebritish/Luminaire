...
namespace Black.Entity.Menu
{
    public partial class HelpMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.HelpMenuEntity", 0, Black.Entity.Menu.HelpMenuEntity.ObjectType, Construct, properties, 0, 1024);
        }
