...
namespace Black.Entity.Menu
{
    public partial class SpecialAttackMenuEntityEPI : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.SpecialAttackMenuEntityEPI", 0, Black.Entity.Menu.SpecialAttackMenuEntityEPI.ObjectType, Construct, properties, 0, 528);
        }
        ...
        {
            return new SpecialAttackMenuEntityEPI();
        }
