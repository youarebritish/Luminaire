...
namespace Black.Entity.Menu
{
    public partial class DinerUseGilMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.DinerUseGilMenuEntity", 0, Black.Entity.Menu.DinerUseGilMenuEntity.ObjectType, Construct, properties, 0, 496);
        }
        ...
        {
            return new DinerUseGilMenuEntity();
        }
