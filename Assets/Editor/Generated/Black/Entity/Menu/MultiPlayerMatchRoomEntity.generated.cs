...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerMatchRoomEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerMatchRoomEntity", 0, Black.Entity.Menu.MultiPlayerMatchRoomEntity.ObjectType, Construct, properties, 0, 704);
        }
        ...
        {
            return new MultiPlayerMatchRoomEntity();
        }
