...
namespace Black.Entity.Menu
{
    public partial class BattleMenuEntityEPG : Black.Entity.Menu.BattleMenuEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.BattleMenuEntityEPG", 0, Black.Entity.Menu.BattleMenuEntityEPG.ObjectType, Construct, properties, 0, 784);
        }
        ...
        {
            return new BattleMenuEntityEPG();
        }
