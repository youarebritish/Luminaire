...
namespace Black.Entity.Menu
{
    public partial class SaveLoadMenuEntityEPG : Black.Entity.Menu.SaveLoadMenuEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.SaveLoadMenuEntityEPG", 0, Black.Entity.Menu.SaveLoadMenuEntityEPG.ObjectType, Construct, properties, 0, 816);
        }
        ...
        {
            return new SaveLoadMenuEntityEPG();
        }
