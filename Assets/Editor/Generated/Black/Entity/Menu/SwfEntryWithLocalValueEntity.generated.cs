...
namespace Black.Entity.Menu
{
    public partial class SwfEntryWithLocalValueEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.SwfEntryWithLocalValueEntity", 0, Black.Entity.Menu.SwfEntryWithLocalValueEntity.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new SwfEntryWithLocalValueEntity();
        }
