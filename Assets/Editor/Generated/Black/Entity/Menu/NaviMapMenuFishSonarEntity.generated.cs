...
namespace Black.Entity.Menu
{
    public partial class NaviMapMenuFishSonarEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.NaviMapMenuFishSonarEntity", 0, Black.Entity.Menu.NaviMapMenuFishSonarEntity.ObjectType, Construct, properties, 0, 880);
        }
        ...
        {
            return new NaviMapMenuFishSonarEntity();
        }
