...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerDialogPictureMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerDialogPictureMenuEntity", 0, Black.Entity.Menu.MultiPlayerDialogPictureMenuEntity.ObjectType, Construct, properties, 0, 816);
        }
        ...
        {
            return new MultiPlayerDialogPictureMenuEntity();
        }
