...
namespace Black.Entity.Menu
{
    public partial class GilInfoHudEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.GilInfoHudEntity", 0, Black.Entity.Menu.GilInfoHudEntity.ObjectType, Construct, properties, 0, 624);
        }
