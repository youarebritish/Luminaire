...
namespace Black.Entity.Menu
{
    public partial class MagicMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MagicMenuEntity", 0, Black.Entity.Menu.MagicMenuEntity.ObjectType, Construct, properties, 0, 752);
        }
