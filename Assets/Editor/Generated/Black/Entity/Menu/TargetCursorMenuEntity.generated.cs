...
namespace Black.Entity.Menu
{
    public partial class TargetCursorMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.TargetCursorMenuEntity", 0, Black.Entity.Menu.TargetCursorMenuEntity.ObjectType, Construct, properties, 0, 576);
        }
        ...
        {
            return new TargetCursorMenuEntity();
        }
