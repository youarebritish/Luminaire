...
namespace Black.Entity.Menu
{
    public partial class ExchangeItemMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ExchangeItemMenuEntity", 0, Black.Entity.Menu.ExchangeItemMenuEntity.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new ExchangeItemMenuEntity();
        }
