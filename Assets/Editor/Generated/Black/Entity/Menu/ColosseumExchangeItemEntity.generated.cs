...
namespace Black.Entity.Menu
{
    public partial class ColosseumExchangeItemEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ColosseumExchangeItemEntity", 0, Black.Entity.Menu.ColosseumExchangeItemEntity.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new ColosseumExchangeItemEntity();
        }
