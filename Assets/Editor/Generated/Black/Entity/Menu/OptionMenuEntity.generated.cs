...
namespace Black.Entity.Menu
{
    public partial class OptionMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.OptionMenuEntity", 0, Black.Entity.Menu.OptionMenuEntity.ObjectType, Construct, properties, 0, 944);
        }
