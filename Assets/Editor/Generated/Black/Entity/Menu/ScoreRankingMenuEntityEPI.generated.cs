...
namespace Black.Entity.Menu
{
    public partial class ScoreRankingMenuEntityEPI : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ScoreRankingMenuEntityEPI", 0, Black.Entity.Menu.ScoreRankingMenuEntityEPI.ObjectType, Construct, properties, 0, 496);
        }
        ...
        {
            return new ScoreRankingMenuEntityEPI();
        }
