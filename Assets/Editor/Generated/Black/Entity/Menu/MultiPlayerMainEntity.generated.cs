...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerMainEntity : Black.Entity.Menu.MainMenuBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerMainEntity", 0, Black.Entity.Menu.MultiPlayerMainEntity.ObjectType, Construct, properties, 0, 528);
        }
        ...
        {
            return new MultiPlayerMainEntity();
        }
