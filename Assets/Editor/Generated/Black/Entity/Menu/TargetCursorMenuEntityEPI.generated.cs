...
namespace Black.Entity.Menu
{
    public partial class TargetCursorMenuEntityEPI : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.TargetCursorMenuEntityEPI", 0, Black.Entity.Menu.TargetCursorMenuEntityEPI.ObjectType, Construct, properties, 0, 576);
        }
        ...
        {
            return new TargetCursorMenuEntityEPI();
        }
