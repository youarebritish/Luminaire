...
namespace Black.Entity.Menu
{
    public partial class PeriodMobhuntInfoMenuEntity : Black.Entity.Menu.MapMenuEntityBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.PeriodMobhuntInfoMenuEntity", 0, Black.Entity.Menu.PeriodMobhuntInfoMenuEntity.ObjectType, Construct, properties, 0, 1120);
        }
        ...
        {
            return new PeriodMobhuntInfoMenuEntity();
        }
