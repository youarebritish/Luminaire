...
namespace Black.Entity.Menu
{
    public partial class StatusPanelMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.StatusPanelMenuEntity", 0, Black.Entity.Menu.StatusPanelMenuEntity.ObjectType, Construct, properties, 0, 576);
        }
        ...
        {
            return new StatusPanelMenuEntity();
        }
