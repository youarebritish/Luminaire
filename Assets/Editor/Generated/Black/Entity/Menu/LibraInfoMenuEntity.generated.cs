...
namespace Black.Entity.Menu
{
    public partial class LibraInfoMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.LibraInfoMenuEntity", 0, Black.Entity.Menu.LibraInfoMenuEntity.ObjectType, Construct, properties, 0, 1008);
        }
        ...
        {
            return new LibraInfoMenuEntity();
        }
