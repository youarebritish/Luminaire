...
namespace Black.Entity.Menu
{
    public partial class TutorialInfoEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.TutorialInfoEntity", 0, Black.Entity.Menu.TutorialInfoEntity.ObjectType, Construct, properties, 0, 704);
        }
