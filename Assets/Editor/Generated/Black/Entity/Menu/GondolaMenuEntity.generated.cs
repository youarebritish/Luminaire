...
namespace Black.Entity.Menu
{
    public partial class GondolaMenuEntity : Black.Entity.Menu.MapMenuEntityBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.GondolaMenuEntity", 0, Black.Entity.Menu.GondolaMenuEntity.ObjectType, Construct, properties, 0, 800);
        }
