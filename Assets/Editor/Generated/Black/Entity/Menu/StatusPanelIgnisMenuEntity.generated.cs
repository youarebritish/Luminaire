...
namespace Black.Entity.Menu
{
    public partial class StatusPanelIgnisMenuEntity : Black.Entity.Menu.StatusPanelMenuEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.StatusPanelIgnisMenuEntity", 0, Black.Entity.Menu.StatusPanelIgnisMenuEntity.ObjectType, Construct, properties, 0, 624);
        }
        ...
        {
            return new StatusPanelIgnisMenuEntity();
        }
