...
namespace Black.Entity.Menu
{
    public partial class ColosseumBetMedalEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ColosseumBetMedalEntity", 0, Black.Entity.Menu.ColosseumBetMedalEntity.ObjectType, Construct, properties, 0, 528);
        }
        ...
        {
            return new ColosseumBetMedalEntity();
        }
