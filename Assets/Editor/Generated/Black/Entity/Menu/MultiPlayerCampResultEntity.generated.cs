...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerCampResultEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerCampResultEntity", 0, Black.Entity.Menu.MultiPlayerCampResultEntity.ObjectType, Construct, properties, 0, 544);
        }
        ...
        {
            return new MultiPlayerCampResultEntity();
        }
