...
namespace Black.Entity.Menu
{
    public partial class QuestInfoHudEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.QuestInfoHudEntity", 0, Black.Entity.Menu.QuestInfoHudEntity.ObjectType, Construct, properties, 0, 688);
        }
