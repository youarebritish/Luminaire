...
namespace Black.Entity.Menu
{
    public partial class MemberInfoMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MemberInfoMenuEntity", 0, Black.Entity.Menu.MemberInfoMenuEntity.ObjectType, Construct, properties, 0, 624);
        }
        ...
        {
            return new MemberInfoMenuEntity();
        }
