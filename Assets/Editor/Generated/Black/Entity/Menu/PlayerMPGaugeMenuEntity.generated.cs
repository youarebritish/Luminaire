...
{
    public partial class PlayerMPGaugeMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new PlayerMPGaugeMenuEntity();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Entity.Menu.PlayerMPGaugeMenuEntity", 0, Black.Entity.Menu.PlayerMPGaugeMenuEntity.ObjectType, Construct, properties, 0, 576);
        }
        ...
        {
            return new PlayerMPGaugeMenuEntity();
        }
