...
namespace Black.Entity.Menu
{
    public partial class InfoMapMenuEntity : Black.Entity.Menu.MapMenuEntityBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.InfoMapMenuEntity", 0, Black.Entity.Menu.InfoMapMenuEntity.ObjectType, Construct, properties, 0, 784);
        }
