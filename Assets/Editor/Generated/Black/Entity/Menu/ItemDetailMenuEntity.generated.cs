...
namespace Black.Entity.Menu
{
    public partial class ItemDetailMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ItemDetailMenuEntity", 0, Black.Entity.Menu.ItemDetailMenuEntity.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new ItemDetailMenuEntity();
        }
