...
namespace Black.Entity.Menu
{
    public partial class ColosseumBetEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ColosseumBetEntity", 0, Black.Entity.Menu.ColosseumBetEntity.ObjectType, Construct, properties, 0, 512);
        }
