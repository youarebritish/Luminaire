...
namespace Black.Entity.Menu
{
    public partial class DamageRateShiftBreakMenuEntity : Black.Entity.Menu.DamageRateMenuEntityBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.DamageRateShiftBreakMenuEntity", 0, Black.Entity.Menu.DamageRateShiftBreakMenuEntity.ObjectType, Construct, properties, 0, 560);
        }
        ...
        {
            return new DamageRateShiftBreakMenuEntity();
        }
