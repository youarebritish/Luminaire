...
namespace Black.Entity.Menu
{
    public partial class WeaponMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.WeaponMenuEntity", 0, Black.Entity.Menu.WeaponMenuEntity.ObjectType, Construct, properties, 0, 672);
        }
