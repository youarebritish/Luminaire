...
namespace Black.Entity.Menu
{
    public partial class ColosseumMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ColosseumMenuEntity", 0, Black.Entity.Menu.ColosseumMenuEntity.ObjectType, Construct, properties, 0, 560);
        }
        ...
        {
            return new ColosseumMenuEntity();
        }
