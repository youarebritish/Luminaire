...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerVoiceChatMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerVoiceChatMenuEntity", 0, Black.Entity.Menu.MultiPlayerVoiceChatMenuEntity.ObjectType, Construct, properties, 0, 592);
        }
        ...
        {
            return new MultiPlayerVoiceChatMenuEntity();
        }
