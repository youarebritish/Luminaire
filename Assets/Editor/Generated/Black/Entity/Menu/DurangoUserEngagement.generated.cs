...
namespace Black.Entity.Menu
{
    public partial class DurangoUserEngagement : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.DurangoUserEngagement", 0, Black.Entity.Menu.DurangoUserEngagement.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new DurangoUserEngagement();
        }
