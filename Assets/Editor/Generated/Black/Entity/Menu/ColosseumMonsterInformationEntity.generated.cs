...
namespace Black.Entity.Menu
{
    public partial class ColosseumMonsterInformationEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ColosseumMonsterInformationEntity", 0, Black.Entity.Menu.ColosseumMonsterInformationEntity.ObjectType, Construct, properties, 0, 560);
        }
        ...
        {
            return new ColosseumMonsterInformationEntity();
        }
