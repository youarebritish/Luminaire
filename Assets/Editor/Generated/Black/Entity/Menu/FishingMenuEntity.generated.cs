...
namespace Black.Entity.Menu
{
    public partial class FishingMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.FishingMenuEntity", 0, Black.Entity.Menu.FishingMenuEntity.ObjectType, Construct, properties, 0, 1120);
        }
