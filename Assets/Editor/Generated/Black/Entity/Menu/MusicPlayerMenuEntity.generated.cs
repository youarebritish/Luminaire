...
{
    public partial class MusicPlayerMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new MusicPlayerMenuEntity();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Entity.Menu.MusicPlayerMenuEntity", 0, Black.Entity.Menu.MusicPlayerMenuEntity.ObjectType, Construct, properties, 0, 528);
        }
        ...
        {
            return new MusicPlayerMenuEntity();
        }
