...
namespace Black.Entity.Menu
{
    public partial class SuppressionInfoMenuEntityEPI : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.SuppressionInfoMenuEntityEPI", 0, Black.Entity.Menu.SuppressionInfoMenuEntityEPI.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new SuppressionInfoMenuEntityEPI();
        }
