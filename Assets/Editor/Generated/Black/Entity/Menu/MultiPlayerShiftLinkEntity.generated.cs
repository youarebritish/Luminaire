...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerShiftLinkEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerShiftLinkEntity", 0, Black.Entity.Menu.MultiPlayerShiftLinkEntity.ObjectType, Construct, properties, 0, 544);
        }
        ...
        {
            return new MultiPlayerShiftLinkEntity();
        }
