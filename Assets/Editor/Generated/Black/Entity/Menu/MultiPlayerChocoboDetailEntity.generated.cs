...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerChocoboDetailEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerChocoboDetailEntity", 0, Black.Entity.Menu.MultiPlayerChocoboDetailEntity.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new MultiPlayerChocoboDetailEntity();
        }
