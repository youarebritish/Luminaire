...
namespace Black.Entity.Menu
{
    public partial class FishingRodSelectMenuEntity : Black.Entity.Menu.ImageSelectMenuEntityBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.FishingRodSelectMenuEntity", 0, Black.Entity.Menu.FishingRodSelectMenuEntity.ObjectType, Construct, properties, 0, 608);
        }
        ...
        {
            return new FishingRodSelectMenuEntity();
        }
