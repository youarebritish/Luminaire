...
namespace Black.Entity.Menu
{
    public partial class TacticalOperationMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.TacticalOperationMenuEntity", 0, Black.Entity.Menu.TacticalOperationMenuEntity.ObjectType, Construct, properties, 0, 560);
        }
        ...
        {
            return new TacticalOperationMenuEntity();
        }
