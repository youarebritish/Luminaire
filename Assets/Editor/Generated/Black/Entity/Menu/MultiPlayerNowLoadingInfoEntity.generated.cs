...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerNowLoadingInfoEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerNowLoadingInfoEntity", 0, Black.Entity.Menu.MultiPlayerNowLoadingInfoEntity.ObjectType, Construct, properties, 0, 1120);
        }
        ...
        {
            return new MultiPlayerNowLoadingInfoEntity();
        }
