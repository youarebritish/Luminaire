...
namespace Black.Entity.Menu
{
    public partial class MapIconThumbnailMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MapIconThumbnailMenuEntity", 0, Black.Entity.Menu.MapIconThumbnailMenuEntity.ObjectType, Construct, properties, 0, 688);
        }
        ...
        {
            return new MapIconThumbnailMenuEntity();
        }
