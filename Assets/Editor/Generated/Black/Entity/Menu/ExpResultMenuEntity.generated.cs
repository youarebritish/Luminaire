...
namespace Black.Entity.Menu
{
    public partial class ExpResultMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ExpResultMenuEntity", 0, Black.Entity.Menu.ExpResultMenuEntity.ObjectType, Construct, properties, 0, 864);
        }
        ...
        {
            return new ExpResultMenuEntity();
        }
