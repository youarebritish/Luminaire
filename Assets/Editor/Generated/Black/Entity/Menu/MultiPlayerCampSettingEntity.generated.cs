...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerCampSettingEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerCampSettingEntity", 0, Black.Entity.Menu.MultiPlayerCampSettingEntity.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new MultiPlayerCampSettingEntity();
        }
