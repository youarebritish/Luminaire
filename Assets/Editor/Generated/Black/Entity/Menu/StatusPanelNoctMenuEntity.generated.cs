...
namespace Black.Entity.Menu
{
    public partial class StatusPanelNoctMenuEntity : Black.Entity.Menu.StatusPanelMenuEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.StatusPanelNoctMenuEntity", 0, Black.Entity.Menu.StatusPanelNoctMenuEntity.ObjectType, Construct, properties, 0, 624);
        }
        ...
        {
            return new StatusPanelNoctMenuEntity();
        }
