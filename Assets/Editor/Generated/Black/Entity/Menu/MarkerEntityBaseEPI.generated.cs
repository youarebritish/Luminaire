...
namespace Black.Entity.Menu
{
    public partial class MarkerEntityBaseEPI : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MarkerEntityBaseEPI", 0, Black.Entity.Menu.MarkerEntityBaseEPI.ObjectType, Construct, properties, 0, 528);
        }
        ...
        {
            return new MarkerEntityBaseEPI();
        }
