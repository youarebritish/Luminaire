...
namespace Black.Entity.Menu
{
    public partial class MovieSkipEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MovieSkipEntity", 0, Black.Entity.Menu.MovieSkipEntity.ObjectType, Construct, properties, 0, 512);
        }
