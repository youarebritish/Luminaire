...
namespace Black.Entity.Menu
{
    public partial class ColosseumResidentEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ColosseumResidentEntity", 0, Black.Entity.Menu.ColosseumResidentEntity.ObjectType, Construct, properties, 0, 544);
        }
        ...
        {
            return new ColosseumResidentEntity();
        }
