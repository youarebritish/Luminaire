...
namespace Black.Entity.Menu
{
    public partial class InteractionCursorEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.InteractionCursorEntity", 0, Black.Entity.Menu.InteractionCursorEntity.ObjectType, Construct, properties, 0, 656);
        }
        ...
        {
            return new InteractionCursorEntity();
        }
