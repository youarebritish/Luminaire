...
namespace Black.Entity.Menu
{
    public partial class MobhuntInfoHudEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MobhuntInfoHudEntity", 0, Black.Entity.Menu.MobhuntInfoHudEntity.ObjectType, Construct, properties, 0, 656);
        }
        ...
        {
            return new MobhuntInfoHudEntity();
        }
