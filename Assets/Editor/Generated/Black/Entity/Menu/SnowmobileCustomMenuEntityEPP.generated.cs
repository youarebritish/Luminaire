...
namespace Black.Entity.Menu
{
    public partial class SnowmobileCustomMenuEntityEPP : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.SnowmobileCustomMenuEntityEPP", 0, Black.Entity.Menu.SnowmobileCustomMenuEntityEPP.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new SnowmobileCustomMenuEntityEPP();
        }
