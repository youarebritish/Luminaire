...
namespace Black.Entity.Menu
{
    public partial class SaveLoadMenuEntityEPI : Black.Entity.Menu.SaveLoadMenuEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.SaveLoadMenuEntityEPI", 0, Black.Entity.Menu.SaveLoadMenuEntityEPI.ObjectType, Construct, properties, 0, 816);
        }
        ...
        {
            return new SaveLoadMenuEntityEPI();
        }
