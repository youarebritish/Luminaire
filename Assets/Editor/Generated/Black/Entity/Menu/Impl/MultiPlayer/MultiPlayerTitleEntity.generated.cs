...
namespace Black.Entity.Menu.Impl.MultiPlayer
{
    public partial class MultiPlayerTitleEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.Impl.MultiPlayer.MultiPlayerTitleEntity", 0, Black.Entity.Menu.Impl.MultiPlayer.MultiPlayerTitleEntity.ObjectType, Construct, properties, 0, 576);
        }
        ...
        {
            return new MultiPlayerTitleEntity();
        }
