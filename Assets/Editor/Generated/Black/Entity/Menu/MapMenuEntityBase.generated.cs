...
namespace Black.Entity.Menu
{
    public partial class MapMenuEntityBase : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MapMenuEntityBase", 0, Black.Entity.Menu.MapMenuEntityBase.ObjectType, Construct, properties, 0, 784);
        }
