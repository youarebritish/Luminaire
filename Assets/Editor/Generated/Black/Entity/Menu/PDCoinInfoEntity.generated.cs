...
namespace Black.Entity.Menu
{
    public partial class PDCoinInfoEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.PDCoinInfoEntity", 0, Black.Entity.Menu.PDCoinInfoEntity.ObjectType, Construct, properties, 0, 512);
        }
