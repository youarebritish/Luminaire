...
namespace Black.Entity.Menu
{
    public partial class DamageRateMenuEntityBase : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.DamageRateMenuEntityBase", 0, Black.Entity.Menu.DamageRateMenuEntityBase.ObjectType, Construct, properties, 0, 560);
        }
        ...
        {
            return new DamageRateMenuEntityBase();
        }
