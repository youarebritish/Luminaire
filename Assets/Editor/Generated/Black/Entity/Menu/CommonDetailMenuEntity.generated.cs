...
namespace Black.Entity.Menu
{
    public partial class CommonDetailMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.CommonDetailMenuEntity", 0, Black.Entity.Menu.CommonDetailMenuEntity.ObjectType, Construct, properties, 0, 816);
        }
        ...
        {
            return new CommonDetailMenuEntity();
        }
