...
namespace Black.Entity.Menu
{
    public partial class ColosseumExchangeCoinEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ColosseumExchangeCoinEntity", 0, Black.Entity.Menu.ColosseumExchangeCoinEntity.ObjectType, Construct, properties, 0, 496);
        }
        ...
        {
            return new ColosseumExchangeCoinEntity();
        }
