...
namespace Black.Entity.Menu
{
    public partial class EnemyHPGaugeMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.EnemyHPGaugeMenuEntity", 0, Black.Entity.Menu.EnemyHPGaugeMenuEntity.ObjectType, Construct, properties, 0, 704);
        }
        ...
        {
            return new EnemyHPGaugeMenuEntity();
        }
