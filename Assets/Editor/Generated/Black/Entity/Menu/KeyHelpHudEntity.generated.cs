...
namespace Black.Entity.Menu
{
    public partial class KeyHelpHudEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.KeyHelpHudEntity", 0, Black.Entity.Menu.KeyHelpHudEntity.ObjectType, Construct, properties, 0, 512);
        }
