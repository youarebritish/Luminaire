...
namespace Black.Entity.Menu
{
    public partial class RifleGunSightMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.RifleGunSightMenuEntity", 0, Black.Entity.Menu.RifleGunSightMenuEntity.ObjectType, Construct, properties, 0, 640);
        }
        ...
        {
            return new RifleGunSightMenuEntity();
        }
