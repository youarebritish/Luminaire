...
namespace Black.Entity.Menu
{
    public partial class MobhuntResultHudEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MobhuntResultHudEntity", 0, Black.Entity.Menu.MobhuntResultHudEntity.ObjectType, Construct, properties, 0, 672);
        }
        ...
        {
            return new MobhuntResultHudEntity();
        }
