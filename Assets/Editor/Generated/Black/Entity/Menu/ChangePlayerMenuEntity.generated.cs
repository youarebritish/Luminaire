...
namespace Black.Entity.Menu
{
    public partial class ChangePlayerMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ChangePlayerMenuEntity", 0, Black.Entity.Menu.ChangePlayerMenuEntity.ObjectType, Construct, properties, 0, 528);
        }
        ...
        {
            return new ChangePlayerMenuEntity();
        }
