...
namespace Black.Entity.Menu
{
    public partial class TacticalOperationEnemyHPGaugeMenuEntity : Black.Entity.Menu.EnemyHPGaugeMenuEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.TacticalOperationEnemyHPGaugeMenuEntity", 0, Black.Entity.Menu.TacticalOperationEnemyHPGaugeMenuEntity.ObjectType, Construct, properties, 0, 704);
        }
        ...
        {
            return new TacticalOperationEnemyHPGaugeMenuEntity();
        }
