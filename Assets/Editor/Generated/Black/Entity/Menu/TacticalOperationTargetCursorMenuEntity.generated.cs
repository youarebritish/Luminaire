...
namespace Black.Entity.Menu
{
    public partial class TacticalOperationTargetCursorMenuEntity : Black.Entity.Menu.TargetCursorMenuEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.TacticalOperationTargetCursorMenuEntity", 0, Black.Entity.Menu.TacticalOperationTargetCursorMenuEntity.ObjectType, Construct, properties, 0, 576);
        }
        ...
        {
            return new TacticalOperationTargetCursorMenuEntity();
        }
