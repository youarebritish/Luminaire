...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerCommDialogMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerCommDialogMenuEntity", 0, Black.Entity.Menu.MultiPlayerCommDialogMenuEntity.ObjectType, Construct, properties, 0, 736);
        }
        ...
        {
            return new MultiPlayerCommDialogMenuEntity();
        }
