...
namespace Black.Entity.Menu
{
    public partial class PDEquipMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.PDEquipMenuEntity", 0, Black.Entity.Menu.PDEquipMenuEntity.ObjectType, Construct, properties, 0, 528);
        }
