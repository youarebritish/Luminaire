...
namespace Black.Entity.Menu
{
    public partial class CounterInfoMenuEntityEPI : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.CounterInfoMenuEntityEPI", 0, Black.Entity.Menu.CounterInfoMenuEntityEPI.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new CounterInfoMenuEntityEPI();
        }
