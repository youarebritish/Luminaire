...
namespace Black.Entity.Menu
{
    public partial class CarCustomMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.CarCustomMenuEntity", 0, Black.Entity.Menu.CarCustomMenuEntity.ObjectType, Construct, properties, 0, 2752);
        }
        ...
        {
            return new CarCustomMenuEntity();
        }
