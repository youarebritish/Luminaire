...
namespace Black.Entity.Menu
{
    public partial class MarkerInfoEntityEPI : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MarkerInfoEntityEPI", 0, Black.Entity.Menu.MarkerInfoEntityEPI.ObjectType, Construct, properties, 0, 528);
        }
        ...
        {
            return new MarkerInfoEntityEPI();
        }
