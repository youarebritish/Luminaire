...
namespace Black.Entity.Menu
{
    public partial class TimedQuestHudMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.TimedQuestHudMenuEntity", 0, Black.Entity.Menu.TimedQuestHudMenuEntity.ObjectType, Construct, properties, 0, 496);
        }
        ...
        {
            return new TimedQuestHudMenuEntity();
        }
