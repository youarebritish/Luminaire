...
namespace Black.Entity.Menu
{
    public partial class SystemWindowEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.SystemWindowEntity", 0, Black.Entity.Menu.SystemWindowEntity.ObjectType, Construct, properties, 0, 848);
        }
