...
namespace Black.Entity.Menu
{
    public partial class CampResultMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.CampResultMenuEntity", 0, Black.Entity.Menu.CampResultMenuEntity.ObjectType, Construct, properties, 0, 544);
        }
        ...
        {
            return new CampResultMenuEntity();
        }
