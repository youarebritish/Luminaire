...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerResultEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerResultEntity", 0, Black.Entity.Menu.MultiPlayerResultEntity.ObjectType, Construct, properties, 0, 880);
        }
        ...
        {
            return new MultiPlayerResultEntity();
        }
