...
namespace Black.Entity.Menu
{
    public partial class ScoreRankingMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ScoreRankingMenuEntity", 0, Black.Entity.Menu.ScoreRankingMenuEntity.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new ScoreRankingMenuEntity();
        }
