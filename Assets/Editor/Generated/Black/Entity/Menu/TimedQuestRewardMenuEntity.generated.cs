...
namespace Black.Entity.Menu
{
    public partial class TimedQuestRewardMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.TimedQuestRewardMenuEntity", 0, Black.Entity.Menu.TimedQuestRewardMenuEntity.ObjectType, Construct, properties, 0, 528);
        }
        ...
        {
            return new TimedQuestRewardMenuEntity();
        }
