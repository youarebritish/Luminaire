...
namespace Black.Entity.Menu
{
    public partial class WireHookMarkerFarMenuEntityEPI : Black.Entity.Menu.MarkerEntityBaseEPI
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.WireHookMarkerFarMenuEntityEPI", 0, Black.Entity.Menu.WireHookMarkerFarMenuEntityEPI.ObjectType, Construct, properties, 0, 528);
        }
        ...
        {
            return new WireHookMarkerFarMenuEntityEPI();
        }
