...
namespace Black.Entity.Menu
{
    public partial class JobCommandMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.JobCommandMenuEntity", 0, Black.Entity.Menu.JobCommandMenuEntity.ObjectType, Construct, properties, 0, 624);
        }
        ...
        {
            return new JobCommandMenuEntity();
        }
