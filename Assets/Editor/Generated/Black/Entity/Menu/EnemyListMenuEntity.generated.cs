...
namespace Black.Entity.Menu
{
    public partial class EnemyListMenuEntity : Black.Entity.Menu.ModelGalleryMenuEntityBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.EnemyListMenuEntity", 0, Black.Entity.Menu.EnemyListMenuEntity.ObjectType, Construct, properties, 0, 816);
        }
        ...
        {
            return new EnemyListMenuEntity();
        }
