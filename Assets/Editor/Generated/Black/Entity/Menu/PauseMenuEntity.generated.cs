...
namespace Black.Entity.Menu
{
    public partial class PauseMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.PauseMenuEntity", 0, Black.Entity.Menu.PauseMenuEntity.ObjectType, Construct, properties, 0, 1184);
        }
