...
namespace Black.Entity.Menu
{
    public partial class ChocoboQTEGaugeEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ChocoboQTEGaugeEntity", 0, Black.Entity.Menu.ChocoboQTEGaugeEntity.ObjectType, Construct, properties, 0, 608);
        }
        ...
        {
            return new ChocoboQTEGaugeEntity();
        }
