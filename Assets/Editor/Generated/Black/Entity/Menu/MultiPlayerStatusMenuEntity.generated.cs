...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerStatusMenuEntity : Black.Entity.Menu.StatusMenuEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerStatusMenuEntity", 0, Black.Entity.Menu.MultiPlayerStatusMenuEntity.ObjectType, Construct, properties, 0, 1408);
        }
        ...
        {
            return new MultiPlayerStatusMenuEntity();
        }
