...
namespace Black.Entity.Menu
{
    public partial class MultiPlayerPlayerPosMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.MultiPlayerPlayerPosMenuEntity", 0, Black.Entity.Menu.MultiPlayerPlayerPosMenuEntity.ObjectType, Construct, properties, 0, 592);
        }
        ...
        {
            return new MultiPlayerPlayerPosMenuEntity();
        }
