...
namespace Black.Entity.Menu
{
    public partial class TimedQuestTitleMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.TimedQuestTitleMenuEntity", 0, Black.Entity.Menu.TimedQuestTitleMenuEntity.ObjectType, Construct, properties, 0, 512);
        }
        ...
        {
            return new TimedQuestTitleMenuEntity();
        }
