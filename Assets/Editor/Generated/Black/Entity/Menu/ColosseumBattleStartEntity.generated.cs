...
namespace Black.Entity.Menu
{
    public partial class ColosseumBattleStartEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.ColosseumBattleStartEntity", 0, Black.Entity.Menu.ColosseumBattleStartEntity.ObjectType, Construct, properties, 0, 496);
        }
        ...
        {
            return new ColosseumBattleStartEntity();
        }
