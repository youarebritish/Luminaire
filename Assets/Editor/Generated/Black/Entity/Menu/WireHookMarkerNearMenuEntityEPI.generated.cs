...
namespace Black.Entity.Menu
{
    public partial class WireHookMarkerNearMenuEntityEPI : Black.Entity.Menu.MarkerEntityBaseEPI
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.WireHookMarkerNearMenuEntityEPI", 0, Black.Entity.Menu.WireHookMarkerNearMenuEntityEPI.ObjectType, Construct, properties, 0, 528);
        }
        ...
        {
            return new WireHookMarkerNearMenuEntityEPI();
        }
