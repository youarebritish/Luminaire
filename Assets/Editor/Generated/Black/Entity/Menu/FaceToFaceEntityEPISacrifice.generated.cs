...
namespace Black.Entity.Menu
{
    public partial class FaceToFaceEntityEPISacrifice : Black.Entity.Menu.FaceToFaceEntityEPI
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.FaceToFaceEntityEPISacrifice", 0, Black.Entity.Menu.FaceToFaceEntityEPISacrifice.ObjectType, Construct, properties, 0, 816);
        }
        ...
        {
            return new FaceToFaceEntityEPISacrifice();
        }
