...
namespace Black.Entity.Menu
{
    public partial class InjuredMenuEntity : Black.Entity.Menu.SwfEntryEntity
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Entity.Menu.InjuredMenuEntity", 0, Black.Entity.Menu.InjuredMenuEntity.ObjectType, Construct, properties, 0, 560);
        }
