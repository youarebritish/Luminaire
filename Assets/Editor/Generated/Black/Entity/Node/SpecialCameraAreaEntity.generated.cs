...
namespace Black.Entity.Node
{
    public partial class SpecialCameraAreaEntity : Black.Entity.Node.SpecialAreaEntity
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("areaType_", 3864051017, "Black.Map.AreaManager.SPECIAL_AREA_TYPE", 448, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("isKillActorInAvoidArea_", 2987841704, "bool", 452, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
