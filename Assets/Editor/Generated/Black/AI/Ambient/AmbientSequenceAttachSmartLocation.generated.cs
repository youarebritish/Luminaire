...
namespace Black.AI.Ambient
{
    public partial class AmbientSequenceAttachSmartLocation : Black.AI.Ambient.AmbientSequenceAction
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("template_.pinName_", 493184819, "Base.String", 472, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("template_.name_", 946359646, "Base.String", 488, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("template_.connections_", 3525356996, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 504, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("template_.pinValueType_", 1000414871, "Base.String", 536, 16, 1, Property.PrimitiveType.String, 0, (char)0));
