...
namespace Black.AI.Ambient
{
    public partial class AmbientSequenceDisableSmartLocation : Black.AI.Ambient.AmbientSequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AI.Ambient.AmbientSequenceDisableSmartLocation", 0, Black.AI.Ambient.AmbientSequenceDisableSmartLocation.ObjectType, Construct, properties, 0, 472);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("locationEntity_.pinName_", 4143522073, "Base.String", 384, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("locationEntity_.name_", 2536150564, "Base.String", 400, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("locationEntity_.connections_", 493324506, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 416, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("locationEntity_.pinValueType_", 1520665369, "Base.String", 448, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new AmbientSequenceDisableSmartLocation();
        }
