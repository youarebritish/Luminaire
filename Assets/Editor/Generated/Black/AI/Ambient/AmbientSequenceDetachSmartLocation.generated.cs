...
namespace Black.AI.Ambient
{
    public partial class AmbientSequenceDetachSmartLocation : Black.AI.Ambient.AmbientSequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AI.Ambient.AmbientSequenceDetachSmartLocation", 0, Black.AI.Ambient.AmbientSequenceDetachSmartLocation.ObjectType, Construct, properties, 0, 464);
        }
        ...
        {
            return new AmbientSequenceDetachSmartLocation();
        }
