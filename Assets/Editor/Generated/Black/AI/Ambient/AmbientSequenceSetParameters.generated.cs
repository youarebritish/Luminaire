...
namespace Black.AI.Ambient
{
    public partial class AmbientSequenceSetParameters : Black.AI.Ambient.AmbientSequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AI.Ambient.AmbientSequenceSetParameters", 0, Black.AI.Ambient.AmbientSequenceSetParameters.ObjectType, Construct, properties, 0, 568);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("parameterEntity_.pinName_", 2868038067, "Base.String", 384, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("parameterEntity_.name_", 833643742, "Base.String", 400, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("parameterEntity_.connections_", 4056004676, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 416, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("parameterEntity_.pinValueType_", 2250548759, "Base.String", 448, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new AmbientSequenceSetParameters();
        }
