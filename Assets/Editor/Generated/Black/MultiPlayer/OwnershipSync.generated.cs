...
namespace Black.MultiPlayer
{
    public partial class OwnershipSync : BaseObject
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.MultiPlayer.OwnershipSync", 0, Black.MultiPlayer.OwnershipSync.ObjectType, Construct, properties, 6, 640);
        }
