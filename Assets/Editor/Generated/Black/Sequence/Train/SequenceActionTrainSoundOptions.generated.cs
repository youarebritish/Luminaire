...
namespace Black.Sequence.Train
{
    public partial class SequenceActionTrainSoundOptions : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Train.SequenceActionTrainSoundOptions", 0, Black.Sequence.Train.SequenceActionTrainSoundOptions.ObjectType, Construct, properties, 0, 464);
        }
        ...
        {
            return new SequenceActionTrainSoundOptions();
        }
