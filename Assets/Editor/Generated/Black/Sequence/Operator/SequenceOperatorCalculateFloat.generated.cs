...
namespace Black.Sequence.Operator
{
    public partial class SequenceOperatorCalculateFloat : Black.Sequence.Operator.SequenceOperatorCalculateBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Operator.SequenceOperatorCalculateFloat", 0, Black.Sequence.Operator.SequenceOperatorCalculateFloat.ObjectType, Construct, properties, 0, 584);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("operatorType_", 916416734, "Black.Sequence.Operator.SequenceOperatorCalculateFloat.FloatOperatorType", 136, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
        ...
        {
            return new SequenceOperatorCalculateFloat();
        }
