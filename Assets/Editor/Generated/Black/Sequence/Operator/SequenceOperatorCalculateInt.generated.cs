...
namespace Black.Sequence.Operator
{
    public partial class SequenceOperatorCalculateInt : Black.Sequence.Operator.SequenceOperatorCalculateBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Operator.SequenceOperatorCalculateInt", 0, Black.Sequence.Operator.SequenceOperatorCalculateInt.ObjectType, Construct, properties, 0, 584);
        }
        ...
        {
            return new SequenceOperatorCalculateInt();
        }
