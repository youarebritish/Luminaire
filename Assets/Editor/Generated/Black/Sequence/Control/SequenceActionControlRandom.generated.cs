...
namespace Black.Sequence.Control
{
    ...
    public partial class SequenceActionControlRandom : Black.Sequence.Control.SequenceActionControlFallBackable
    {
		...
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableInputPin fixidIndexPinNoin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
