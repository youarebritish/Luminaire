...
namespace Black.Sequence.Control.GameFlag
{
    public partial class SequenceActionControlGetGameFlagFixId : Black.Sequence.Control.GameFlag.SequenceActionControlGameFlagBaseFixId
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Control.GameFlag.SequenceActionControlGetGameFlagFixId", 0, Black.Sequence.Control.GameFlag.SequenceActionControlGetGameFlagFixId.ObjectType, Construct, properties, 0, 560);
        }
        ...
        {
            return new SequenceActionControlGetGameFlagFixId();
        }
