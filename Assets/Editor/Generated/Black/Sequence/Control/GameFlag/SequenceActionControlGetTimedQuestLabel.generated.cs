...
namespace Black.Sequence.Control.GameFlag
{
    public partial class SequenceActionControlGetTimedQuestLabel : Black.Sequence.Control.GameFlag.SequenceActionControlTimedQuestLabelBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Control.GameFlag.SequenceActionControlGetTimedQuestLabel", 0, Black.Sequence.Control.GameFlag.SequenceActionControlGetTimedQuestLabel.ObjectType, Construct, properties, 0, 560);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("labelPin_.pinName_", 3345580800, "Base.String", 384, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("labelPin_.name_", 1171050731, "Base.String", 400, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("labelPin_.connections_", 1449764387, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 416, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("labelPin_.pinValueType_", 1335347678, "Base.String", 448, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionControlGetTimedQuestLabel();
        }
