...
namespace Black.Sequence.MultiPlayer
{
    public partial class SequenceMultiPlayerNoReturnableDeathEvent : Black.Sequence.MultiPlayer.SequenceMultiPlayerSyncEventBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.MultiPlayer.SequenceMultiPlayerNoReturnableDeathEvent", 0, Black.Sequence.MultiPlayer.SequenceMultiPlayerNoReturnableDeathEvent.ObjectType, Construct, properties, 0, 392);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("timeOPin_.pinName_", 2298233452, "Base.String", 304, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("timeOPin_.name_", 1463982807, "Base.String", 320, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("timeOPin_.connections_", 2606616247, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 336, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("timeOPin_.pinValueType_", 746295770, "Base.String", 368, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceMultiPlayerNoReturnableDeathEvent();
        }
