...
namespace Black.Sequence.MultiPlayer
{
    public partial class SequenceMultiPlayerGetArrangementFlag : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.MultiPlayer.SequenceMultiPlayerGetArrangementFlag", 0, Black.Sequence.MultiPlayer.SequenceMultiPlayerGetArrangementFlag.ObjectType, Construct, properties, 0, 544);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("outValue_.pinName_", 1626062440, "Base.String", 464, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("outValue_.name_", 229917699, "Base.String", 480, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("outValue_.connections_", 2399569163, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 496, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("outValue_.pinValueType_", 3816269750, "Base.String", 528, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceMultiPlayerGetArrangementFlag();
        }
