...
namespace Black.Sequence.MultiPlayer
{
    public partial class SequenceMultiPlayerGameOverEvent : Black.Sequence.MultiPlayer.SequenceMultiPlayerSyncEventBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.MultiPlayer.SequenceMultiPlayerGameOverEvent", 0, Black.Sequence.MultiPlayer.SequenceMultiPlayerGameOverEvent.ObjectType, Construct, properties, 0, 296);
        }
        ...
        {
            return new SequenceMultiPlayerGameOverEvent();
        }
