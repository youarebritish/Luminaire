...
namespace Black.Sequence.MultiPlayer
{
    public partial class SequenceMultiPlayerReturnableDeathEvent : Black.Sequence.MultiPlayer.SequenceMultiPlayerSyncEventBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.MultiPlayer.SequenceMultiPlayerReturnableDeathEvent", 0, Black.Sequence.MultiPlayer.SequenceMultiPlayerReturnableDeathEvent.ObjectType, Construct, properties, 0, 296);
        }
        ...
        {
            return new SequenceMultiPlayerReturnableDeathEvent();
        }
