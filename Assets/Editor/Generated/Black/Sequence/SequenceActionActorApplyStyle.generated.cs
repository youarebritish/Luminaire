...
{
    public partial class SequenceActionActorApplyStyle : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionActorApplyStyle();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.SequenceActionActorApplyStyle", 0, Black.Sequence.SequenceActionActorApplyStyle.ObjectType, Construct, properties, 0, 488);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.SequenceActionActorApplyStyle", base.GetFieldProperties(), 328062682, 26534124);
			...
			fieldProperties.AddProperty(new Property("debugThrough_", 1526981274, "bool", 464, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
        ...
        {
            return new SequenceActionActorApplyStyle();
        }
