...
namespace Black.Sequence.Action.Level.Ignis
{
    public partial class SequenceActionSetChapter : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Level.Ignis.SequenceActionSetChapter", 0, Black.Sequence.Action.Level.Ignis.SequenceActionSetChapter.ObjectType, Construct, properties, 0, 376);
        }
        ...
        {
            return new SequenceActionSetChapter();
        }
