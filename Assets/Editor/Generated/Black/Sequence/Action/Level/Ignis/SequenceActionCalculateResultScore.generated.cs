...
namespace Black.Sequence.Action.Level.Ignis
{
    public partial class SequenceActionCalculateResultScore : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Level.Ignis.SequenceActionCalculateResultScore", 0, Black.Sequence.Action.Level.Ignis.SequenceActionCalculateResultScore.ObjectType, Construct, properties, 0, 376);
        }
        ...
        {
            return new SequenceActionCalculateResultScore();
        }
