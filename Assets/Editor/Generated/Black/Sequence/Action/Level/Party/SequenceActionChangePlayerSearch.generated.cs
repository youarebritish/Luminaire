...
namespace Black.Sequence.Action.Level.Party
{
    public partial class SequenceActionChangePlayerSearch : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("actorIPin_.pinName_", 3542083172, "Base.String", 376, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("actorIPin_.name_", 1879047359, "Base.String", 392, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("actorIPin_.connections_", 299757807, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 408, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("actorIPin_.pinValueType_", 1030360322, "Base.String", 440, 16, 1, Property.PrimitiveType.String, 0, (char)0));
