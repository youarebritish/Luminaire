...
namespace Black.Sequence.Action.Level
{
    public partial class SequenceActionAddFoodOrderCount : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Level.SequenceActionAddFoodOrderCount", 0, Black.Sequence.Action.Level.SequenceActionAddFoodOrderCount.ObjectType, Construct, properties, 0, 464);
        }
        ...
        {
            return new SequenceActionAddFoodOrderCount();
        }
