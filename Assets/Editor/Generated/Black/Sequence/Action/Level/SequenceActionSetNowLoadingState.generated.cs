...
namespace Black.Sequence.Action.Level
{
    public partial class SequenceActionSetNowLoadingState : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Level.SequenceActionSetNowLoadingState", 0, Black.Sequence.Action.Level.SequenceActionSetNowLoadingState.ObjectType, Construct, properties, 0, 480);
        }
        ...
        {
            return new SequenceActionSetNowLoadingState();
        }
