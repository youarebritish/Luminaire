...
namespace Black.Sequence.Action.Level
{
    public partial class SequenceActionSetDinerPlaceInformation : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Level.SequenceActionSetDinerPlaceInformation", 0, Black.Sequence.Action.Level.SequenceActionSetDinerPlaceInformation.ObjectType, Construct, properties, 0, 632);
        }
        ...
        {
            return new SequenceActionSetDinerPlaceInformation();
        }
