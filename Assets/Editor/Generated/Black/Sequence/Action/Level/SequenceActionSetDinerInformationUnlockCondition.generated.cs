...
namespace Black.Sequence.Action.Level
{
    public partial class SequenceActionSetDinerInformationUnlockCondition : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Level.SequenceActionSetDinerInformationUnlockCondition", 0, Black.Sequence.Action.Level.SequenceActionSetDinerInformationUnlockCondition.ObjectType, Construct, properties, 0, 376);
        }
        ...
        {
            return new SequenceActionSetDinerInformationUnlockCondition();
        }
