...
namespace Black.Sequence.Action.Level.Reinforcement
{
    public partial class SequenceActionDeleteReinforcement : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Level.Reinforcement.SequenceActionDeleteReinforcement", 0, Black.Sequence.Action.Level.Reinforcement.SequenceActionDeleteReinforcement.ObjectType, Construct, properties, 0, 464);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("inReinforceID_.pinName_", 1968696342, "Base.String", 376, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("inReinforceID_.name_", 1455595681, "Base.String", 392, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("inReinforceID_.connections_", 3013331713, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 408, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("inReinforceID_.pinValueType_", 291011608, "Base.String", 440, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionDeleteReinforcement();
        }
