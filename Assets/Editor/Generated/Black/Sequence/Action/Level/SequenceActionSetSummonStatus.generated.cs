...
namespace Black.Sequence.Action.Level
{
    public partial class SequenceActionSetSummonStatus : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Level.SequenceActionSetSummonStatus", 0, Black.Sequence.Action.Level.SequenceActionSetSummonStatus.ObjectType, Construct, properties, 0, 472);
        }
        ...
        {
            return new SequenceActionSetSummonStatus();
        }
