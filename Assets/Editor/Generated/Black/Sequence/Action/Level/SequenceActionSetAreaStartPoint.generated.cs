...
namespace Black.Sequence.Action.Level
{
    public partial class SequenceActionSetAreaStartPoint : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Level.SequenceActionSetAreaStartPoint", 0, Black.Sequence.Action.Level.SequenceActionSetAreaStartPoint.ObjectType, Construct, properties, 0, 616);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("labeledValue_.pinName_", 2492147793, "Base.String", 280, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("labeledValue_.name_", 379254540, "Base.String", 296, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("labeledValue_.connections_", 705957010, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 312, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("labeledValue_.pinValueType_", 3676937825, "Base.String", 344, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("valueAreaStartPosition_.pinName_", 3340352186, "Base.String", 488, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("valueAreaStartPosition_.name_", 2792791237, "Base.String", 504, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("valueAreaStartPosition_.connections_", 88895965, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 520, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("valueAreaStartPosition_.pinValueType_", 2275976396, "Base.String", 552, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionSetAreaStartPoint();
        }
