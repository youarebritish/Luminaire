...
namespace Black.Sequence.Action.Level.Corps
{
    public partial class SequenceActionDeleteCorps : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("corps_.pinName_", 2606885002, "Base.String", 384, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("corps_.name_", 4154057301, "Base.String", 400, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("corps_.connections_", 1737325261, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 416, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("corps_.pinValueType_", 2344817244, "Base.String", 448, 16, 1, Property.PrimitiveType.String, 0, (char)0));
