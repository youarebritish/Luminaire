...
namespace Black.Sequence.Action.Level.Summon
{
    ...
    public partial class SequenceActionStartSummonForce : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
		...
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphTriggerOutputPin UCon_= new SQEX.Ebony.Framework.Node.GraphTriggerOutputPin();
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphTriggerOutputPin playerDead_= new SQEX.Ebony.Framework.Node.GraphTriggerOutputPin();
