...
namespace Black.Sequence.Action.Level
{
    public partial class SequenceActionSetBattleAreaInfoClearAll : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Level.SequenceActionSetBattleAreaInfoClearAll", 0, Black.Sequence.Action.Level.SequenceActionSetBattleAreaInfoClearAll.ObjectType, Construct, properties, 0, 384);
        }
        ...
        {
            return new SequenceActionSetBattleAreaInfoClearAll();
        }
