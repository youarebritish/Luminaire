...
namespace Black.Sequence.Action.Level.Nifl
{
    public partial class SequenceActionChangeAirCraftState : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("inAircraft_.pinName_", 863906440, "Base.String", 376, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("inAircraft_.name_", 1859150691, "Base.String", 392, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("inAircraft_.connections_", 3224486507, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 408, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("inAircraft_.pinValueType_", 1883585302, "Base.String", 440, 16, 1, Property.PrimitiveType.String, 0, (char)0));
