...
namespace Black.Sequence.Action.Level.Nifl
{
    public partial class SequenceActionSetTurretHeatParams : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Level.Nifl.SequenceActionSetTurretHeatParams", 0, Black.Sequence.Action.Level.Nifl.SequenceActionSetTurretHeatParams.ObjectType, Construct, properties, 0, 384);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("enableToHeat_", 3519029970, "bool", 376, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
        ...
        {
            return new SequenceActionSetTurretHeatParams();
        }
