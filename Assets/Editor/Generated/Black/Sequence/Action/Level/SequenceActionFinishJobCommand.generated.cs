...
namespace Black.Sequence.Action.Level
{
    public partial class SequenceActionFinishJobCommand : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Level.SequenceActionFinishJobCommand", 0, Black.Sequence.Action.Level.SequenceActionFinishJobCommand.ObjectType, Construct, properties, 0, 464);
        }
        ...
        {
            return new SequenceActionFinishJobCommand();
        }
