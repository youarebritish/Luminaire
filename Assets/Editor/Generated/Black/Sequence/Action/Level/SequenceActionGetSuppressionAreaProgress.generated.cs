...
namespace Black.Sequence.Action.Level
{
    public partial class SequenceActionGetSuppressionAreaProgress : Black.Sequence.Action.Level.SequenceActionSuppressionAreaBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Level.SequenceActionGetSuppressionAreaProgress", 0, Black.Sequence.Action.Level.SequenceActionGetSuppressionAreaProgress.ObjectType, Construct, properties, 0, 720);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("progressPercentOut_.pinName_", 261949213, "Base.String", 632, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("progressPercentOut_.name_", 4106512104, "Base.String", 648, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("progressPercentOut_.connections_", 3615479334, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 664, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("progressPercentOut_.pinValueType_", 375070253, "Base.String", 696, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionGetSuppressionAreaProgress();
        }
