...
namespace Black.Sequence.Action.Sample
{
    public partial class SequenceActionSamplePropertySequence : SQEX.Ebony.Framework.Sequence.Action.SequenceActionWithCurveControl
    {
		...
		public IList<Black.Entity.Data.CharacterEntry.CharacterEntryStringArrayItem> pathList_= new List<Black.Entity.Data.CharacterEntry.CharacterEntryStringArrayItem>();
		public IList<Black.Entity.Data.CharacterEntry.CharacterEntryStringArrayItem> strList_= new List<Black.Entity.Data.CharacterEntry.CharacterEntryStringArrayItem>();
		public IList<Black.Entity.Data.CharacterEntry.CharacterEntryFixidArrayItem> fixIdList_= new List<Black.Entity.Data.CharacterEntry.CharacterEntryFixidArrayItem>();
		public IList<bool> primitiveBoolList_= new List<bool>();
		public IList<int> primitiveIntList_= new List<int>();
		public IList<float> primitiveFloatList_= new List<float>();
		public IList<Black.Camera.CameraManager.BlackCameraParamType> primitiveEnumLongList_= new List<Black.Camera.CameraManager.BlackCameraParamType>();
		public IList<string> primitiveStringList_= new List<string>();
		public IList<UnityEngine.Vector4> primitiveVectorList_= new List<UnityEngine.Vector4>();
		public IList<UnityEngine.Color> primitivecolorList_= new List<UnityEngine.Color>();
