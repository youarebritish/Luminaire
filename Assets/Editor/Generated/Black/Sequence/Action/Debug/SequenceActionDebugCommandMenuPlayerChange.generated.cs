...
{
    public partial class SequenceActionDebugCommandMenuPlayerChange : Black.Sequence.Action.Debug.SequenceActionDebugCommandMenuBase
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.Debug.SequenceActionDebugCommandMenuPlayerChange", base.GetFieldProperties(), 1254249131, -716528397);
			...
			fieldProperties.AddIndirectlyProperty(new Property("end_", 3007557807, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 272, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("reqNext_", 740954671, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 368, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("reqPreview_", 402856430, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 464, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("isPlayerControlOff_", 604135359, "bool", 560, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("bSetPause_", 455134428, "bool", 561, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
