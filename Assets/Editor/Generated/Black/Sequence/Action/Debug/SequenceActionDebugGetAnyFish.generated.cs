...
namespace Black.Sequence.Action.Debug
{
    public partial class SequenceActionDebugGetAnyFish : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Debug.SequenceActionDebugGetAnyFish", 0, Black.Sequence.Action.Debug.SequenceActionDebugGetAnyFish.ObjectType, Construct, properties, 0, 560);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("string_.pinName_", 668307124, "Base.String", 280, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("string_.name_", 311541711, "Base.String", 296, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("string_.connections_", 680685151, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 312, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("string_.pinValueType_", 1769302994, "Base.String", 344, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("string_", 3430064421, "SQEX.Ebony.Framework.Node.GraphVariableOutputPin", 272, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
        ...
        {
            return new SequenceActionDebugGetAnyFish();
        }
