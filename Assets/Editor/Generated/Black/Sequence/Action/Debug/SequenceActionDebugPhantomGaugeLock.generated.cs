...
namespace Black.Sequence.Action.Debug
{
    public partial class SequenceActionDebugPhantomGaugeLock : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Debug.SequenceActionDebugPhantomGaugeLock", 0, Black.Sequence.Action.Debug.SequenceActionDebugPhantomGaugeLock.ObjectType, Construct, properties, 0, 464);
        }
        ...
        {
            return new SequenceActionDebugPhantomGaugeLock();
        }
