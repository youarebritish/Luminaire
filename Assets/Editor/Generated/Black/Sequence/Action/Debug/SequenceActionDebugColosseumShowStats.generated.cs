...
{
    public partial class SequenceActionDebugColosseumShowStats : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
		...
		public SQEX.Ebony.Framework.Node.GraphTriggerInputPin showStats_;
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("showStats_.pinName_", 3718158679, "Base.String", 376, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("showStats_.name_", 774620866, "Base.String", 392, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("showStats_.connections_", 3125743760, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 408, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("showStats_.delayType_", 3534182, "SQEX.Ebony.Framework.Node.GraphPin.DelayType", 440, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("showStats_.delayTime_", 2003696817, "float", 444, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("showStats_.delayMaxTime_", 1803920973, "float", 448, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("showStats_", 1091219832, "SQEX.Ebony.Framework.Node.GraphTriggerInputPin", 368, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
