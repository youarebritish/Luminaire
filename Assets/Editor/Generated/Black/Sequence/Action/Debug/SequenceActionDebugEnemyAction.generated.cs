...
namespace Black.Sequence.Action.Debug
{
    public partial class SequenceActionDebugEnemyAction : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Debug.SequenceActionDebugEnemyAction", 0, Black.Sequence.Action.Debug.SequenceActionDebugEnemyAction.ObjectType, Construct, properties, 0, 992);
        }
        ...
        {
            return new SequenceActionDebugEnemyAction();
        }
