...
namespace Black.Sequence.Action.Debug
{
    public partial class SequenceActionDebugGetEnemyEncyclopediaList : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("labelList_.pinName_", 100170389, "Base.String", 280, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("labelList_.name_", 3838209808, "Base.String", 296, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("labelList_.connections_", 1943607518, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 312, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("labelList_.pinValueType_", 3347060757, "Base.String", 344, 16, 1, Property.PrimitiveType.String, 0, (char)0));
