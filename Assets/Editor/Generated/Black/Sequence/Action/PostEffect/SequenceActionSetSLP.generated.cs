...
namespace Black.Sequence.Action.PostEffect
{
    public partial class SequenceActionSetSLP : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.PostEffect.SequenceActionSetSLP", 0, Black.Sequence.Action.PostEffect.SequenceActionSetSLP.ObjectType, Construct, properties, 0, 376);
        }
        ...
        {
            return new SequenceActionSetSLP();
        }
