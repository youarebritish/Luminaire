...
namespace Black.Sequence.Action.Camera
{
    public partial class SequenceActionCameraEndSequence : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Camera.SequenceActionCameraEndSequence", 0, Black.Sequence.Action.Camera.SequenceActionCameraEndSequence.ObjectType, Construct, properties, 0, 296);
        }
        ...
        {
            return new SequenceActionCameraEndSequence();
        }
