...
namespace Black.Sequence.Action.Camera
{
    public partial class SequenceActionCameraSetCenterCamera : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Camera.SequenceActionCameraSetCenterCamera", 0, Black.Sequence.Action.Camera.SequenceActionCameraSetCenterCamera.ObjectType, Construct, properties, 0, 376);
        }
        ...
        {
            return new SequenceActionCameraSetCenterCamera();
        }
