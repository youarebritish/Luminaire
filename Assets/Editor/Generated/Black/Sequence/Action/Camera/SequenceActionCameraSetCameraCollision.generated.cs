...
namespace Black.Sequence.Action.Camera
{
    public partial class SequenceActionCameraSetCameraCollision : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Camera.SequenceActionCameraSetCameraCollision", 0, Black.Sequence.Action.Camera.SequenceActionCameraSetCameraCollision.ObjectType, Construct, properties, 0, 376);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("enableFlag_", 3259172653, "bool", 368, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
        ...
        {
            return new SequenceActionCameraSetCameraCollision();
        }
