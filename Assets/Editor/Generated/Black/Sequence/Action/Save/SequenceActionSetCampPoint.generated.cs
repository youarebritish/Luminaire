...
namespace Black.Sequence.Action.Save
{
    public partial class SequenceActionSetCampPoint : Black.Sequence.Action.Save.SequenceActionSaveBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Save.SequenceActionSetCampPoint", 0, Black.Sequence.Action.Save.SequenceActionSetCampPoint.ObjectType, Construct, properties, 0, 464);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("restartPointId_", 406173680, "SQEX.Ebony.Std.Fixid", 456, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
        ...
        {
            return new SequenceActionSetCampPoint();
        }
