...
namespace Black.Sequence.Action.Save
{
    public partial class SequenceActionSaveDataBackupCarnival : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Save.SequenceActionSaveDataBackupCarnival", 0, Black.Sequence.Action.Save.SequenceActionSaveDataBackupCarnival.ObjectType, Construct, properties, 0, 376);
        }
        ...
        {
            return new SequenceActionSaveDataBackupCarnival();
        }
