...
namespace Black.Sequence.Action.Ecology
{
    public partial class SequenceActionEcologySystemStart : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Ecology.SequenceActionEcologySystemStart", 0, Black.Sequence.Action.Ecology.SequenceActionEcologySystemStart.ObjectType, Construct, properties, 0, 368);
        }
        ...
        {
            return new SequenceActionEcologySystemStart();
        }
