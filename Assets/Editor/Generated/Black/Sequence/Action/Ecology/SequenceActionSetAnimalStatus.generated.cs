...
namespace Black.Sequence.Action.Ecology
{
    public partial class SequenceActionSetAnimalStatus : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Ecology.SequenceActionSetAnimalStatus", 0, Black.Sequence.Action.Ecology.SequenceActionSetAnimalStatus.ObjectType, Construct, properties, 0, 464);
        }
        ...
        {
            return new SequenceActionSetAnimalStatus();
        }
