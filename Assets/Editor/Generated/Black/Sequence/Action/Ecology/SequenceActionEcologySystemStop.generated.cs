...
namespace Black.Sequence.Action.Ecology
{
    public partial class SequenceActionEcologySystemStop : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Ecology.SequenceActionEcologySystemStop", 0, Black.Sequence.Action.Ecology.SequenceActionEcologySystemStop.ObjectType, Construct, properties, 0, 368);
        }
        ...
        {
            return new SequenceActionEcologySystemStop();
        }
