...
namespace Black.Sequence.Action.Ecology
{
    public partial class SequenceActionEcologyTeamResultLotClear : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("valueId_.pinName_", 2271925927, "Base.String", 280, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("valueId_.name_", 1255370130, "Base.String", 296, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("valueId_.connections_", 4290358784, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 312, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("valueId_.pinValueType_", 3298525595, "Base.String", 344, 16, 1, Property.PrimitiveType.String, 0, (char)0));
