...
namespace Black.Sequence.Action.Ecology
{
    ...
    public partial class SequenceActionEcologyGetCharaBgmInfo : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
		...
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableInputPin valueCharacterId_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
		...
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableOutputPin valueCharaEntryPath_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableOutputPin valueLoadSuccess_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
		public uint teritoryCharacterId_;
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableOutputPin valueOverwriteParamId_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
