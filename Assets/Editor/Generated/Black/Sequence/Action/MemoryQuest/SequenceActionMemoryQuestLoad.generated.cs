...
namespace Black.Sequence.Action.MemoryQuest
{
    public partial class SequenceActionMemoryQuestLoad : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.MemoryQuest.SequenceActionMemoryQuestLoad", 0, Black.Sequence.Action.MemoryQuest.SequenceActionMemoryQuestLoad.ObjectType, Construct, properties, 0, 568);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("memoryQuestParamId_", 1346978041, "SQEX.Ebony.Std.Fixid", 560, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
        ...
        {
            return new SequenceActionMemoryQuestLoad();
        }
