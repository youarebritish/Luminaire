...
namespace Black.Sequence.Action.Vehicle
{
    public partial class SequenceActionChangeVehicleLooks : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("vehicleActor_.pinName_", 4137719552, "Base.String", 480, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("vehicleActor_.name_", 3438382315, "Base.String", 496, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("vehicleActor_.connections_", 1996356131, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 512, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("vehicleActor_.pinValueType_", 2568488414, "Base.String", 544, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("bodyPatternIdPin_.pinName_", 2766748163, "Base.String", 576, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("bodyPatternIdPin_.name_", 3877860782, "Base.String", 592, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("bodyPatternIdPin_.connections_", 1517775348, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 608, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("bodyPatternIdPin_.pinValueType_", 4042269351, "Base.String", 640, 16, 1, Property.PrimitiveType.String, 0, (char)0));
