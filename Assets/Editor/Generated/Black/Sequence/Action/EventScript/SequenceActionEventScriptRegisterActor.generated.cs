...
{
    public partial class SequenceActionEventScriptRegisterActor : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionEventScriptRegisterActor();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Action.EventScript.SequenceActionEventScriptRegisterActor", 0, Black.Sequence.Action.EventScript.SequenceActionEventScriptRegisterActor.ObjectType, Construct, properties, 0, 472);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.EventScript.SequenceActionEventScriptRegisterActor", base.GetFieldProperties(), -1076483415, -1722755908);
			...
			fieldProperties.AddProperty(new Property("characterId_", 1394587190, "Black.Event.Script.CharacterId", 464, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
        ...
        {
            return new SequenceActionEventScriptRegisterActor();
        }
