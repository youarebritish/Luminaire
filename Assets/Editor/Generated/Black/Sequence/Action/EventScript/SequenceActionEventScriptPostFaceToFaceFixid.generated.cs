...
namespace Black.Sequence.Action.EventScript
{
    public partial class SequenceActionEventScriptPostFaceToFaceFixid : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.EventScript.SequenceActionEventScriptPostFaceToFaceFixid", 0, Black.Sequence.Action.EventScript.SequenceActionEventScriptPostFaceToFaceFixid.ObjectType, Construct, properties, 0, 376);
        }
        ...
        {
            return new SequenceActionEventScriptPostFaceToFaceFixid();
        }
