...
namespace Black.Sequence.Action.Menu
{
    public partial class SequenceActionTutorialTitleWindow : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionTutorialTitleWindow", 0, Black.Sequence.Action.Menu.SequenceActionTutorialTitleWindow.ObjectType, Construct, properties, 0, 472);
        }
        ...
        {
            return new SequenceActionTutorialTitleWindow();
        }
