...
namespace Black.Sequence.Action.Menu
{
    public partial class SequenceActionTipsRequest : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionTipsRequest", 0, Black.Sequence.Action.Menu.SequenceActionTipsRequest.ObjectType, Construct, properties, 0, 376);
        }
        ...
        {
            return new SequenceActionTipsRequest();
        }
