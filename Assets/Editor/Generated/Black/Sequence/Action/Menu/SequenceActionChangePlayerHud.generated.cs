...
namespace Black.Sequence.Action.Menu
{
    public partial class SequenceActionChangePlayerHud : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionChangePlayerHud", 0, Black.Sequence.Action.Menu.SequenceActionChangePlayerHud.ObjectType, Construct, properties, 0, 464);
        }
        ...
        {
            return new SequenceActionChangePlayerHud();
        }
