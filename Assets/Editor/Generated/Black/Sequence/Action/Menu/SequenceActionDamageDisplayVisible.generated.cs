...
{
    public partial class SequenceActionDamageDisplayVisible : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionDamageDisplayVisible();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionDamageDisplayVisible", 0, Black.Sequence.Action.Menu.SequenceActionDamageDisplayVisible.ObjectType, Construct, properties, 0, 464);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.Menu.SequenceActionDamageDisplayVisible", base.GetFieldProperties(), 1417123733, 1197667363);
        ...
        {
            return new SequenceActionDamageDisplayVisible();
        }
