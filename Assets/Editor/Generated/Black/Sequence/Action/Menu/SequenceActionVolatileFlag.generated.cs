...
namespace Black.Sequence.Action.Menu
{
    public partial class SequenceActionVolatileFlag : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionVolatileFlag", 0, Black.Sequence.Action.Menu.SequenceActionVolatileFlag.ObjectType, Construct, properties, 0, 456);
        }
        ...
        {
            return new SequenceActionVolatileFlag();
        }
