...
namespace Black.Sequence.Action.Menu
{
    public partial class SequenceActionSetVisibleInteractionUI : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionSetVisibleInteractionUI", 0, Black.Sequence.Action.Menu.SequenceActionSetVisibleInteractionUI.ObjectType, Construct, properties, 0, 464);
        }
        ...
        {
            return new SequenceActionSetVisibleInteractionUI();
        }
