...
namespace Black.Sequence.Action.Menu
{
    public partial class SequenceActionTargetMarkVisible : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionTargetMarkVisible", 0, Black.Sequence.Action.Menu.SequenceActionTargetMarkVisible.ObjectType, Construct, properties, 0, 464);
        }
        ...
        {
            return new SequenceActionTargetMarkVisible();
        }
