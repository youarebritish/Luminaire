...
{
    public partial class SequenceActionSetVisibleContinueSave : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionSetVisibleContinueSave();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionSetVisibleContinueSave", 0, Black.Sequence.Action.Menu.SequenceActionSetVisibleContinueSave.ObjectType, Construct, properties, 0, 464);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.Menu.SequenceActionSetVisibleContinueSave", base.GetFieldProperties(), -916201218, 143866152);
        ...
        {
            return new SequenceActionSetVisibleContinueSave();
        }
