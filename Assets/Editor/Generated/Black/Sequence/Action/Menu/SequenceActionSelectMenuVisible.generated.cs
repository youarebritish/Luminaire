...
{
    public partial class SequenceActionSelectMenuVisible : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionSelectMenuVisible();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionSelectMenuVisible", 0, Black.Sequence.Action.Menu.SequenceActionSelectMenuVisible.ObjectType, Construct, properties, 0, 464);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.Menu.SequenceActionSelectMenuVisible", base.GetFieldProperties(), 349167775, -2084780781);
        ...
        {
            return new SequenceActionSelectMenuVisible();
        }
