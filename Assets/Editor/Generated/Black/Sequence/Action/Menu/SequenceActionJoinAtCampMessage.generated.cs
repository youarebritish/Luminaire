...
namespace Black.Sequence.Action.Menu
{
    public partial class SequenceActionJoinAtCampMessage : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionJoinAtCampMessage", 0, Black.Sequence.Action.Menu.SequenceActionJoinAtCampMessage.ObjectType, Construct, properties, 0, 368);
        }
        ...
        {
            return new SequenceActionJoinAtCampMessage();
        }
