...
namespace Black.Sequence.Action.Menu
{
    public partial class SequenceActionSetGaugeRatioSwfEntity : Black.Sequence.Action.Menu.SequenceActionSwfEntityHierarchyBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionSetGaugeRatioSwfEntity", 0, Black.Sequence.Action.Menu.SequenceActionSetGaugeRatioSwfEntity.ObjectType, Construct, properties, 0, 688);
        }
        ...
        {
            return new SequenceActionSetGaugeRatioSwfEntity();
        }
