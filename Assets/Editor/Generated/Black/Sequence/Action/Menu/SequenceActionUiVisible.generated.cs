...
{
    public partial class SequenceActionUiVisible : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionUiVisible();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionUiVisible", 0, Black.Sequence.Action.Menu.SequenceActionUiVisible.ObjectType, Construct, properties, 0, 464);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.Menu.SequenceActionUiVisible", base.GetFieldProperties(), -28233074, -10823670);
        ...
        {
            return new SequenceActionUiVisible();
        }
