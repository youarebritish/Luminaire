...
namespace Black.Sequence.Action.Menu
{
    public partial class SequenceActionSetPositionIndexSwfEntity : Black.Sequence.Action.Menu.SequenceActionSwfEntityBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionSetPositionIndexSwfEntity", 0, Black.Sequence.Action.Menu.SequenceActionSetPositionIndexSwfEntity.ObjectType, Construct, properties, 0, 688);
        }
        ...
        {
            return new SequenceActionSetPositionIndexSwfEntity();
        }
