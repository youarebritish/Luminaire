...
namespace Black.Sequence.Action.Menu
{
    public partial class SequenceActionStayInnEnd : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionStayInnEnd", 0, Black.Sequence.Action.Menu.SequenceActionStayInnEnd.ObjectType, Construct, properties, 0, 376);
        }
        ...
        {
            return new SequenceActionStayInnEnd();
        }
