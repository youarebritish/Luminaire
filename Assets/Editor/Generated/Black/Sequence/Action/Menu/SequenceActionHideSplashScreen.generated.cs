...
namespace Black.Sequence.Action.Menu
{
    public partial class SequenceActionHideSplashScreen : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionHideSplashScreen", 0, Black.Sequence.Action.Menu.SequenceActionHideSplashScreen.ObjectType, Construct, properties, 0, 368);
        }
        ...
        {
            return new SequenceActionHideSplashScreen();
        }
