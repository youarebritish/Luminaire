...
namespace Black.Sequence.Action.Menu
{
    public partial class SequenceActionTutorialInfoWindowArgs : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionTutorialInfoWindowArgs", 0, Black.Sequence.Action.Menu.SequenceActionTutorialInfoWindowArgs.ObjectType, Construct, properties, 0, 1104);
        }
        ...
        {
            return new SequenceActionTutorialInfoWindowArgs();
        }
