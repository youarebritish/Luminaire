...
namespace Black.Sequence.Action.Menu
{
    public partial class SequenceActionSetScaleSwfEntity : Black.Sequence.Action.Menu.SequenceActionSwfEntityBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Menu.SequenceActionSetScaleSwfEntity", 0, Black.Sequence.Action.Menu.SequenceActionSetScaleSwfEntity.ObjectType, Construct, properties, 0, 560);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("scale_.pinName_", 1530711485, "Base.String", 480, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("scale_.name_", 2479731144, "Base.String", 496, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("scale_.connections_", 578211846, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 512, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("scale_.pinValueType_", 382423565, "Base.String", 544, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionSetScaleSwfEntity();
        }
