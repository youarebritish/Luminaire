...
namespace Black.Sequence.Action.Chocobo
{
    public partial class SequenceActionRideOnChocobo : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Chocobo.SequenceActionRideOnChocobo", 0, Black.Sequence.Action.Chocobo.SequenceActionRideOnChocobo.ObjectType, Construct, properties, 0, 960);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("cameraNoPin_.pinName_", 1497944896, "Base.String", 840, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("cameraNoPin_.name_", 3459939115, "Base.String", 856, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("cameraNoPin_.connections_", 3240386147, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 872, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("cameraNoPin_.pinValueType_", 3383764510, "Base.String", 904, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionRideOnChocobo();
        }
