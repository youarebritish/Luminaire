...
namespace Black.Sequence.Action.Physics
{
    public partial class SequenceActionSetBodyDriverAllEnabled : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Physics.SequenceActionSetBodyDriverAllEnabled", 0, Black.Sequence.Action.Physics.SequenceActionSetBodyDriverAllEnabled.ObjectType, Construct, properties, 0, 464);
        }
        ...
        {
            return new SequenceActionSetBodyDriverAllEnabled();
        }
