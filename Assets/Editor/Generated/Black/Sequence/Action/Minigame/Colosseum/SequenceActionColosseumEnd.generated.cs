...
namespace Black.Sequence.Action.Minigame.Colosseum
{
    public partial class SequenceActionColosseumEnd : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Minigame.Colosseum.SequenceActionColosseumEnd", 0, Black.Sequence.Action.Minigame.Colosseum.SequenceActionColosseumEnd.ObjectType, Construct, properties, 0, 472);
        }
        ...
        {
            return new SequenceActionColosseumEnd();
        }
