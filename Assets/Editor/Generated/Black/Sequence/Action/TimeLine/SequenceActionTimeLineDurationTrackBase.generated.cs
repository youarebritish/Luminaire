...
namespace Black.Sequence.Action.TimeLine
{
    public partial class SequenceActionTimeLineDurationTrackBase : Black.Sequence.Action.TimeLine.SequenceActionTimeLineActorTrackBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.TimeLine.SequenceActionTimeLineDurationTrackBase", 0, Black.Sequence.Action.TimeLine.SequenceActionTimeLineDurationTrackBase.ObjectType, Construct, properties, 0, 400);
        }
        ...
        {
            return new SequenceActionTimeLineDurationTrackBase();
        }
