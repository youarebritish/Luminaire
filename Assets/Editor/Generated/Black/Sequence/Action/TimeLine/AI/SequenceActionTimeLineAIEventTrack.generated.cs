...
namespace Black.Sequence.Action.TimeLine.AI
{
    public partial class SequenceActionTimeLineAIEventTrack : Black.Sequence.Action.TimeLine.SequenceActionTimeLineDurationTrackBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.TimeLine.AI.SequenceActionTimeLineAIEventTrack", 0, Black.Sequence.Action.TimeLine.AI.SequenceActionTimeLineAIEventTrack.ObjectType, Construct, properties, 0, 400);
        }
        ...
        {
            return new SequenceActionTimeLineAIEventTrack();
        }
