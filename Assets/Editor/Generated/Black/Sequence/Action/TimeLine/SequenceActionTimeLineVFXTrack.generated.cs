...
namespace Black.Sequence.Action.TimeLine
{
    public partial class SequenceActionTimeLineVFXTrack : Black.Sequence.Action.TimeLine.SequenceActionTimeLineDurationTrackBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.TimeLine.SequenceActionTimeLineVFXTrack", 0, Black.Sequence.Action.TimeLine.SequenceActionTimeLineVFXTrack.ObjectType, Construct, properties, 0, 424);
        }
        ...
        {
            return new SequenceActionTimeLineVFXTrack();
        }
