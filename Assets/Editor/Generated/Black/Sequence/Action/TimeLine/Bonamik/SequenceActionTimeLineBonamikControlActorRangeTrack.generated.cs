...
namespace Black.Sequence.Action.TimeLine.Bonamik
{
    public partial class SequenceActionTimeLineBonamikControlActorRangeTrack : Black.Sequence.Action.TimeLine.SequenceActionTimeLineDurationTrackBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.TimeLine.Bonamik.SequenceActionTimeLineBonamikControlActorRangeTrack", 0, Black.Sequence.Action.TimeLine.Bonamik.SequenceActionTimeLineBonamikControlActorRangeTrack.ObjectType, Construct, properties, 0, 400);
        }
        ...
        {
            return new SequenceActionTimeLineBonamikControlActorRangeTrack();
        }
