...
namespace Black.Sequence.Action.TimeLine
{
    public partial class SequenceActionTimeLineActorTrackInterpBase : Black.Sequence.Action.TimeLine.SequenceActionTimeLineActorTrackBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.TimeLine.SequenceActionTimeLineActorTrackInterpBase", 0, Black.Sequence.Action.TimeLine.SequenceActionTimeLineActorTrackInterpBase.ObjectType, Construct, properties, 0, 352);
        }
        ...
        {
            return new SequenceActionTimeLineActorTrackInterpBase();
        }
