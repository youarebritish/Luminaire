...
namespace Black.Sequence.Action.TimeLine
{
    public partial class SequenceActionTimeLineSoundOptionTrackGeneral : Black.Sequence.Action.TimeLine.SequenceActionTimeLineDurationTrackBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.TimeLine.SequenceActionTimeLineSoundOptionTrackGeneral", 0, Black.Sequence.Action.TimeLine.SequenceActionTimeLineSoundOptionTrackGeneral.ObjectType, Construct, properties, 0, 440);
        }
        ...
        {
            return new SequenceActionTimeLineSoundOptionTrackGeneral();
        }
