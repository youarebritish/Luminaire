...
namespace Black.Sequence.Action.TimeLine.Camera.Shake
{
    public partial class SequenceActionTimeLineCameraShakeManualTrack : SQEX.Ebony.Framework.Sequence.Action.SequenceActionTimeLineTrackBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.TimeLine.Camera.Shake.SequenceActionTimeLineCameraShakeManualTrack", 0, Black.Sequence.Action.TimeLine.Camera.Shake.SequenceActionTimeLineCameraShakeManualTrack.ObjectType, Construct, properties, 0, 592);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("cameraActorPin_.pinName_", 1110337782, "Base.String", 328, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("cameraActorPin_.name_", 3328430017, "Base.String", 344, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("cameraActorPin_.connections_", 3699365665, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 360, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("cameraActorPin_.pinValueType_", 3273162808, "Base.String", 392, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionTimeLineCameraShakeManualTrack();
        }
