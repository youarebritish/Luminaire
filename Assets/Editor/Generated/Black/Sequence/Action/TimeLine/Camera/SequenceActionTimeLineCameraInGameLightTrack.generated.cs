...
namespace Black.Sequence.Action.TimeLine.Camera
{
    public partial class SequenceActionTimeLineCameraInGameLightTrack : Black.Sequence.Action.TimeLine.Camera.SequenceActionTimeLineCameraInGameLightBaseTrack
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.TimeLine.Camera.SequenceActionTimeLineCameraInGameLightTrack", 0, Black.Sequence.Action.TimeLine.Camera.SequenceActionTimeLineCameraInGameLightTrack.ObjectType, Construct, properties, 0, 2320);
        }
        ...
        {
            return new SequenceActionTimeLineCameraInGameLightTrack();
        }
