...
namespace Black.Sequence.Action.TimeLine.Camera
{
    public partial class SequenceActionTimeLineCameraFovTrack : Black.Sequence.Action.TimeLine.SequenceActionTimeLineActorTrackInterpBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.TimeLine.Camera.SequenceActionTimeLineCameraFovTrack", 0, Black.Sequence.Action.TimeLine.Camera.SequenceActionTimeLineCameraFovTrack.ObjectType, Construct, properties, 0, 528);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("masterTrackItem_.fov_", 1894015368, "float", 456, 4, 1, Property.PrimitiveType.Float, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("masterTrackItem_.interpMode_", 1696916378, "SQEX.Ebony.Framework.TimeControl.InterpMode", 460, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
        ...
        {
            return new SequenceActionTimeLineCameraFovTrack();
        }
