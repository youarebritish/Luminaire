...
namespace Black.Sequence.Action.TimeLine.Camera
{
    public partial class SequenceActionTimeLineCameraAttachTrack : Black.Sequence.Action.TimeLine.SequenceActionTimeLineActorTrackBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.TimeLine.Camera.SequenceActionTimeLineCameraAttachTrack", 0, Black.Sequence.Action.TimeLine.Camera.SequenceActionTimeLineCameraAttachTrack.ObjectType, Construct, properties, 0, 432);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("targetActor_.pinName_", 3733198037, "Base.String", 344, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("targetActor_.name_", 1572991568, "Base.String", 360, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("targetActor_.connections_", 2337539614, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 376, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("targetActor_.pinValueType_", 1641946197, "Base.String", 408, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			
			
			fieldProperties.AddProperty(new Property("targetActor_", 2552160338, "SQEX.Ebony.Framework.Node.GraphVariableInputPin", 336, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
        ...
        {
            return new SequenceActionTimeLineCameraAttachTrack();
        }
