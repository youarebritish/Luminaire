...
namespace Black.Sequence.Action.TimeLine.Camera.SeamlessInGame
{
    public partial class SequenceActionTimeLineCameraInGameTrackElementFov : Black.Sequence.Action.TimeLine.SequenceActionTimeLineDurationTrackBase
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("masterFovData_.startData_", 1870670370, "Black.System.TimeLine.TrackItem.Camera.Struct.InGameCameraFovStart", 472, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("masterFovData_.startData_.isChangeStartFov_", 3565471780, "bool", 480, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("masterFovData_.startData_.fovStartInterpMode_", 3696567945, "Black.Camera.BlendModeType", 484, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("masterFovData_.startData_.fovStartInterpTime_", 1650734847, "float", 488, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("masterFovData_.startData_.fovStartFInterpToSpeed_", 2612660406, "float", 492, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("masterFovData_.startData_.fovStartDegree_", 4236027050, "float", 496, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("masterFovData_.endData_", 1166283709, "Black.System.TimeLine.TrackItem.Camera.Struct.InGameCameraFovEnd", 504, 24, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("masterFovData_.endData_.isChangeEndFov_", 3793765842, "bool", 512, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("masterFovData_.endData_.fovEndInterpMode_", 4048913281, "Black.Camera.BlendModeType", 516, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("masterFovData_.endData_.fovEndInterpTime_", 821633463, "float", 520, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("masterFovData_.endData_.fovEndFInterpToSpeed_", 1307074334, "float", 524, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
