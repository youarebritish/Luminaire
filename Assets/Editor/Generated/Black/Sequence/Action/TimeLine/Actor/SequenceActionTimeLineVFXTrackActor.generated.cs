...
namespace Black.Sequence.Action.TimeLine.Actor
{
    public partial class SequenceActionTimeLineVFXTrackActor : Black.Sequence.Action.TimeLine.SequenceActionTimeLineVFXTrack
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.TimeLine.Actor.SequenceActionTimeLineVFXTrackActor", 0, Black.Sequence.Action.TimeLine.Actor.SequenceActionTimeLineVFXTrackActor.ObjectType, Construct, properties, 0, 424);
        }
        ...
        {
            return new SequenceActionTimeLineVFXTrackActor();
        }
