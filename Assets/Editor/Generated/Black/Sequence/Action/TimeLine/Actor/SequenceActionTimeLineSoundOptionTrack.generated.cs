...
namespace Black.Sequence.Action.TimeLine.Actor
{
    public partial class SequenceActionTimeLineSoundOptionTrack : Black.Sequence.Action.TimeLine.SequenceActionTimeLineDurationTrackBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.TimeLine.Actor.SequenceActionTimeLineSoundOptionTrack", 0, Black.Sequence.Action.TimeLine.Actor.SequenceActionTimeLineSoundOptionTrack.ObjectType, Construct, properties, 0, 400);
        }
        ...
        {
            return new SequenceActionTimeLineSoundOptionTrack();
        }
