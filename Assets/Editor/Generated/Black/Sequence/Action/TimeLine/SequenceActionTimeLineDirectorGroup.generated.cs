...
namespace Black.Sequence.Action.TimeLine
{
    public partial class SequenceActionTimeLineDirectorGroup : SQEX.Ebony.Framework.Sequence.Action.SequenceActionTimeLineTrackBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.TimeLine.SequenceActionTimeLineDirectorGroup", 0, Black.Sequence.Action.TimeLine.SequenceActionTimeLineDirectorGroup.ObjectType, Construct, properties, 0, 320);
        }
        ...
        {
            return new SequenceActionTimeLineDirectorGroup();
        }
