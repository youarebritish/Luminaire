...
namespace Black.Sequence.Action.Actor
{
    public partial class SequenceActionActorSetUseRootAnimation : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.SequenceActionActorSetUseRootAnimation", 0, Black.Sequence.Action.Actor.SequenceActionActorSetUseRootAnimation.ObjectType, Construct, properties, 0, 488);
        }
        ...
        {
            return new SequenceActionActorSetUseRootAnimation();
        }
