...
namespace Black.Sequence.Action.Actor
{
    public partial class SequenceActionActorSlow : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.SequenceActionActorSlow", 0, Black.Sequence.Action.Actor.SequenceActionActorSlow.ObjectType, Construct, properties, 0, 576);
        }
        ...
        {
            return new SequenceActionActorSlow();
        }
