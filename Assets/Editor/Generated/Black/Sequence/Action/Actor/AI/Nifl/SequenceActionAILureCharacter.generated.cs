...
namespace Black.Sequence.Action.Actor.AI.Nifl
{
    public partial class SequenceActionAILureCharacter : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.AI.Nifl.SequenceActionAILureCharacter", 0, Black.Sequence.Action.Actor.AI.Nifl.SequenceActionAILureCharacter.ObjectType, Construct, properties, 0, 496);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("baseActor_.pinName_", 2289734245, "Base.String", 384, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("baseActor_.name_", 2032294496, "Base.String", 400, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("baseActor_.connections_", 783239310, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 416, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("baseActor_.pinValueType_", 1945518373, "Base.String", 448, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionAILureCharacter();
        }
