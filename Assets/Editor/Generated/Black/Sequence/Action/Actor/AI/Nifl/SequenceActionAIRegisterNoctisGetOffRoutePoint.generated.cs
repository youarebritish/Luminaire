...
namespace Black.Sequence.Action.Actor.AI.Nifl
{
    public partial class SequenceActionAIRegisterNoctisGetOffRoutePoint : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.AI.Nifl.SequenceActionAIRegisterNoctisGetOffRoutePoint", 0, Black.Sequence.Action.Actor.AI.Nifl.SequenceActionAIRegisterNoctisGetOffRoutePoint.ObjectType, Construct, properties, 0, 552);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("routePoints_.pinName_", 3159820117, "Base.String", 472, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("routePoints_.name_", 3536894416, "Base.String", 488, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("routePoints_.connections_", 3724779678, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 504, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("routePoints_.pinValueType_", 206459861, "Base.String", 536, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionAIRegisterNoctisGetOffRoutePoint();
        }
