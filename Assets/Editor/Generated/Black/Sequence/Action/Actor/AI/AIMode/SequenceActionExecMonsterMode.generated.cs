...
namespace Black.Sequence.Action.Actor.AI.AIMode
{
    public partial class SequenceActionExecMonsterMode : Black.Sequence.Action.Actor.AI.AIMode.SequenceActionExecAIModeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.AI.AIMode.SequenceActionExecMonsterMode", 0, Black.Sequence.Action.Actor.AI.AIMode.SequenceActionExecMonsterMode.ObjectType, Construct, properties, 0, 1232);
        }
        ...
        {
            return new SequenceActionExecMonsterMode();
        }
