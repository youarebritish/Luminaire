...
namespace Black.Sequence.Action.Actor.AI.AIMode
{
    ...
    public partial class SequenceActionGetAIModeInfo : Black.Sequence.Actor.AI.SequenceActionAIBase
    {
		...
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableOutputPin aiModeId_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableOutputPin aiSubModeId_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
