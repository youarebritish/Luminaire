...
{
    public partial class SequenceActionActorGetPlayerActor : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionActorGetPlayerActor();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Action.Actor.SequenceActionActorGetPlayerActor", 0, Black.Sequence.Action.Actor.SequenceActionActorGetPlayerActor.ObjectType, Construct, properties, 0, 480);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.Actor.SequenceActionActorGetPlayerActor", base.GetFieldProperties(), 951089183, -120273917);
			...
			fieldProperties.AddProperty(new Property("actor_", 3434601855, "SQEX.Ebony.Framework.Node.GraphVariableOutputPin", 280, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
        ...
        {
            return new SequenceActionActorGetPlayerActor();
        }
