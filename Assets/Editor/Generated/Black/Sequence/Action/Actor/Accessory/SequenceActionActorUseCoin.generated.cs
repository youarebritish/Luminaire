...
{
    public partial class SequenceActionActorUseCoin : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
		...
		public SQEX.Ebony.Framework.Node.GraphVariableInputPin use_coin_;
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionActorUseCoin();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorUseCoin", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorUseCoin.ObjectType, Construct, properties, 0, 848);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.Actor.Accessory.SequenceActionActorUseCoin", base.GetFieldProperties(), -472476354, 1706152368);
			...
			fieldProperties.AddIndirectlyProperty(new Property("use_coin_.pinName_", 1967381636, "Base.String", 480, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("use_coin_.name_", 3769560991, "Base.String", 496, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("use_coin_.connections_", 3725482575, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 512, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("use_coin_.pinValueType_", 598768610, "Base.String", 544, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("useCoin_", 3758119626, "int", 464, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("use_coin_", 2635302229, "SQEX.Ebony.Framework.Node.GraphVariableInputPin", 472, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
        ...
        {
            return new SequenceActionActorUseCoin();
        }
