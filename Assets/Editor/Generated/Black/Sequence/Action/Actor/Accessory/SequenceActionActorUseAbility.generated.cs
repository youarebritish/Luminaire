...
namespace Black.Sequence.Action.Actor.Accessory
{
    public partial class SequenceActionActorUseAbility : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorUseAbility", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorUseAbility.ObjectType, Construct, properties, 0, 672);
        }
        ...
        {
            return new SequenceActionActorUseAbility();
        }
