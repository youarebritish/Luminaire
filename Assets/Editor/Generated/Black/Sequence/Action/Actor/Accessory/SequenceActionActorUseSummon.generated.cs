...
namespace Black.Sequence.Action.Actor.Accessory
{
    public partial class SequenceActionActorUseSummon : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorUseSummon", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorUseSummon.ObjectType, Construct, properties, 0, 768);
        }
        ...
        {
            return new SequenceActionActorUseSummon();
        }
