...
namespace Black.Sequence.Action.Actor.Accessory
{
    public partial class SequenceActionActorGetClothAmount : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetClothAmount", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetClothAmount.ObjectType, Construct, properties, 0, 664);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("clothId_", 2267967739, "SQEX.Ebony.Std.Fixid", 376, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
        ...
        {
            return new SequenceActionActorGetClothAmount();
        }
