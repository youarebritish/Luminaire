...
{
    public partial class SequenceActionActorUseCloth : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionActorUseCloth();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorUseCloth", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorUseCloth.ObjectType, Construct, properties, 0, 664);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.Actor.Accessory.SequenceActionActorUseCloth", base.GetFieldProperties(), 1245066768, 2065963932);
        ...
        {
            return new SequenceActionActorUseCloth();
        }
