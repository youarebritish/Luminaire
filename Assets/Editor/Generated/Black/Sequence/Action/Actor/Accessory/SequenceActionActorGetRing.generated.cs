...
namespace Black.Sequence.Action.Actor.Accessory
{
    public partial class SequenceActionActorGetRing : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetRing", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetRing.ObjectType, Construct, properties, 0, 768);
        }
        ...
        {
            return new SequenceActionActorGetRing();
        }
