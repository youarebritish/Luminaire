...
namespace Black.Sequence.Action.Actor.Accessory
{
    public partial class SequenceActionActorGetItemAmount : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetItemAmount", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetItemAmount.ObjectType, Construct, properties, 0, 664);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("itemId_", 2463901516, "SQEX.Ebony.Std.Fixid", 376, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
			fieldProperties.AddProperty(new Property("checkItem_", 2449001805, "int", 380, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
        ...
        {
            return new SequenceActionActorGetItemAmount();
        }
