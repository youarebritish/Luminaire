...
{
    public partial class SequenceActionActorGetMedalAmount : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionActorGetMedalAmount();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetMedalAmount", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetMedalAmount.ObjectType, Construct, properties, 0, 664);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetMedalAmount", base.GetFieldProperties(), 1489571694, 990820432);
			...
			fieldProperties.AddProperty(new Property("checkMedal_", 779656007, "int", 376, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
        ...
        {
            return new SequenceActionActorGetMedalAmount();
        }
