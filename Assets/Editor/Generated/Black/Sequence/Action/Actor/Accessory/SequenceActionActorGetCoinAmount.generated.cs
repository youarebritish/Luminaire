...
namespace Black.Sequence.Action.Actor.Accessory
{
    public partial class SequenceActionActorGetCoinAmount : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetCoinAmount", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetCoinAmount.ObjectType, Construct, properties, 0, 664);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("checkCoin_", 1957556255, "int", 376, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
        ...
        {
            return new SequenceActionActorGetCoinAmount();
        }
