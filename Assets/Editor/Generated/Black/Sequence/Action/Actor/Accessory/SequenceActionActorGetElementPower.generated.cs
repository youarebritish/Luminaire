...
namespace Black.Sequence.Action.Actor.Accessory
{
    public partial class SequenceActionActorGetElementPower : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetElementPower", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetElementPower.ObjectType, Construct, properties, 0, 768);
        }
        ...
        {
            return new SequenceActionActorGetElementPower();
        }
