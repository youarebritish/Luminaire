...
{
    public partial class SequenceActionActorFullSummon : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionActorFullSummon();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorFullSummon", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorFullSummon.ObjectType, Construct, properties, 0, 560);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.Actor.Accessory.SequenceActionActorFullSummon", base.GetFieldProperties(), 517451918, 1783902375);
        ...
        {
            return new SequenceActionActorFullSummon();
        }
