...
namespace Black.Sequence.Action.Actor.Accessory
{
    public partial class SequenceActionActorGetRingAmount : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetRingAmount", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetRingAmount.ObjectType, Construct, properties, 0, 664);
        }
        ...
        {
            return new SequenceActionActorGetRingAmount();
        }
