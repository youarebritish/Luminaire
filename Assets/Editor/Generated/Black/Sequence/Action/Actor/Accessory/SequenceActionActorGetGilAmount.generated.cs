...
{
    public partial class SequenceActionActorGetGilAmount : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionActorGetGilAmount();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetGilAmount", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetGilAmount.ObjectType, Construct, properties, 0, 664);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetGilAmount", base.GetFieldProperties(), 1687130069, -1217593027);
			...
			fieldProperties.AddProperty(new Property("checkGil_", 3651988302, "int", 376, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
        ...
        {
            return new SequenceActionActorGetGilAmount();
        }
