...
{
    public partial class SequenceActionActorGetAccessoryAmount : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionActorGetAccessoryAmount();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetAccessoryAmount", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetAccessoryAmount.ObjectType, Construct, properties, 0, 664);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetAccessoryAmount", base.GetFieldProperties(), -1995600765, -1345109928);
			...
			fieldProperties.AddProperty(new Property("accessoryId_", 3640441177, "SQEX.Ebony.Std.Fixid", 376, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
			fieldProperties.AddProperty(new Property("checkAccessory_", 2323278392, "int", 380, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
        ...
        {
            return new SequenceActionActorGetAccessoryAmount();
        }
