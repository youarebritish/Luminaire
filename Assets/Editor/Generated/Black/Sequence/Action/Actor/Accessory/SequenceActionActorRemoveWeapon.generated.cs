...
namespace Black.Sequence.Action.Actor.Accessory
{
    public partial class SequenceActionActorRemoveWeapon : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorRemoveWeapon", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorRemoveWeapon.ObjectType, Construct, properties, 0, 664);
        }
        ...
        {
            return new SequenceActionActorRemoveWeapon();
        }
