...
namespace Black.Sequence.Action.Actor.Accessory
{
    public partial class SequenceActionActorEquipWeaponNOX : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorEquipWeaponNOX", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorEquipWeaponNOX.ObjectType, Construct, properties, 0, 664);
        }
        ...
        {
            return new SequenceActionActorEquipWeaponNOX();
        }
