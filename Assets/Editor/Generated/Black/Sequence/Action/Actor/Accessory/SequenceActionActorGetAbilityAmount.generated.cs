...
namespace Black.Sequence.Action.Actor.Accessory
{
    public partial class SequenceActionActorGetAbilityAmount : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetAbilityAmount", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetAbilityAmount.ObjectType, Construct, properties, 0, 760);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("abilityId_", 2120138817, "SQEX.Ebony.Std.Fixid", 472, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
        ...
        {
            return new SequenceActionActorGetAbilityAmount();
        }
