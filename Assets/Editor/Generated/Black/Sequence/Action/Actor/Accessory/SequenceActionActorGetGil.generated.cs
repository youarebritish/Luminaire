...
namespace Black.Sequence.Action.Actor.Accessory
{
    public partial class SequenceActionActorGetGil : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetGil", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetGil.ObjectType, Construct, properties, 0, 848);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("get_gil_.pinName_", 2820175564, "Base.String", 480, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("get_gil_.name_", 3795968887, "Base.String", 496, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("get_gil_.connections_", 3856048215, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 512, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("get_gil_.pinValueType_", 983210490, "Base.String", 544, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("addGil_", 1447403617, "int", 464, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("get_gil_", 2045709101, "SQEX.Ebony.Framework.Node.GraphVariableInputPin", 472, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
        ...
        {
            return new SequenceActionActorGetGil();
        }
