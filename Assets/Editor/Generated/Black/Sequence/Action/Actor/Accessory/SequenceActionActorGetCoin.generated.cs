...
namespace Black.Sequence.Action.Actor.Accessory
{
    public partial class SequenceActionActorGetCoin : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetCoin", 0, Black.Sequence.Action.Actor.Accessory.SequenceActionActorGetCoin.ObjectType, Construct, properties, 0, 848);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("get_coin_.pinName_", 2561013561, "Base.String", 480, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("get_coin_.name_", 626485380, "Base.String", 496, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("get_coin_.connections_", 2347882810, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 512, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("get_coin_.pinValueType_", 1033020665, "Base.String", 544, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("addCoin_", 1030677322, "int", 464, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("get_coin_", 3394908478, "SQEX.Ebony.Framework.Node.GraphVariableInputPin", 472, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
        ...
        {
            return new SequenceActionActorGetCoin();
        }
