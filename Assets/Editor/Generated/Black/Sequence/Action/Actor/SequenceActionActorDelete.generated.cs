...
namespace Black.Sequence.Action.Actor
{
    public partial class SequenceActionActorDelete : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.SequenceActionActorDelete", 0, Black.Sequence.Action.Actor.SequenceActionActorDelete.ObjectType, Construct, properties, 0, 480);
        }
        ...
        {
            return new SequenceActionActorDelete();
        }
