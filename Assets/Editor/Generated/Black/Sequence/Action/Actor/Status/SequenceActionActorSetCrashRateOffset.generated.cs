...
namespace Black.Sequence.Action.Actor.Status
{
    public partial class SequenceActionActorSetCrashRateOffset : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Status.SequenceActionActorSetCrashRateOffset", 0, Black.Sequence.Action.Actor.Status.SequenceActionActorSetCrashRateOffset.ObjectType, Construct, properties, 0, 376);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("crashRateOffset_", 3515873974, "int", 368, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
        ...
        {
            return new SequenceActionActorSetCrashRateOffset();
        }
