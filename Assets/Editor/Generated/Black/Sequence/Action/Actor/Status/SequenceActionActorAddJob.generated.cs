...
namespace Black.Sequence.Action.Actor.Status
{
    public partial class SequenceActionActorAddJob : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Status.SequenceActionActorAddJob", 0, Black.Sequence.Action.Actor.Status.SequenceActionActorAddJob.ObjectType, Construct, properties, 0, 376);
        }
        ...
        {
            return new SequenceActionActorAddJob();
        }
