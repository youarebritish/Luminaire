...
namespace Black.Sequence.Action.Actor.Status
{
    public partial class SequenceActionActorSetAbilityPoint : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Status.SequenceActionActorSetAbilityPoint", 0, Black.Sequence.Action.Actor.Status.SequenceActionActorSetAbilityPoint.ObjectType, Construct, properties, 0, 584);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("menu_finish_.pinName_", 2651486068, "Base.String", 496, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("menu_finish_.name_", 2957335439, "Base.String", 512, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("menu_finish_.connections_", 1116090655, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 528, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("menu_finish_.delayType_", 3369261961, "SQEX.Ebony.Framework.Node.GraphPin.DelayType", 560, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("menu_finish_.delayTime_", 1145013262, "float", 564, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("menu_finish_.delayMaxTime_", 2283442660, "float", 568, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
        ...
        {
            return new SequenceActionActorSetAbilityPoint();
        }
