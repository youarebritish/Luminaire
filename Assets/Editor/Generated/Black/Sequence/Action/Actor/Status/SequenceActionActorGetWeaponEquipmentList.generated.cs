...
namespace Black.Sequence.Action.Actor.Status
{
    public partial class SequenceActionActorGetWeaponEquipmentList : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Status.SequenceActionActorGetWeaponEquipmentList", 0, Black.Sequence.Action.Actor.Status.SequenceActionActorGetWeaponEquipmentList.ObjectType, Construct, properties, 0, 752);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("weaponElemIdListPin_.pinName_", 8572906, "Base.String", 488, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("weaponElemIdListPin_.name_", 1577705077, "Base.String", 504, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("weaponElemIdListPin_.connections_", 2806720749, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 520, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("weaponElemIdListPin_.pinValueType_", 3227202300, "Base.String", 552, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("weaponTypeIdListPin_.pinName_", 4254318075, "Base.String", 576, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("weaponTypeIdListPin_.name_", 85450486, "Base.String", 592, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("weaponTypeIdListPin_.connections_", 576426764, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 608, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("weaponTypeIdListPin_.pinValueType_", 1628374735, "Base.String", 640, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionActorGetWeaponEquipmentList();
        }
