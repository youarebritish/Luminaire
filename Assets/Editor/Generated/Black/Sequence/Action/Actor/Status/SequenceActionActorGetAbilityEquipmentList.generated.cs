...
namespace Black.Sequence.Action.Actor.Status
{
    public partial class SequenceActionActorGetAbilityEquipmentList : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Status.SequenceActionActorGetAbilityEquipmentList", 0, Black.Sequence.Action.Actor.Status.SequenceActionActorGetAbilityEquipmentList.ObjectType, Construct, properties, 0, 760);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("abilityElemIdListPin_.pinName_", 2139921242, "Base.String", 496, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("abilityElemIdListPin_.name_", 3995701541, "Base.String", 512, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("abilityElemIdListPin_.connections_", 24259005, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 528, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("abilityElemIdListPin_.pinValueType_", 3691624108, "Base.String", 560, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionActorGetAbilityEquipmentList();
        }
