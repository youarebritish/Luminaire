...
namespace Black.Sequence.Action.Actor.Status
{
    public partial class SequenceActionActorSetStatusCountDefence : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Status.SequenceActionActorSetStatusCountDefence", 0, Black.Sequence.Action.Actor.Status.SequenceActionActorSetStatusCountDefence.ObjectType, Construct, properties, 0, 576);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("defencePin_.pinName_", 2350357978, "Base.String", 488, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("defencePin_.name_", 1615235237, "Base.String", 504, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("defencePin_.connections_", 2051724349, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 520, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("defencePin_.pinValueType_", 2568887852, "Base.String", 552, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionActorSetStatusCountDefence();
        }
