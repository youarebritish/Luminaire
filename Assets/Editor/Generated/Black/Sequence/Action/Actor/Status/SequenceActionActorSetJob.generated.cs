...
namespace Black.Sequence.Action.Actor.Status
{
    public partial class SequenceActionActorSetJob : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Status.SequenceActionActorSetJob", 0, Black.Sequence.Action.Actor.Status.SequenceActionActorSetJob.ObjectType, Construct, properties, 0, 376);
        }
        ...
        {
            return new SequenceActionActorSetJob();
        }
