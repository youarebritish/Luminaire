...
namespace Black.Sequence.Action.Actor.Status
{
    public partial class SequenceActionActorSetDeath : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Status.SequenceActionActorSetDeath", 0, Black.Sequence.Action.Actor.Status.SequenceActionActorSetDeath.ObjectType, Construct, properties, 0, 472);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("bGetExp_", 4040954275, "bool", 464, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
        ...
        {
            return new SequenceActionActorSetDeath();
        }
