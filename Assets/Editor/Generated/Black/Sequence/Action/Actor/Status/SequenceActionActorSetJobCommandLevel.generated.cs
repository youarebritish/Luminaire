...
namespace Black.Sequence.Action.Actor.Status
{
    public partial class SequenceActionActorSetJobCommandLevel : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Status.SequenceActionActorSetJobCommandLevel", 0, Black.Sequence.Action.Actor.Status.SequenceActionActorSetJobCommandLevel.ObjectType, Construct, properties, 0, 672);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("job_command_level_", 3396505596, "int32_t", 472, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
        ...
        {
            return new SequenceActionActorSetJobCommandLevel();
        }
