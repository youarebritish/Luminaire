...
namespace Black.Sequence.Action.Actor
{
    public partial class SequenceActionActorPlayBodyLinkAnimTransitionTime : BaseObject
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.SequenceActionActorPlayBodyLinkAnimTransitionTime", 0, Black.Sequence.Action.Actor.SequenceActionActorPlayBodyLinkAnimTransitionTime.ObjectType, Construct, properties, 0, 16);
        }
        ...
        {
            return new SequenceActionActorPlayBodyLinkAnimTransitionTime();
        }
