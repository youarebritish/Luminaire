...
namespace Black.Sequence.Action.Actor
{
    public partial class SequenceActionActorDetectDestroyed : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.SequenceActionActorDetectDestroyed", 0, Black.Sequence.Action.Actor.SequenceActionActorDetectDestroyed.ObjectType, Construct, properties, 0, 480);
        }
        ...
        {
            return new SequenceActionActorDetectDestroyed();
        }
