...
namespace Black.Sequence.Action.Actor
{
    public partial class SequenceActionActorSetStaticModelVisible : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("visiblePin_.pinName_", 3397599676, "Base.String", 384, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("visiblePin_.name_", 4106633063, "Base.String", 400, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("visiblePin_.connections_", 1157444391, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 416, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("visiblePin_.pinValueType_", 2910834538, "Base.String", 448, 16, 1, Property.PrimitiveType.String, 0, (char)0));
