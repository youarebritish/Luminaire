...
{
    public partial class SequenceActionActorAreaNPCRemove : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionActorAreaNPCRemove();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Action.Actor.SequenceActionActorAreaNPCRemove", 0, Black.Sequence.Action.Actor.SequenceActionActorAreaNPCRemove.ObjectType, Construct, properties, 0, 472);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Action.Actor.SequenceActionActorAreaNPCRemove", base.GetFieldProperties(), 452016791, 1800734699);
			...
			fieldProperties.AddProperty(new Property("areaNo_", 1202998740, "int32_t", 464, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
        ...
        {
            return new SequenceActionActorAreaNPCRemove();
        }
