...
namespace Black.Sequence.Action.Actor.Physics
{
    public partial class SequenceActionActorResetPhysics : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.Physics.SequenceActionActorResetPhysics", 0, Black.Sequence.Action.Actor.Physics.SequenceActionActorResetPhysics.ObjectType, Construct, properties, 0, 472);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("phxGroup_", 2064483235, "SQEX.Ebony.Std.Fixid", 464, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
        ...
        {
            return new SequenceActionActorResetPhysics();
        }
