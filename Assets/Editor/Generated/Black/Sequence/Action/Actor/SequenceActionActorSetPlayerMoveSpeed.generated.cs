...
namespace Black.Sequence.Action.Actor
{
    public partial class SequenceActionActorSetPlayerMoveSpeed : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.SequenceActionActorSetPlayerMoveSpeed", 0, Black.Sequence.Action.Actor.SequenceActionActorSetPlayerMoveSpeed.ObjectType, Construct, properties, 0, 472);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("speed_", 1253745677, "float", 464, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
        ...
        {
            return new SequenceActionActorSetPlayerMoveSpeed();
        }
