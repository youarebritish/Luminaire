...
namespace Black.Sequence.Action.Actor.StatusGrow
{
    public partial class SequenceActionActorAddLevel : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.StatusGrow.SequenceActionActorAddLevel", 0, Black.Sequence.Action.Actor.StatusGrow.SequenceActionActorAddLevel.ObjectType, Construct, properties, 0, 560);
        }
        ...
        {
            return new SequenceActionActorAddLevel();
        }
