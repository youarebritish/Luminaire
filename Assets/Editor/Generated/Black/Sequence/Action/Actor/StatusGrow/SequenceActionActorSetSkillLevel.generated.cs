...
namespace Black.Sequence.Action.Actor.StatusGrow
{
    public partial class SequenceActionActorSetSkillLevel : Black.Sequence.Actor.SequenceActionActorStatusOneBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.StatusGrow.SequenceActionActorSetSkillLevel", 0, Black.Sequence.Action.Actor.StatusGrow.SequenceActionActorSetSkillLevel.ObjectType, Construct, properties, 0, 560);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("level_pin_.pinName_", 797960545, "Base.String", 480, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("level_pin_.name_", 1311544348, "Base.String", 496, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("level_pin_.connections_", 3242368002, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 512, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("level_pin_.pinValueType_", 1894959729, "Base.String", 544, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionActorSetSkillLevel();
        }
