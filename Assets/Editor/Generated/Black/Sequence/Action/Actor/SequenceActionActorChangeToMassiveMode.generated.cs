...
namespace Black.Sequence.Action.Actor
{
    public partial class SequenceActionActorChangeToMassiveMode : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.SequenceActionActorChangeToMassiveMode", 0, Black.Sequence.Action.Actor.SequenceActionActorChangeToMassiveMode.ObjectType, Construct, properties, 0, 480);
        }
        ...
        {
            return new SequenceActionActorChangeToMassiveMode();
        }
