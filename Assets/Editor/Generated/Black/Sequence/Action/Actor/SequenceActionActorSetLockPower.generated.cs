...
namespace Black.Sequence.Action.Actor
{
    public partial class SequenceActionActorSetLockPower : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.SequenceActionActorSetLockPower", 0, Black.Sequence.Action.Actor.SequenceActionActorSetLockPower.ObjectType, Construct, properties, 0, 568);
        }
        ...
        {
            return new SequenceActionActorSetLockPower();
        }
