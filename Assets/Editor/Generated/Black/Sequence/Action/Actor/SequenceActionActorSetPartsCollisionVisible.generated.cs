...
namespace Black.Sequence.Action.Actor
{
    public partial class SequenceActionActorSetPartsCollisionVisible : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Actor.SequenceActionActorSetPartsCollisionVisible", 0, Black.Sequence.Action.Actor.SequenceActionActorSetPartsCollisionVisible.ObjectType, Construct, properties, 0, 488);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("isVisible_", 3195904618, "bool", 464, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddProperty(new Property("partsIDList_", 3551626069, "SQEX.Ebony.Std.DynamicArray< Black.Sequence.Action.Actor.SequenceActionActorSetPartsCollisionVisibleInfo* >", 472, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)0));
        ...
        {
            return new SequenceActionActorSetPartsCollisionVisible();
        }
