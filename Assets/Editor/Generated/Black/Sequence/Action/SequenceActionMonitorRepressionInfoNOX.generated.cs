...
namespace Black.Sequence.Action
{
    public partial class SequenceActionMonitorRepressionInfoNOX : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.SequenceActionMonitorRepressionInfoNOX", 0, Black.Sequence.Action.SequenceActionMonitorRepressionInfoNOX.ObjectType, Construct, properties, 0, 464);
        }
        ...
        {
            return new SequenceActionMonitorRepressionInfoNOX();
        }
