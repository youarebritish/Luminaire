...
namespace Black.Sequence.Action.Render
{
    public partial class SequenceActionSetNVShadowLib : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Render.SequenceActionSetNVShadowLib", 0, Black.Sequence.Action.Render.SequenceActionSetNVShadowLib.ObjectType, Construct, properties, 0, 376);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("filterMode_", 2902685693, "Black.Sequence.Action.Render.SequenceActionSetNVShadowLib.FILTER_MODE_TYPE", 372, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
        ...
        {
            return new SequenceActionSetNVShadowLib();
        }
