...
namespace Black.Sequence.Action.Render
{
    public partial class SequenceActionSetVRPosRot : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Render.SequenceActionSetVRPosRot", 0, Black.Sequence.Action.Render.SequenceActionSetVRPosRot.ObjectType, Construct, properties, 0, 384);
        }
        ...
        {
            return new SequenceActionSetVRPosRot();
        }
