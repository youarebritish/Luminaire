...
namespace Black.Sequence.Action.System
{
    public partial class SequenceActionGetCarnivalType : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.System.SequenceActionGetCarnivalType", 0, Black.Sequence.Action.System.SequenceActionGetCarnivalType.ObjectType, Construct, properties, 0, 464);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("mog_choco_.pinName_", 2144645999, "Base.String", 376, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("mog_choco_.name_", 1460752650, "Base.String", 392, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("mog_choco_.connections_", 3639411464, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 408, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("mog_choco_.delayType_", 4252803534, "SQEX.Ebony.Framework.Node.GraphPin.DelayType", 440, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("mog_choco_.delayTime_", 3097873033, "float", 444, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("mog_choco_.delayMaxTime_", 4093779253, "float", 448, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
        ...
        {
            return new SequenceActionGetCarnivalType();
        }
