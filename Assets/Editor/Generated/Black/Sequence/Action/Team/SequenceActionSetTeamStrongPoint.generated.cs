...
namespace Black.Sequence.Action.Team
{
    public partial class SequenceActionSetTeamStrongPoint : Black.Sequence.Action.Team.SequenceActionTeamBase
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("strPoint_.pinName_", 585908238, "Base.String", 384, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("strPoint_.name_", 181986121, "Base.String", 400, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("strPoint_.connections_", 1785955257, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 416, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("strPoint_.pinValueType_", 3408273472, "Base.String", 448, 16, 1, Property.PrimitiveType.String, 0, (char)0));
