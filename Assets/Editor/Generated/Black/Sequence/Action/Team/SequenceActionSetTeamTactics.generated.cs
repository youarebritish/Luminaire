...
namespace Black.Sequence.Action.Team
{
    public partial class SequenceActionSetTeamTactics : Black.Sequence.Action.Team.SequenceActionTeamBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Team.SequenceActionSetTeamTactics", 0, Black.Sequence.Action.Team.SequenceActionSetTeamTactics.ObjectType, Construct, properties, 0, 504);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("inSetTeam_.pinName_", 2913143455, "Base.String", 384, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("inSetTeam_.name_", 1697400058, "Base.String", 400, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("inSetTeam_.connections_", 656357912, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 416, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("inSetTeam_.pinValueType_", 984753091, "Base.String", 448, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionSetTeamTactics();
        }
