...
namespace Black.Sequence.Action.Interaction
{
    public partial class SequenceActionInteractionOverrideId : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Interaction.SequenceActionInteractionOverrideId", 0, Black.Sequence.Action.Interaction.SequenceActionInteractionOverrideId.ObjectType, Construct, properties, 0, 608);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("interactionId_", 1818027579, "SQEX.Ebony.Std.Fixid", 556, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
			fieldProperties.AddProperty(new Property("clearInteractionId_", 3152156496, "bool", 560, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
        ...
        {
            return new SequenceActionInteractionOverrideId();
        }
