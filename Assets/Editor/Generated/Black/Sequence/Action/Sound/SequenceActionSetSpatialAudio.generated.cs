...
namespace Black.Sequence.Action.Sound
{
    public partial class SequenceActionSetSpatialAudio : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Sound.SequenceActionSetSpatialAudio", 0, Black.Sequence.Action.Sound.SequenceActionSetSpatialAudio.ObjectType, Construct, properties, 0, 552);
        }
        ...
        {
            return new SequenceActionSetSpatialAudio();
        }
