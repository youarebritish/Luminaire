...
namespace Black.Sequence.Action.Sound
{
    public partial class SequenceActionPlayMenuSoundEntity : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Sound.SequenceActionPlayMenuSoundEntity", 0, Black.Sequence.Action.Sound.SequenceActionPlayMenuSoundEntity.ObjectType, Construct, properties, 0, 464);
        }
        ...
        {
            return new SequenceActionPlayMenuSoundEntity();
        }
