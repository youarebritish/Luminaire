...
namespace Black.Sequence.Action.Quest
{
    public partial class SequenceActionCheckQuestKind : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Quest.SequenceActionCheckQuestKind", 0, Black.Sequence.Action.Quest.SequenceActionCheckQuestKind.ObjectType, Construct, properties, 0, 472);
        }
        ...
        {
            return new SequenceActionCheckQuestKind();
        }
