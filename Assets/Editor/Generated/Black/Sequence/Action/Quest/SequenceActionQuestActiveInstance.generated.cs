...
namespace Black.Sequence.Action.Quest
{
    public partial class SequenceActionQuestActiveInstance : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Action.Quest.SequenceActionQuestActiveInstance", 0, Black.Sequence.Action.Quest.SequenceActionQuestActiveInstance.ObjectType, Construct, properties, 0, 560);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("questEntryIdPin_.pinName_", 1726111633, "Base.String", 472, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("questEntryIdPin_.name_", 375169612, "Base.String", 488, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("questEntryIdPin_.connections_", 9574866, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 504, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("questEntryIdPin_.pinValueType_", 1499963553, "Base.String", 536, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionQuestActiveInstance();
        }
