...
namespace Black.Sequence.ScreenEffect
{
    public partial class SequenceActionSetWaterTemporalAA : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("enable_pin_.pinName_", 1883697818, "Base.String", 384, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("enable_pin_.name_", 1141161317, "Base.String", 400, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("enable_pin_.connections_", 3876082941, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 416, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("enable_pin_.pinValueType_", 4046991340, "Base.String", 448, 16, 1, Property.PrimitiveType.String, 0, (char)0));
