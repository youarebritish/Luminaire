...
namespace Black.Sequence.Actor
{
    public partial class SequenceVariableActorBase : SQEX.Ebony.Framework.Sequence.SequenceVariable
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceVariableActorBase", 0, Black.Sequence.Actor.SequenceVariableActorBase.ObjectType, Construct, properties, 0, 232);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("inValue_", 2850905696, "SQEX.Ebony.Framework.Node.GraphVariableInputPin", 88, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
        ...
        {
            return new SequenceVariableActorBase();
        }
