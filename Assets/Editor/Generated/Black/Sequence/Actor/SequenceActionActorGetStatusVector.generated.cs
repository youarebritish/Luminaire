...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorGetStatusVector : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorGetStatusVector", 0, Black.Sequence.Actor.SequenceActionActorGetStatusVector.ObjectType, Construct, properties, 0, 592);
        }
        ...
        {
            return new SequenceActionActorGetStatusVector();
        }
