...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorGetStatusFloat : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorGetStatusFloat", 0, Black.Sequence.Actor.SequenceActionActorGetStatusFloat.ObjectType, Construct, properties, 0, 584);
        }
        ...
        {
            return new SequenceActionActorGetStatusFloat();
        }
