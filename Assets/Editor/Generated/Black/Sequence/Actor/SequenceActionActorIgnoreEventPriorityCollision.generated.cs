...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorIgnoreEventPriorityCollision : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorIgnoreEventPriorityCollision", 0, Black.Sequence.Actor.SequenceActionActorIgnoreEventPriorityCollision.ObjectType, Construct, properties, 0, 568);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("isIgnore_", 1566830948, "bool", 560, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
        ...
        {
            return new SequenceActionActorIgnoreEventPriorityCollision();
        }
