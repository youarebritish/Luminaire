...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorSetStatusInt : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorSetStatusInt", 0, Black.Sequence.Actor.SequenceActionActorSetStatusInt.ObjectType, Construct, properties, 0, 584);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("int_", 4287716243, "SQEX.Ebony.Framework.Node.GraphVariableInputPin", 480, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("value_", 273093519, "int", 576, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
        ...
        {
            return new SequenceActionActorSetStatusInt();
        }
