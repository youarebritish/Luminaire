...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionStopBgm : Black.Sequence.Actor.SequenceActionBgmBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionStopBgm", 0, Black.Sequence.Actor.SequenceActionStopBgm.ObjectType, Construct, properties, 0, 392);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("isPose_", 3527172593, "bool", 380, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddProperty(new Property("isKeepContinue_", 523499906, "bool", 381, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
        ...
        {
            return new SequenceActionStopBgm();
        }
