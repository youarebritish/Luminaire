...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorChangeCharacterMeshCollision : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorChangeCharacterMeshCollision", 0, Black.Sequence.Actor.SequenceActionActorChangeCharacterMeshCollision.ObjectType, Construct, properties, 0, 520);
        }
        ...
        {
            return new SequenceActionActorChangeCharacterMeshCollision();
        }
