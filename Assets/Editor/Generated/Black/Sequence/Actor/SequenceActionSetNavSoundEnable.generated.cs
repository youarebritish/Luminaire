...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionSetNavSoundEnable : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionSetNavSoundEnable", 0, Black.Sequence.Actor.SequenceActionSetNavSoundEnable.ObjectType, Construct, properties, 0, 384);
        }
        ...
        {
            return new SequenceActionSetNavSoundEnable();
        }
