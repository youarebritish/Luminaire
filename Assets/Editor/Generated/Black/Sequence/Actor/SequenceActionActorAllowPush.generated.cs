...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorAllowPush : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorAllowPush", 0, Black.Sequence.Actor.SequenceActionActorAllowPush.ObjectType, Construct, properties, 0, 568);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("isAllow_", 756260615, "bool", 560, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
        ...
        {
            return new SequenceActionActorAllowPush();
        }
