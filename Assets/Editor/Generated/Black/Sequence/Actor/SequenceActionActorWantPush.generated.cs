...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorWantPush : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorWantPush", 0, Black.Sequence.Actor.SequenceActionActorWantPush.ObjectType, Construct, properties, 0, 568);
        }
        ...
        {
            return new SequenceActionActorWantPush();
        }
