...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorChangeStepHeight : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorChangeStepHeight", 0, Black.Sequence.Actor.SequenceActionActorChangeStepHeight.ObjectType, Construct, properties, 0, 568);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("stepHeight_", 4105229821, "float", 560, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
        ...
        {
            return new SequenceActionActorChangeStepHeight();
        }
