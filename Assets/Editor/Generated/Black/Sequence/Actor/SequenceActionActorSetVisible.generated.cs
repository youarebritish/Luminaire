...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorSetVisible : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorSetVisible", 0, Black.Sequence.Actor.SequenceActionActorSetVisible.ObjectType, Construct, properties, 0, 568);
        }
        ...
        {
            return new SequenceActionActorSetVisible();
        }
