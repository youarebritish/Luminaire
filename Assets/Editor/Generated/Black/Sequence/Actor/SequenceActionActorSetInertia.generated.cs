...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorSetInertia : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorSetInertia", 0, Black.Sequence.Actor.SequenceActionActorSetInertia.ObjectType, Construct, properties, 0, 480);
        }
        ...
        {
            return new SequenceActionActorSetInertia();
        }
