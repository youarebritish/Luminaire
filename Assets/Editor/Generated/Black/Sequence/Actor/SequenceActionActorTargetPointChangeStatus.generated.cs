...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorTargetPointChangeStatus : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorTargetPointChangeStatus", 0, Black.Sequence.Actor.SequenceActionActorTargetPointChangeStatus.ObjectType, Construct, properties, 0, 480);
        }
        ...
        {
            return new SequenceActionActorTargetPointChangeStatus();
        }
