...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionInteractionFlag : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionInteractionFlag", 0, Black.Sequence.Actor.SequenceActionInteractionFlag.ObjectType, Construct, properties, 0, 576);
        }
        ...
        {
            return new SequenceActionInteractionFlag();
        }
