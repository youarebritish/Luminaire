...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionInteractionEnd : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionInteractionEnd", 0, Black.Sequence.Actor.SequenceActionInteractionEnd.ObjectType, Construct, properties, 0, 488);
        }
        ...
        {
            return new SequenceActionInteractionEnd();
        }
