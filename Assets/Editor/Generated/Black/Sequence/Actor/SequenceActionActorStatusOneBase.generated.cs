...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorStatusOneBase : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorStatusOneBase", 0, Black.Sequence.Actor.SequenceActionActorStatusOneBase.ObjectType, Construct, properties, 0, 464);
        }
        ...
        {
            return new SequenceActionActorStatusOneBase();
        }
