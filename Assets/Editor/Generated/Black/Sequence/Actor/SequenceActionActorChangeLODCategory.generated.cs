...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorChangeLODCategory : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorChangeLODCategory", 0, Black.Sequence.Actor.SequenceActionActorChangeLODCategory.ObjectType, Construct, properties, 0, 488);
        }
        ...
        {
            return new SequenceActionActorChangeLODCategory();
        }
