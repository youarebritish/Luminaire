...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorGetExeActor : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorGetExeActor", 0, Black.Sequence.Actor.SequenceActionActorGetExeActor.ObjectType, Construct, properties, 0, 472);
        }
        ...
        {
            return new SequenceActionActorGetExeActor();
        }
