...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorSetStatusEffectVisible : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorSetStatusEffectVisible", 0, Black.Sequence.Actor.SequenceActionActorSetStatusEffectVisible.ObjectType, Construct, properties, 0, 576);
        }
        ...
        {
            return new SequenceActionActorSetStatusEffectVisible();
        }
