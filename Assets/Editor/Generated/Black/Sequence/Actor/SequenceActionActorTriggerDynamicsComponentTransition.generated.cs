...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorTriggerDynamicsComponentTransition : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorTriggerDynamicsComponentTransition", 0, Black.Sequence.Actor.SequenceActionActorTriggerDynamicsComponentTransition.ObjectType, Construct, properties, 0, 592);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("inRigidBody_.pinName_", 2419849713, "Base.String", 472, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("inRigidBody_.name_", 4162976492, "Base.String", 488, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("inRigidBody_.connections_", 2875506802, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 504, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("inRigidBody_.pinValueType_", 542243777, "Base.String", 536, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceActionActorTriggerDynamicsComponentTransition();
        }
