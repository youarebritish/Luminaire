...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorChangeWeight : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorChangeWeight", 0, Black.Sequence.Actor.SequenceActionActorChangeWeight.ObjectType, Construct, properties, 0, 568);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("weight_", 3537511442, "float", 560, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
        ...
        {
            return new SequenceActionActorChangeWeight();
        }
