...
namespace Black.Sequence.Actor.AI
{
    public partial class SequenceActionAISetLookAtTarget : Black.Sequence.Actor.AI.SequenceActionAIBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.AI.SequenceActionAISetLookAtTarget", 0, Black.Sequence.Actor.AI.SequenceActionAISetLookAtTarget.ObjectType, Construct, properties, 0, 568);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("reset_", 2999468877, "bool", 552, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddProperty(new Property("lookPointType_", 151937229, "Black.Actor.Component.IK.ATIK_POINT_TYPE", 556, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
			fieldProperties.AddProperty(new Property("controlType_", 3130654579, "Black.Actor.Component.IK.LookAt.LOOKAT_CONTROL_TYPE", 560, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
        ...
        {
            return new SequenceActionAISetLookAtTarget();
        }
