...
namespace Black.Sequence.Actor.AI.Hate
{
    public partial class SequenceActionAIHateClearParams : Black.Sequence.Actor.AI.SequenceActionAIBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.AI.Hate.SequenceActionAIHateClearParams", 0, Black.Sequence.Actor.AI.Hate.SequenceActionAIHateClearParams.ObjectType, Construct, properties, 0, 288);
        }
        ...
        {
            return new SequenceActionAIHateClearParams();
        }
