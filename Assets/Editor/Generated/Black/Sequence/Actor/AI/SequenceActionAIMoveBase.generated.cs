...
namespace Black.Sequence.Actor.AI
{
    public partial class SequenceActionAIMoveBase : Black.Sequence.Actor.AI.SequenceActionAIBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.AI.SequenceActionAIMoveBase", 0, Black.Sequence.Actor.AI.SequenceActionAIMoveBase.ObjectType, Construct, properties, 0, 896);
        }
        ...
        {
            return new SequenceActionAIMoveBase();
        }
