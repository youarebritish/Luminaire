...
namespace Black.Sequence.Actor.AI.Team
{
    public partial class SequenceActionAIGetTeamStatusObject : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.AI.Team.SequenceActionAIGetTeamStatusObject", 0, Black.Sequence.Actor.AI.Team.SequenceActionAIGetTeamStatusObject.ObjectType, Construct, properties, 0, 576);
        }
        ...
        {
            return new SequenceActionAIGetTeamStatusObject();
        }
