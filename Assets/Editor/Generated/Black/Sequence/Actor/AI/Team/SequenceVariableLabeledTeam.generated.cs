...
namespace Black.Sequence.Actor.AI.Team
{
    public partial class SequenceVariableLabeledTeam : Black.Sequence.Actor.SequenceVariableLabeledActor
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.AI.Team.SequenceVariableLabeledTeam", 0, Black.Sequence.Actor.AI.Team.SequenceVariableLabeledTeam.ObjectType, Construct, properties, 0, 1136);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("leader_.pinName_", 405299000, "Base.String", 968, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("leader_.name_", 2819590035, "Base.String", 984, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("leader_.connections_", 4241647483, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 1000, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("leader_.pinValueType_", 4081140678, "Base.String", 1032, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("memberCount_.pinName_", 2401419042, "Base.String", 1056, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("memberCount_.name_", 3338758301, "Base.String", 1072, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("memberCount_.connections_", 2296321445, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 1088, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("memberCount_.pinValueType_", 2993087300, "Base.String", 1120, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceVariableLabeledTeam();
        }
