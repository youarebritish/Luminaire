...
{
    public partial class SequenceActionAIBuddyMetaSet : Black.Sequence.Actor.AI.SequenceActionAIBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceActionAIBuddyMetaSet();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Actor.AI.Buddy.SequenceActionAIBuddyMetaSet", 0, Black.Sequence.Actor.AI.Buddy.SequenceActionAIBuddyMetaSet.ObjectType, Construct, properties, 0, 384);
        }
        ...
        {
            return new SequenceActionAIBuddyMetaSet();
        }
