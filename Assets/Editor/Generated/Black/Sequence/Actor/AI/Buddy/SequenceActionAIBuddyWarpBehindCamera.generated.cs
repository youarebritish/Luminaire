...
namespace Black.Sequence.Actor.AI.Buddy
{
    public partial class SequenceActionAIBuddyWarpBehindCamera : Black.Sequence.Actor.AI.SequenceActionAIBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.AI.Buddy.SequenceActionAIBuddyWarpBehindCamera", 0, Black.Sequence.Actor.AI.Buddy.SequenceActionAIBuddyWarpBehindCamera.ObjectType, Construct, properties, 0, 736);
        }
        ...
        {
            return new SequenceActionAIBuddyWarpBehindCamera();
        }
