...
namespace Black.Sequence.Actor.AI.Buddy
{
    public partial class SequenceActionActorAIBuddyGetColorCorrection : Black.Sequence.Actor.AI.SequenceActionAIBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.AI.Buddy.SequenceActionActorAIBuddyGetColorCorrection", 0, Black.Sequence.Actor.AI.Buddy.SequenceActionActorAIBuddyGetColorCorrection.ObjectType, Construct, properties, 0, 384);
        }
        ...
        {
            return new SequenceActionActorAIBuddyGetColorCorrection();
        }
