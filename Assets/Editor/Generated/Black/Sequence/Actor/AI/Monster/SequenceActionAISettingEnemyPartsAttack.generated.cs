...
namespace Black.Sequence.Actor.AI.Monster
{
    public partial class SequenceActionAISettingEnemyPartsAttack : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.AI.Monster.SequenceActionAISettingEnemyPartsAttack", 0, Black.Sequence.Actor.AI.Monster.SequenceActionAISettingEnemyPartsAttack.ObjectType, Construct, properties, 0, 472);
        }
        ...
        {
            return new SequenceActionAISettingEnemyPartsAttack();
        }
