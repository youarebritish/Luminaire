...
namespace Black.Sequence.Actor.AI.Monster
{
    public partial class SequenceActionAISetWeakMonsParts : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.AI.Monster.SequenceActionAISetWeakMonsParts", 0, Black.Sequence.Actor.AI.Monster.SequenceActionAISetWeakMonsParts.ObjectType, Construct, properties, 0, 472);
        }
        ...
        {
            return new SequenceActionAISetWeakMonsParts();
        }
