...
namespace Black.Sequence.Actor.AI
{
    public partial class SequenceActionAINotifyRoleActionResult : Black.Sequence.Actor.AI.SequenceActionAIBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.AI.SequenceActionAINotifyRoleActionResult", 0, Black.Sequence.Actor.AI.SequenceActionAINotifyRoleActionResult.ObjectType, Construct, properties, 0, 384);
        }
        ...
        {
            return new SequenceActionAINotifyRoleActionResult();
        }
