...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionActorAttachPointNode : Black.Sequence.Actor.SequenceActionActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionActorAttachPointNode", 0, Black.Sequence.Actor.SequenceActionActorAttachPointNode.ObjectType, Construct, properties, 0, 560);
        }
        ...
        {
            return new SequenceActionActorAttachPointNode();
        }
