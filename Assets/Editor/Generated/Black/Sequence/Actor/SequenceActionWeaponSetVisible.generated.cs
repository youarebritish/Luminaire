...
namespace Black.Sequence.Actor
{
    public partial class SequenceActionWeaponSetVisible : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Actor.SequenceActionWeaponSetVisible", 0, Black.Sequence.Actor.SequenceActionWeaponSetVisible.ObjectType, Construct, properties, 0, 576);
        }
        ...
        {
            return new SequenceActionWeaponSetVisible();
        }
