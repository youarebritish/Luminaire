...
namespace Black.Sequence.Variable
{
    public partial class SequenceVariableSwfConnector : SQEX.Ebony.Framework.Sequence.SequenceVariable
    {
		...
		public string prefix11_= string.Empty;
		public string prefix12_= string.Empty;
		public string prefix13_= string.Empty;
		public string prefix14_= string.Empty;
		public string prefix15_= string.Empty;
		public string prefix16_= string.Empty;
		public string prefix17_= string.Empty;
		public string prefix18_= string.Empty;
		public string prefix19_= string.Empty;
		public string prefix20_= string.Empty;
		public string prefix21_= string.Empty;
		public string prefix22_= string.Empty;
		public string prefix23_= string.Empty;
		public string prefix24_= string.Empty;
		public string prefix25_= string.Empty;
		public string prefix26_= string.Empty;
		public string prefix27_= string.Empty;
		public string prefix28_= string.Empty;
		public string prefix29_= string.Empty;
		public string prefix30_= string.Empty;
		public string prefix31_= string.Empty;
		public string prefix32_= string.Empty;
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Variable.SequenceVariableSwfConnector", 0, Black.Sequence.Variable.SequenceVariableSwfConnector.ObjectType, Construct, properties, 0, 3456);
        }
        ...
        {
            return new SequenceVariableSwfConnector();
        }
