...
namespace Black.Sequence.Variable.Labeled
{
    ...
    public partial class SequenceListTakeOutFromGroupEntity : SQEX.Ebony.Framework.Sequence.SequenceVariable
    {
		...
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableInputPin entityGroup_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableOutputPin list_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableOutputPin listCount_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
