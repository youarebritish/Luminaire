...
namespace Black.Sequence.Variable
{
    public partial class SequenceVariableObjectStatus : SQEX.Ebony.Framework.Sequence.SequenceVariable
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Variable.SequenceVariableObjectStatus", 0, Black.Sequence.Variable.SequenceVariableObjectStatus.ObjectType, Construct, properties, 0, 280);
        }
        ...
        {
            return new SequenceVariableObjectStatus();
        }
