...
namespace Black.Sequence.Variable
{
    public partial class SequenceVariablePlayerVehicleDrive : SQEX.Ebony.Framework.Sequence.SequenceActivatableNode
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Variable.SequenceVariablePlayerVehicleDrive", 0, Black.Sequence.Variable.SequenceVariablePlayerVehicleDrive.ObjectType, Construct, properties, 0, 552);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("isPlayerVehicle_.pinName_", 2603559468, "Base.String", 472, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("isPlayerVehicle_.name_", 809083031, "Base.String", 488, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("isPlayerVehicle_.connections_", 2096525175, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 504, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("isPlayerVehicle_.pinValueType_", 1321487002, "Base.String", 536, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			
			
			fieldProperties.AddProperty(new Property("target_", 1693858869, "Black.Include.RideVehicleStatus", 168, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("isPlayerVehicle_", 2129006989, "SQEX.Ebony.Framework.Node.GraphVariableOutputPin", 464, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
        ...
        {
            return new SequenceVariablePlayerVehicleDrive();
        }
