...
namespace Black.Sequence.Render
{
    public partial class SequenceActionBlendExposure : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("lightProbePin_.pinName_", 1998611682, "Base.String", 376, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("lightProbePin_.name_", 1814186333, "Base.String", 392, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("lightProbePin_.connections_", 4246064997, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 408, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("lightProbePin_.pinValueType_", 349863428, "Base.String", 440, 16, 1, Property.PrimitiveType.String, 0, (char)0));
