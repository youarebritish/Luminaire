...
namespace Black.Sequence.Render
{
    public partial class SequenceActionSetGraphicsLODScale : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Render.SequenceActionSetGraphicsLODScale", 0, Black.Sequence.Render.SequenceActionSetGraphicsLODScale.ObjectType, Construct, properties, 0, 376);
        }
        ...
        {
            return new SequenceActionSetGraphicsLODScale();
        }
