...
namespace Black.Sequence.Event.Menu
{
    public partial class SequenceEventMenuInputNOX : Black.Sequence.Event.Menu.SequenceEventMenuInput
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("enablePin_", 2477767534, "SQEX.Ebony.Framework.Node.GraphTriggerInputPin", 176, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("disablePin_", 911041999, "SQEX.Ebony.Framework.Node.GraphTriggerInputPin", 272, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("movePrevPin_", 3867206685, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 368, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveNextPin_", 2979458537, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 464, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("movePrevRepeatPin_", 20823278, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 560, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveNextRepeatPin_", 77318210, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 656, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveUpPin_", 3345583493, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 752, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveDownPin_", 167598448, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 848, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveUpRepeatPin_", 4088788918, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 944, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveDownRepeatPin_", 283343739, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 1040, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveLeftPin_", 1098262945, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 1136, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveRightPin_", 286398830, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 1232, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveLeftRepeatPin_", 86353338, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 1328, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveRightRepeatPin_", 3274082893, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 1424, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveL1Pin_", 440912247, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 1520, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveR1Pin_", 3054166949, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 1616, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveL1RepeatPin_", 581255900, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 1712, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveR1RepeatPin_", 811884566, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 1808, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveL2Pin_", 3987866990, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 1904, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveR2Pin_", 4208394768, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 2000, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveL2RepeatPin_", 57087565, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 2096, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveR2RepeatPin_", 4164103259, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 2192, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("decidedPin_", 501229515, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 2288, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("canceledPin_", 2029360058, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 2384, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("squarePin_", 4149579958, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 2480, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("trianglePin_", 3145603633, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 2576, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("l3Pin_", 2659188040, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 2672, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("r3Pin_", 4187379746, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 2768, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("startPin_", 2664043275, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 2864, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("selectPin_", 806940521, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 2960, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("cursorDirectionType_", 2351682253, "Black.Sequence.Event.Menu.SequenceEventMenuInput.CursorDirectionType", 3056, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("padAction_", 1209527701, "Black.Sequence.Event.Menu.SequenceEventMenuInput.PadActionType", 3060, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("autoDisable_", 1670925043, "bool", 3064, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("useMainKeyFocus_", 2326074045, "bool", 3065, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("alwaysClearPad_", 2702492483, "bool", 3066, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("decideClearPad_", 3377348824, "bool", 3067, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("cancelClearPad_", 2056169074, "bool", 3068, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("squareClearPad_", 2670964517, "bool", 3069, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("triangleClearPad_", 2911211188, "bool", 3070, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("startClearPad_", 3504244798, "bool", 3071, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("selectClearPad_", 1846190828, "bool", 3072, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("l1ClearPad_", 4208591357, "bool", 3073, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("r1ClearPad_", 3150150203, "bool", 3074, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("startRepeatFrame_", 2733462798, "unsigned int", 3076, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("intervalRepeatFrame_", 3661613097, "unsigned int", 3080, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("mapMenuPin_.pinName_", 1164704801, "Base.String", 3112, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("mapMenuPin_.name_", 2788559068, "Base.String", 3128, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("mapMenuPin_.connections_", 1540265410, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 3144, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("mapMenuPin_.delayType_", 3744524384, "SQEX.Ebony.Framework.Node.GraphPin.DelayType", 3176, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("mapMenuPin_.delayTime_", 3404137163, "float", 3180, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("mapMenuPin_.delayMaxTime_", 3533864435, "float", 3184, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("cameraLockPin_.pinName_", 3518190052, "Base.String", 3208, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("cameraLockPin_.name_", 2253098815, "Base.String", 3224, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("cameraLockPin_.connections_", 3139212399, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 3240, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("cameraLockPin_.delayType_", 1703461849, "SQEX.Ebony.Framework.Node.GraphPin.DelayType", 3272, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("cameraLockPin_.delayTime_", 2858392350, "float", 3276, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("cameraLockPin_.delayMaxTime_", 1008762740, "float", 3280, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
