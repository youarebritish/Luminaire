...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventInteractionCursorDisplayExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventInteractionCursorDisplayExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventInteractionCursorDisplayExecutor.ObjectType, Construct, properties, 0, 1104);
        }
        ...
        {
            return new SequenceEventInteractionCursorDisplayExecutor();
        }
