...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventBattleQuestInfoExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventBattleQuestInfoExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventBattleQuestInfoExecutor.ObjectType, Construct, properties, 0, 1096);
        }
        ...
        {
            return new SequenceEventBattleQuestInfoExecutor();
        }
