...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventTutorialKeyInfoDisplayExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventTutorialKeyInfoDisplayExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventTutorialKeyInfoDisplayExecutor.ObjectType, Construct, properties, 0, 1104);
        }
        ...
        {
            return new SequenceEventTutorialKeyInfoDisplayExecutor();
        }
