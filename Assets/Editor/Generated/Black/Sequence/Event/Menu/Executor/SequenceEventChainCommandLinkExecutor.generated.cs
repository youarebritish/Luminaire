...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventChainCommandLinkExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventChainCommandLinkExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventChainCommandLinkExecutor.ObjectType, Construct, properties, 0, 1096);
        }
        ...
        {
            return new SequenceEventChainCommandLinkExecutor();
        }
