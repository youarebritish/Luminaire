...
{
    public partial class SequenceEventChainCommandExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceEventChainCommandExecutor();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventChainCommandExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventChainCommandExecutor.ObjectType, Construct, properties, 0, 1096);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Event.Menu.Executor.SequenceEventChainCommandExecutor", base.GetFieldProperties(), -963573671, 1283682694);
        ...
        {
            return new SequenceEventChainCommandExecutor();
        }
