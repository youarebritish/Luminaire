...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventTutorialTitleDisplayExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventTutorialTitleDisplayExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventTutorialTitleDisplayExecutor.ObjectType, Construct, properties, 0, 1104);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("titleFixId_", 4278580730, "SQEX.Ebony.Std.Fixid", 1088, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
        ...
        {
            return new SequenceEventTutorialTitleDisplayExecutor();
        }
