...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventTargetLockHelpExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventTargetLockHelpExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventTargetLockHelpExecutor.ObjectType, Construct, properties, 0, 1104);
        }
        ...
        {
            return new SequenceEventTargetLockHelpExecutor();
        }
