...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventCursorAttackExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventCursorAttackExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventCursorAttackExecutor.ObjectType, Construct, properties, 0, 1120);
        }
        ...
        {
            return new SequenceEventCursorAttackExecutor();
        }
