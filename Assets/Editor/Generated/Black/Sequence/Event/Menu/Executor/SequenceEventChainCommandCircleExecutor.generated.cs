...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventChainCommandCircleExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventChainCommandCircleExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventChainCommandCircleExecutor.ObjectType, Construct, properties, 0, 1152);
        }
        ...
        {
            return new SequenceEventChainCommandCircleExecutor();
        }
