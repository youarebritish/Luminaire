...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventCoverUIExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventCoverUIExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventCoverUIExecutor.ObjectType, Construct, properties, 0, 1104);
        }
        ...
        {
            return new SequenceEventCoverUIExecutor();
        }
