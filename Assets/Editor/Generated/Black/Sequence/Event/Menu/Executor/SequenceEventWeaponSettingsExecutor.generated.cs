...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventWeaponSettingsExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventWeaponSettingsExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventWeaponSettingsExecutor.ObjectType, Construct, properties, 0, 2224);
        }
        ...
        {
            return new SequenceEventWeaponSettingsExecutor();
        }
