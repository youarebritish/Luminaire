...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventGetExpInfoDisplayExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventGetExpInfoDisplayExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventGetExpInfoDisplayExecutor.ObjectType, Construct, properties, 0, 3728);
        }
        ...
        {
            return new SequenceEventGetExpInfoDisplayExecutor();
        }
