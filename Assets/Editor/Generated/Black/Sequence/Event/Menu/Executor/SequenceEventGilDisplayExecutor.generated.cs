...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventGilDisplayExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventGilDisplayExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventGilDisplayExecutor.ObjectType, Construct, properties, 0, 1120);
        }
        ...
        {
            return new SequenceEventGilDisplayExecutor();
        }
