...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventShiftBreakInfoDisplayExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventShiftBreakInfoDisplayExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventShiftBreakInfoDisplayExecutor.ObjectType, Construct, properties, 0, 1096);
        }
        ...
        {
            return new SequenceEventShiftBreakInfoDisplayExecutor();
        }
