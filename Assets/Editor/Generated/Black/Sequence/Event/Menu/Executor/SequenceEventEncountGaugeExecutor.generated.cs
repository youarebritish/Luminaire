...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventEncountGaugeExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("pin8_.pinName_", 4163083736, "Base.String", 1096, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("pin8_.name_", 1322792819, "Base.String", 1112, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("pin8_.connections_", 1019959387, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 1128, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("pin8_.pinValueType_", 1475778854, "Base.String", 1160, 16, 1, Property.PrimitiveType.String, 0, (char)0));
