...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventShopMenuExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventShopMenuExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventShopMenuExecutor.ObjectType, Construct, properties, 0, 1144);
        }
        ...
        {
            return new SequenceEventShopMenuExecutor();
        }
