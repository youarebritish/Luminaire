...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventLvAndExpInfoDisplayExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventLvAndExpInfoDisplayExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventLvAndExpInfoDisplayExecutor.ObjectType, Construct, properties, 0, 1112);
        }
        ...
        {
            return new SequenceEventLvAndExpInfoDisplayExecutor();
        }
