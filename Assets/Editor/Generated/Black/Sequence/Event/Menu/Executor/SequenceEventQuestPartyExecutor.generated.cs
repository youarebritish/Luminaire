...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventQuestPartyExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventQuestPartyExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventQuestPartyExecutor.ObjectType, Construct, properties, 0, 1104);
        }
        ...
        {
            return new SequenceEventQuestPartyExecutor();
        }
