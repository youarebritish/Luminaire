...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventBackHomeKeyGuideExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventBackHomeKeyGuideExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventBackHomeKeyGuideExecutor.ObjectType, Construct, properties, 0, 1104);
        }
        ...
        {
            return new SequenceEventBackHomeKeyGuideExecutor();
        }
