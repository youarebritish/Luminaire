...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventAttackGuradInfoDisplayExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventAttackGuradInfoDisplayExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventAttackGuradInfoDisplayExecutor.ObjectType, Construct, properties, 0, 1096);
        }
        ...
        {
            return new SequenceEventAttackGuradInfoDisplayExecutor();
        }
