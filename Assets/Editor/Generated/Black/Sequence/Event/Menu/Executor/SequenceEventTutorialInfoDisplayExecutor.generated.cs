...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventTutorialInfoDisplayExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventTutorialInfoDisplayExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventTutorialInfoDisplayExecutor.ObjectType, null, properties, 0, 1112);
        }
