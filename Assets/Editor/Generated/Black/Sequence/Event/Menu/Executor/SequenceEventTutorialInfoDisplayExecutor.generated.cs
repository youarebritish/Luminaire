...
{
    public partial class SequenceEventTutorialInfoDisplayExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceEventTutorialInfoDisplayExecutor();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventTutorialInfoDisplayExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventTutorialInfoDisplayExecutor.ObjectType, Construct, properties, 0, 1112);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Event.Menu.Executor.SequenceEventTutorialInfoDisplayExecutor", base.GetFieldProperties(), -19920010, -1265636113);
        ...
        {
            return new SequenceEventTutorialInfoDisplayExecutor();
        }
