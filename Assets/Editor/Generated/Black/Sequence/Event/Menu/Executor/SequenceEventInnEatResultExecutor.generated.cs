...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventInnEatResultExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventInnEatResultExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventInnEatResultExecutor.ObjectType, Construct, properties, 0, 7760);
        }
        ...
        {
            return new SequenceEventInnEatResultExecutor();
        }
