...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventCommonDialogExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventCommonDialogExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventCommonDialogExecutor.ObjectType, Construct, properties, 0, 1240);
        }
        ...
        {
            return new SequenceEventCommonDialogExecutor();
        }
