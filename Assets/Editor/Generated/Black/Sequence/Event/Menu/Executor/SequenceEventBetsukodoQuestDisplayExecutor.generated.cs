...
{
    public partial class SequenceEventBetsukodoQuestDisplayExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceEventBetsukodoQuestDisplayExecutor();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventBetsukodoQuestDisplayExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventBetsukodoQuestDisplayExecutor.ObjectType, Construct, properties, 0, 1104);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("Black.Sequence.Event.Menu.Executor.SequenceEventBetsukodoQuestDisplayExecutor", base.GetFieldProperties(), 980377204, 674977605);
        ...
        {
            return new SequenceEventBetsukodoQuestDisplayExecutor();
        }
