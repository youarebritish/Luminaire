...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventMpBurstInfoDisplayExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventMpBurstInfoDisplayExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventMpBurstInfoDisplayExecutor.ObjectType, Construct, properties, 0, 1128);
        }
        ...
        {
            return new SequenceEventMpBurstInfoDisplayExecutor();
        }
