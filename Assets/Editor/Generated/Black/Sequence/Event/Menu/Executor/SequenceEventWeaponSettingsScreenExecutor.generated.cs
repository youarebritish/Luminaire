...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventWeaponSettingsScreenExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventWeaponSettingsScreenExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventWeaponSettingsScreenExecutor.ObjectType, Construct, properties, 0, 1272);
        }
        ...
        {
            return new SequenceEventWeaponSettingsScreenExecutor();
        }
