...
namespace Black.Sequence.Event.Menu.Executor
{
    public partial class SequenceEventQuestSelectMenuExecutor : Black.Sequence.Event.Menu.SequenceEventUiEntityInputBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.Executor.SequenceEventQuestSelectMenuExecutor", 0, Black.Sequence.Event.Menu.Executor.SequenceEventQuestSelectMenuExecutor.ObjectType, Construct, properties, 0, 1512);
        }
        ...
        {
            return new SequenceEventQuestSelectMenuExecutor();
        }
