...
namespace Black.Sequence.Event.Menu
{
    public partial class SequenceEventCombatCommandMenuClosed : Black.Sequence.Event.Menu.SequenceEventUiBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Menu.SequenceEventCombatCommandMenuClosed", 0, Black.Sequence.Event.Menu.SequenceEventCombatCommandMenuClosed.ObjectType, Construct, properties, 0, 296);
        }
        ...
        {
            return new SequenceEventCombatCommandMenuClosed();
        }
