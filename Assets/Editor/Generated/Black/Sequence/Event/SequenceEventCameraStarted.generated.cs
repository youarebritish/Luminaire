...
namespace Black.Sequence.Event
{
    public partial class SequenceEventCameraStarted : SQEX.Ebony.Framework.Sequence.SequenceEvent
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.SequenceEventCameraStarted", 0, Black.Sequence.Event.SequenceEventCameraStarted.ObjectType, Construct, properties, 0, 272);
        }
        ...
        {
            return new SequenceEventCameraStarted();
        }
