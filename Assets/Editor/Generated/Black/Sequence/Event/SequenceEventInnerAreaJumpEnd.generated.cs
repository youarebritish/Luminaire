...
namespace Black.Sequence.Event
{
    public partial class SequenceEventInnerAreaJumpEnd : SQEX.Ebony.Framework.Sequence.SequenceEvent
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.SequenceEventInnerAreaJumpEnd", 0, Black.Sequence.Event.SequenceEventInnerAreaJumpEnd.ObjectType, Construct, properties, 0, 272);
        }
        ...
        {
            return new SequenceEventInnerAreaJumpEnd();
        }
