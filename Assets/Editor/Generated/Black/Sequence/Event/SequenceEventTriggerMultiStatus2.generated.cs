...
namespace Black.Sequence.Event
{
    public partial class SequenceEventTriggerMultiStatus2 : Black.Sequence.Event.SequenceEventTriggerMultiStatus
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.SequenceEventTriggerMultiStatus2", 0, Black.Sequence.Event.SequenceEventTriggerMultiStatus2.ObjectType, Construct, properties, 0, 1272);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("triggerPointPin_", 846860007, "SQEX.Ebony.Framework.Node.GraphVariableInputPin", 176, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("remoteEvent_", 3639870650, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 264, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("touch_", 2860744581, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 360, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("unTouch_", 2975892838, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 456, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("attackIn_", 2471703499, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 552, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("attackOut_", 2947025912, "SQEX.Ebony.Framework.Node.GraphTriggerOutputPin", 648, 96, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("causedActorList_", 2501124410, "SQEX.Ebony.Framework.Node.GraphVariableOutputPin", 744, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("causedActor_", 1920287630, "SQEX.Ebony.Framework.Node.GraphVariableOutputPin", 832, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("triggerActor_", 3722828613, "SQEX.Ebony.Framework.Node.GraphVariableOutputPin", 920, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("eventId_", 548562519, "SQEX.Ebony.Std.Fixid", 1008, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("eventString_", 3649127407, "Ebony.Base.String", 1016, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("waitEntity_", 3335877996, "bool", 1032, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
        ...
        {
            return new SequenceEventTriggerMultiStatus2();
        }
