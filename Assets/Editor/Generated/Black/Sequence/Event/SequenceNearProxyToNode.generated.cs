...
namespace Black.Sequence.Event
{
    public partial class SequenceNearProxyToNode : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.SequenceNearProxyToNode", 0, Black.Sequence.Event.SequenceNearProxyToNode.ObjectType, Construct, properties, 0, 272);
        }
        ...
        {
            return new SequenceNearProxyToNode();
        }
