...
namespace Black.Sequence.Event.Actor
{
    public partial class SequenceEventActorThink : Black.Sequence.Event.Actor.SequenceEventActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Actor.SequenceEventActorThink", 0, Black.Sequence.Event.Actor.SequenceEventActorThink.ObjectType, Construct, properties, 0, 288);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("rootType_", 650113078, "Black.Actor.Component.AIController.ThinkRootType", 280, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
        ...
        {
            return new SequenceEventActorThink();
        }
