...
namespace Black.Sequence.Event.Actor.Vehicle
{
    public partial class SequenceEventActorVehicleStateChanged : Black.Sequence.Event.Actor.SequenceEventActorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Event.Actor.Vehicle.SequenceEventActorVehicleStateChanged", 0, Black.Sequence.Event.Actor.Vehicle.SequenceEventActorVehicleStateChanged.ObjectType, Construct, properties, 0, 408);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("paramOnePin_.pinName_", 4116210205, "Base.String", 320, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("paramOnePin_.name_", 3770849256, "Base.String", 336, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("paramOnePin_.connections_", 3629506854, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 352, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("paramOnePin_.pinValueType_", 1733193517, "Base.String", 384, 16, 1, Property.PrimitiveType.String, 0, (char)0));
        ...
        {
            return new SequenceEventActorVehicleStateChanged();
        }
