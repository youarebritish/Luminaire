...
namespace Black.Sequence.Event
{
    ...
    public partial class SequenceEventFishingBattleFishHpTriggered : SQEX.Ebony.Framework.Sequence.SequenceEvent
    {
		...
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphTriggerOutputPin hpTriggered_out_= new SQEX.Ebony.Framework.Node.GraphTriggerOutputPin();
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableInputPin hp_rate_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
