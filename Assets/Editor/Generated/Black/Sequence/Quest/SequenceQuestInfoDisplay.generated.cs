...
namespace Black.Sequence.Quest
{
    public partial class SequenceQuestInfoDisplay : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Sequence.Quest.SequenceQuestInfoDisplay", 0, Black.Sequence.Quest.SequenceQuestInfoDisplay.ObjectType, Construct, properties, 0, 464);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("msgType_", 2249557719, "Black.Sequence.Quest.SequenceQuestInfoDisplay.MessageType", 456, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
        ...
        {
            return new SequenceQuestInfoDisplay();
        }
