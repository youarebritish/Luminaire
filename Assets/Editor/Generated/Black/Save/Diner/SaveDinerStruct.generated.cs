...
namespace Black.Save.Diner
{
    ...
    public partial class SaveDinerStruct
    {
		...
		[UnityEngine.SerializeReference] public List<Black.Save.Diner.SaveDinerDataStruct> dataLists_= new List<Black.Save.Diner.SaveDinerDataStruct>();
		[UnityEngine.SerializeReference] public List<Black.Save.Diner.SaveDinerInformationStruct> informationLists_= new List<Black.Save.Diner.SaveDinerInformationStruct>();
		[UnityEngine.SerializeReference] public List<Black.Save.Diner.SaveDinerPlaceStruct> placeLists_= new List<Black.Save.Diner.SaveDinerPlaceStruct>();
