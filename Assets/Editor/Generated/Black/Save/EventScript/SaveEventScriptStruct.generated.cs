...
namespace Black.Save.EventScript
{
    ...
    public partial class SaveEventScriptStruct
    {
		...
		[UnityEngine.SerializeReference] public List<Black.Save.EventScript.SaveEventScriptGroupDataStruct> saveEventScriptGroupDataStructList= new List<Black.Save.EventScript.SaveEventScriptGroupDataStruct>();
		[UnityEngine.SerializeReference] public List<Black.Save.EventScript.SaveEventScriptSceneDataStruct> saveEventScriptSceneDataStructList= new List<Black.Save.EventScript.SaveEventScriptSceneDataStruct>();
