...
namespace Black.Save.Quest
{
    ...
    public partial class SaveQuestDataStruct
    {
		...
		[UnityEngine.SerializeReference] public List<Black.Save.Quest.SaveQuestGameInformationStruct> gameInformationList= new List<Black.Save.Quest.SaveQuestGameInformationStruct>();
		[UnityEngine.SerializeReference] public List<uint> acceptQuestIdList_= new List<uint>();
