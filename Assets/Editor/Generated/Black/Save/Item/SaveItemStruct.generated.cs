...
namespace Black.Save.Item
{
    ...
    public partial class SaveItemStruct
    {
		...
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemDataStruct battle_item= new Black.Save.Item.SaveItemDataStruct();
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemDataStruct event_item= new Black.Save.Item.SaveItemDataStruct();
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemDataStruct food_item= new Black.Save.Item.SaveItemDataStruct();
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemDataStruct treasure_item= new Black.Save.Item.SaveItemDataStruct();
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemDataStruct car_item= new Black.Save.Item.SaveItemDataStruct();
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemDataStruct leisure_item= new Black.Save.Item.SaveItemDataStruct();
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemDataStruct reinforcement_item= new Black.Save.Item.SaveItemDataStruct();
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemDataStruct trunk_item= new Black.Save.Item.SaveItemDataStruct();
		public int magic_bottle_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveMagicBottleStruct magic_bottle= new Black.Save.Item.SaveMagicBottleStruct();
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveMagicBottleStruct magic_bottle_available= new Black.Save.Item.SaveMagicBottleStruct();
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveRingStruct ring= new Black.Save.Item.SaveRingStruct();
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveMagicRecipeListStruct magic_recipe_list= new Black.Save.Item.SaveMagicRecipeListStruct();
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_battle_item= new Black.Save.Item.SaveItemInformationStruct();
		public int information_battle_item_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_event_item= new Black.Save.Item.SaveItemInformationStruct();
		public int information_event_item_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_food_item= new Black.Save.Item.SaveItemInformationStruct();
		public int information_food_item_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_treasure_item= new Black.Save.Item.SaveItemInformationStruct();
		public int information_treasure_item_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_car_item= new Black.Save.Item.SaveItemInformationStruct();
		public int information_car_item_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_leisure_item= new Black.Save.Item.SaveItemInformationStruct();
		public int information_leisure_item_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_reinforcement_item= new Black.Save.Item.SaveItemInformationStruct();
		public int information_reinforcement_item_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_magic_bottle= new Black.Save.Item.SaveItemInformationStruct();
		public int information_magic_bottle_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_magic_bottle_available= new Black.Save.Item.SaveItemInformationStruct();
		public int information_magic_bottle_available_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_ring= new Black.Save.Item.SaveItemInformationStruct();
		public int information_ring_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_weapon= new Black.Save.Item.SaveItemInformationStruct();
		public int information_weapon_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_phantom_sword= new Black.Save.Item.SaveItemInformationStruct();
		public int information_phantom_sword_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_accessory= new Black.Save.Item.SaveItemInformationStruct();
		public int information_accessory_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_cloth= new Black.Save.Item.SaveItemInformationStruct();
		public int information_cloth_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_job_command= new Black.Save.Item.SaveItemInformationStruct();
		public int information_job_command_amount;
		[UnityEngine.SerializeReference] public Black.Save.Item.SaveItemInformationStruct information_recipe= new Black.Save.Item.SaveItemInformationStruct();
