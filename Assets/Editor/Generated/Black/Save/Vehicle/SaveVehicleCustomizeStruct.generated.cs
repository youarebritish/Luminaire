...
namespace Black.Save.Vehicle
{
    ...
    public partial class SaveVehicleCustomizeStruct
    {
		...
		[UnityEngine.SerializeReference] public List<Black.Save.Vehicle.SaveVehicleColorStruct> unlockedBodyColor_= new List<Black.Save.Vehicle.SaveVehicleColorStruct>();
		[UnityEngine.SerializeReference] public List<Black.Save.Vehicle.SaveVehicleColorStruct> unlockedInteriorColor_= new List<Black.Save.Vehicle.SaveVehicleColorStruct>();
		[UnityEngine.SerializeReference] public List<Black.Save.Vehicle.SaveVehicleColorStruct> unlockedTireColor_= new List<Black.Save.Vehicle.SaveVehicleColorStruct>();
		[UnityEngine.SerializeReference] public List<Black.Save.Vehicle.SaveVehicleUnlockStruct> unlockedSetSticker_= new List<Black.Save.Vehicle.SaveVehicleUnlockStruct>();
		[UnityEngine.SerializeReference] public List<Black.Save.Vehicle.SaveVehicleUnlockStruct> unlockedLeftSticker_= new List<Black.Save.Vehicle.SaveVehicleUnlockStruct>();
		[UnityEngine.SerializeReference] public List<Black.Save.Vehicle.SaveVehicleUnlockStruct> unlockedRightSticker_= new List<Black.Save.Vehicle.SaveVehicleUnlockStruct>();
		[UnityEngine.SerializeReference] public List<Black.Save.Vehicle.SaveVehicleUnlockStruct> unlockedTopSticker_= new List<Black.Save.Vehicle.SaveVehicleUnlockStruct>();
		[UnityEngine.SerializeReference] public List<Black.Save.Vehicle.SaveVehicleUnlockStruct> unlockedFrontSticker_= new List<Black.Save.Vehicle.SaveVehicleUnlockStruct>();
		[UnityEngine.SerializeReference] public List<Black.Save.Vehicle.SaveVehicleUnlockStruct> unlockedRearSticker_= new List<Black.Save.Vehicle.SaveVehicleUnlockStruct>();
		[UnityEngine.SerializeReference] public List<Black.Save.Vehicle.SaveVehiclePartsStruct> unlockedParts_= new List<Black.Save.Vehicle.SaveVehiclePartsStruct>();
