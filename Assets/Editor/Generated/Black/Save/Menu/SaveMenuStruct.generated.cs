...
namespace Black.Save.Menu
{
    ...
    public partial class SaveMenuStruct
    {
		...
		[UnityEngine.SerializeReference] public List<uint> discoveredLocations_= new List<uint>();
		[UnityEngine.SerializeReference] public List<Black.Save.Menu.SaveMenuFootprint> footPrints_= new List<Black.Save.Menu.SaveMenuFootprint>();
		...
		[UnityEngine.SerializeReference] public List<uint> battleItemOrderList_= new List<uint>();
