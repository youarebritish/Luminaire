...
namespace Black.WorldMap
{
    ...
    public partial class TerrainCurveMeshData : SQEX.Luminous.Core.Object.Object
    {
		...
		[UnityEngine.SerializeReference] public List<uint> RequireResourceList_= new List<uint>();
		[UnityEngine.SerializeReference] public List<int> InstanceNodeIndex_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> CurveIndex_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MeshDataCount_= new List<int>();
		[UnityEngine.SerializeReference] public List<float> InfoPositionX_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> InfoPositionY_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> InfoPositionZ_= new List<float>();
		[UnityEngine.SerializeReference] public List<int> BuiltMeshID_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> VertexBuffer0Size_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> VertexBuffer1Size_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> VertexBuffer2Size_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> IndexBufferSize_= new List<int>();
		[UnityEngine.SerializeReference] public List<float> BoundingBoxMaxX_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> BoundingBoxMaxY_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> BoundingBoxMaxZ_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> BoundingBoxMinX_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> BoundingBoxMinY_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> BoundingBoxMinZ_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> Vertex0Buffer_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> Vertex1Buffer_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> Vertex2Buffer_= new List<float>();
		[UnityEngine.SerializeReference] public List<int> IndexBuffer_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> LightCount_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MetaInstanceNodeHash_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MetaMeshTagCount_= new List<int>();
		[UnityEngine.SerializeReference] public List<float> MetaMeshDataLODNear_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> MetaMeshDataLODFar_= new List<float>();
		[UnityEngine.SerializeReference] public List<int> MetaMeshDataVertexDataCount_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MetaMeshDataVertexStride_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MetaMeshDataPosType_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MetaMeshDataPosOffset_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MetaMeshDataNrmType_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MetaMeshDataNrmOffset_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MetaMeshDataBinType_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MetaMeshDataBinOffset_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MetaMeshDataTanType_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MetaMeshDataTanOffset_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MetaMeshDataCol2Type_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MetaMeshDataCol2Offset_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> LightNodeHash_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> LightShadowOwnerIndex_= new List<int>();
		[UnityEngine.SerializeReference] public List<float> LightPosX_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> LightPosY_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> LightPosZ_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> LightDirX_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> LightDirY_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> LightDirZ_= new List<float>();
