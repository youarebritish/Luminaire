...
namespace Black.WorldMap
{
    ...
    public partial class TerrainCurveNaviData : SQEX.Luminous.Core.Object.Object
    {
		...
		public int Magic_;
		public int Version_;
		[UnityEngine.SerializeReference] public List<int> CurveCount_= new List<int>();
		...
		[UnityEngine.SerializeReference] public List<float> CurveLength_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> Weight_= new List<float>();
		[UnityEngine.SerializeReference] public List<int> ConnectionCountAtStart_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> ConnectionCountAtEnd_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> EdgeInfoAtStart_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> EdgeInfoAtEnd_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> ConnectedCurveID_= new List<int>();
		[UnityEngine.SerializeReference] public List<float> Angle_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> RoughAngle_= new List<float>();
		[UnityEngine.SerializeReference] public List<bool> IsConnectToStartPos_= new List<bool>();
		[UnityEngine.SerializeReference] public List<bool> IsRightSide_= new List<bool>();
		...
		[UnityEngine.SerializeReference] public List<float> Length_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> OffsetFromCurveStart_= new List<float>();
