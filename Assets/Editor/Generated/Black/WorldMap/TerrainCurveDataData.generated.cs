...
namespace Black.WorldMap
{
    ...
    public partial class TerrainCurveDataData : SQEX.Luminous.Core.Object.Object
    {
		...
		[UnityEngine.SerializeReference] public List<int> SegmentsCount_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> InstancesCount_= new List<int>();
		[UnityEngine.SerializeReference] public List<bool> IsLoop_= new List<bool>();
		[UnityEngine.SerializeReference] public List<char> CurveName_= new List<char>();
		[UnityEngine.SerializeReference] public List<float> LodLength_= new List<float>();
		[UnityEngine.SerializeReference] public List<int> CurveAttribute_= new List<int>();
		[UnityEngine.SerializeReference] public List<float> PointX0_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PointX1_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PointX2_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PointX3_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PointY0_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PointY1_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PointY2_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PointY3_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PointZ0_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PointZ1_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PointZ2_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PointZ3_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> BankSZ_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> BankEZ_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> FlattenWidth_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> FlattenSmooth_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> FlattenSmoothLeft_= new List<float>();
		[UnityEngine.SerializeReference] public List<int> ModelSetsCount_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> ModelSetsIndex_= new List<int>();
		[UnityEngine.SerializeReference] public List<bool> AbsorbEnable_= new List<bool>();
		[UnityEngine.SerializeReference] public List<bool> VisibleEnable_= new List<bool>();
		[UnityEngine.SerializeReference] public List<int> SmoothType_= new List<int>();
		[UnityEngine.SerializeReference] public List<float> BezieLength_= new List<float>();
		[UnityEngine.SerializeReference] public List<int> EntityListCount_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> EntityList_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> CheckPosListCount_= new List<int>();
		[UnityEngine.SerializeReference] public List<float> CheckPosListX_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> CheckPosListY_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> CheckPosListZ_= new List<float>();
		[UnityEngine.SerializeReference] public List<bool> isBranch_= new List<bool>();
		[UnityEngine.SerializeReference] public List<int> branchPointIndex_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> branchPointCount_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> branchSegmentCount_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> segmentModelPattern0_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> segmentModelPattern0ListCount_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> segmentModelPattern0ListItemCount_= new List<int>();
		[UnityEngine.SerializeReference] public List<float> DefaultLeftLane_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> MaxLeftLane_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> ParkLane_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> LimitSpeed_= new List<float>();
		[UnityEngine.SerializeReference] public List<int> CurveType_= new List<int>();
		[UnityEngine.SerializeReference] public List<bool> CanParking_= new List<bool>();
		[UnityEngine.SerializeReference] public List<bool> IsForCollisionWall_= new List<bool>();
		[UnityEngine.SerializeReference] public List<float> CollisionWallHeight_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> CollisionWallHeight2_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> CollisionWallWidth_= new List<float>();
		[UnityEngine.SerializeReference] public List<int> CollisionWallMask_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> CollisionWallFlag_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> CollisionWallFilter_= new List<int>();
		[UnityEngine.SerializeReference] public List<float> InstancePositionX_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> InstancePositionY_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> InstancePositionZ_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> InstanceRotationX_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> InstanceRotationY_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> InstanceRotationZ_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> InstanceScalingX_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> InstanceScalingY_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> InstanceScalingZ_= new List<float>();
		[UnityEngine.SerializeReference] public List<int> InstanceModelIndex_= new List<int>();
