...
namespace Black.WorldMap
{
    ...
    public partial class TerrainCurveCollisionData : SQEX.Luminous.Core.Object.Object
    {
		...
		[UnityEngine.SerializeReference] public List<int> CollisionType_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> DrawableObjectID_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> MCHIndex_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> PhysXDataID_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> VertexSize_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> IndexSize_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> AttributeSize_= new List<int>();
		...
		[UnityEngine.SerializeReference] public List<float> PositionX_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PositionY_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PositionZ_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PositionX2_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PositionY2_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> PositionZ2_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> WallWidth_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> WallHeight_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> WallHeight2_= new List<float>();
		[UnityEngine.SerializeReference] public List<int> WallMask_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> WallFlag_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> WallFilter_= new List<int>();
		[UnityEngine.SerializeReference] public List<float> VertexBuffer_= new List<float>();
		[UnityEngine.SerializeReference] public List<short> IndexBuffer_= new List<short>();
		[UnityEngine.SerializeReference] public List<short> AttributeBuffer_= new List<short>();
		[UnityEngine.SerializeReference] public List<char> PhysXData_= new List<char>();
