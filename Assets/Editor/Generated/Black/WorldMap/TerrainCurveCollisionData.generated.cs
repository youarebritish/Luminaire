...
namespace Black.WorldMap
{
    public partial class TerrainCurveCollisionData : SQEX.Luminous.Core.Object.Object
    {
		...
		public IList<int> CollisionType_= new List<int>();
		public IList<int> DrawableObjectID_= new List<int>();
		public IList<int> MCHIndex_= new List<int>();
		public IList<int> PhysXDataID_= new List<int>();
		public IList<int> VertexSize_= new List<int>();
		public IList<int> IndexSize_= new List<int>();
		public IList<int> AttributeSize_= new List<int>();
		...
		public IList<float> PositionX_= new List<float>();
		public IList<float> PositionY_= new List<float>();
		public IList<float> PositionZ_= new List<float>();
		public IList<float> PositionX2_= new List<float>();
		public IList<float> PositionY2_= new List<float>();
		public IList<float> PositionZ2_= new List<float>();
		public IList<float> WallWidth_= new List<float>();
		public IList<float> WallHeight_= new List<float>();
		public IList<float> WallHeight2_= new List<float>();
		public IList<int> WallMask_= new List<int>();
		public IList<int> WallFlag_= new List<int>();
		public IList<int> WallFilter_= new List<int>();
		public IList<float> VertexBuffer_= new List<float>();
		public IList<short> IndexBuffer_= new List<short>();
		public IList<short> AttributeBuffer_= new List<short>();
		public IList<char> PhysXData_= new List<char>();
