...
namespace Black.WorldMap
{
    ...
    public partial class TerrainCurveData : Black.WorldMap.TerrainCurveDataData
    {
		...
		[UnityEngine.SerializeReference] public List<char> ModelName_= new List<char>();
		[UnityEngine.SerializeReference] public List<int> ModelIndex0_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> ModelIndex1_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> ModelIndex2_= new List<int>();
		[UnityEngine.SerializeReference] public List<int> ModelIndex0Count_= new List<int>();
		[UnityEngine.SerializeReference] public List<float> ModelLength0_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> ModelLength1_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> ModelLength2_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> OffsetX_= new List<float>();
		[UnityEngine.SerializeReference] public List<float> OffsetY_= new List<float>();
		[UnityEngine.SerializeReference] public List<bool> IsCollision_= new List<bool>();
		[UnityEngine.SerializeReference] public List<bool> IsTransForm_= new List<bool>();
		[UnityEngine.SerializeReference] public List<bool> IsStraight_= new List<bool>();
		[UnityEngine.SerializeReference] public List<bool> IsYRotationOnly_= new List<bool>();
		[UnityEngine.SerializeReference] public List<bool> IsForInstancing_= new List<bool>();
		[UnityEngine.SerializeReference] public List<int> ModelSelectRate0_= new List<int>();
