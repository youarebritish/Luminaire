...
namespace Black.AIGraph.Extend.Expression.Invoke.Buddy
{
    public partial class AIGraphExpressionInvokeHasAbility : SQEX.Ebony.AIGraph.Expression.Invoke.AIGraphExpressionInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Expression.Invoke.Buddy.AIGraphExpressionInvokeHasAbility", 0, Black.AIGraph.Extend.Expression.Invoke.Buddy.AIGraphExpressionInvokeHasAbility.ObjectType, Construct, properties, 0, 8);
        }
        ...
        {
            return new AIGraphExpressionInvokeHasAbility();
        }
