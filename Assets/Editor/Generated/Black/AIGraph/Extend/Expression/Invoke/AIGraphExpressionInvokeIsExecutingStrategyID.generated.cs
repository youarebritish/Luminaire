...
namespace Black.AIGraph.Extend.Expression.Invoke
{
    public partial class AIGraphExpressionInvokeIsExecutingStrategyID : SQEX.Ebony.AIGraph.Expression.Invoke.AIGraphExpressionInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Expression.Invoke.AIGraphExpressionInvokeIsExecutingStrategyID", 0, Black.AIGraph.Extend.Expression.Invoke.AIGraphExpressionInvokeIsExecutingStrategyID.ObjectType, Construct, properties, 0, 8);
        }
        ...
        {
            return new AIGraphExpressionInvokeIsExecutingStrategyID();
        }
