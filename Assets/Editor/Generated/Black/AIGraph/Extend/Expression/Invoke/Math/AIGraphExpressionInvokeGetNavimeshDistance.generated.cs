...
namespace Black.AIGraph.Extend.Expression.Invoke.Math
{
    public partial class AIGraphExpressionInvokeGetNavimeshDistance : Black.AIGraph.Extend.Expression.Invoke.Math.AIGraphExpressionInvokeTargetSlotArgsBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Expression.Invoke.Math.AIGraphExpressionInvokeGetNavimeshDistance", 0, Black.AIGraph.Extend.Expression.Invoke.Math.AIGraphExpressionInvokeGetNavimeshDistance.ObjectType, null, properties, 0, 8);
        }
