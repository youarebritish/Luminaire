...
namespace Black.AIGraph.Extend.Expression.Invoke.Nifl
{
    public partial class AIGraphExpressionIvokeCheckCanSpearShoot : SQEX.Ebony.AIGraph.Expression.Invoke.AIGraphExpressionInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Expression.Invoke.Nifl.AIGraphExpressionIvokeCheckCanSpearShoot", 0, Black.AIGraph.Extend.Expression.Invoke.Nifl.AIGraphExpressionIvokeCheckCanSpearShoot.ObjectType, Construct, properties, 0, 8);
        }
        ...
        {
            return new AIGraphExpressionIvokeCheckCanSpearShoot();
        }
