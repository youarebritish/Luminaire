...
namespace Black.AIGraph.Extend.Expression.Invoke.Buddy
{
    public partial class AIGraphExpressionInvokeIsExecutingJobCommand : SQEX.Ebony.AIGraph.Expression.Invoke.AIGraphExpressionInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Expression.Invoke.Buddy.AIGraphExpressionInvokeIsExecutingJobCommand", 0, Black.AIGraph.Extend.Expression.Invoke.Buddy.AIGraphExpressionInvokeIsExecutingJobCommand.ObjectType, Construct, properties, 0, 8);
        }
        ...
        {
            return new AIGraphExpressionInvokeIsExecutingJobCommand();
        }
