...
namespace Black.AIGraph.Extend.Expression.Invoke.Nifl
{
    public partial class AIGraphExpressionInvokeCanShootWire : SQEX.Ebony.AIGraph.Expression.Invoke.AIGraphExpressionInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Expression.Invoke.Nifl.AIGraphExpressionInvokeCanShootWire", 0, Black.AIGraph.Extend.Expression.Invoke.Nifl.AIGraphExpressionInvokeCanShootWire.ObjectType, null, properties, 0, 8);
        }
