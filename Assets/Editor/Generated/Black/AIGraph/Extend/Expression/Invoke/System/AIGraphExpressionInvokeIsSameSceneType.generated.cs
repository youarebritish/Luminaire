...
namespace Black.AIGraph.Extend.Expression.Invoke.System
{
    public partial class AIGraphExpressionInvokeIsSameSceneType : SQEX.Ebony.AIGraph.Expression.Invoke.AIGraphExpressionInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Expression.Invoke.System.AIGraphExpressionInvokeIsSameSceneType", 0, Black.AIGraph.Extend.Expression.Invoke.System.AIGraphExpressionInvokeIsSameSceneType.ObjectType, Construct, properties, 0, 8);
        }
        ...
        {
            return new AIGraphExpressionInvokeIsSameSceneType();
        }
