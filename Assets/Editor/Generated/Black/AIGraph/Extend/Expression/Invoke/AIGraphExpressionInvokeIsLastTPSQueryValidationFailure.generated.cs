...
namespace Black.AIGraph.Extend.Expression.Invoke
{
    public partial class AIGraphExpressionInvokeIsLastTPSQueryValidationFailure : SQEX.Ebony.AIGraph.Expression.Invoke.AIGraphExpressionInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Expression.Invoke.AIGraphExpressionInvokeIsLastTPSQueryValidationFailure", 0, Black.AIGraph.Extend.Expression.Invoke.AIGraphExpressionInvokeIsLastTPSQueryValidationFailure.ObjectType, Construct, properties, 0, 8);
        }
        ...
        {
            return new AIGraphExpressionInvokeIsLastTPSQueryValidationFailure();
        }
