...
namespace Black.AIGraph.Extend.Invoke
{
    public partial class AIGraphInvokeSetAnimationBlackboard_Float : SQEX.Ebony.AIGraph.Invoke.AIGraphInvokeBase
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("paramValue_", 3541012908, "float", 28, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddProperty(new Property("isRandom_", 2467781335, "bool", 32, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddProperty(new Property("minRandomValue_", 4013967298, "float", 36, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddProperty(new Property("maxRandomValue_", 894391400, "float", 40, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
