...
namespace Black.AIGraph.Extend.Invoke
{
    public partial class AIGraphInvokeResetAllowPush : SQEX.Ebony.AIGraph.Invoke.AIGraphInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Invoke.AIGraphInvokeResetAllowPush", 0, Black.AIGraph.Extend.Invoke.AIGraphInvokeResetAllowPush.ObjectType, Construct, properties, 0, 24);
        }
        ...
        {
            return new AIGraphInvokeResetAllowPush();
        }
