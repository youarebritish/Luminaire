...
namespace Black.AIGraph.Extend.Invoke
{
    public partial class AIGraphInvokeResetWantPush : SQEX.Ebony.AIGraph.Invoke.AIGraphInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Invoke.AIGraphInvokeResetWantPush", 0, Black.AIGraph.Extend.Invoke.AIGraphInvokeResetWantPush.ObjectType, Construct, properties, 0, 24);
        }
        ...
        {
            return new AIGraphInvokeResetWantPush();
        }
