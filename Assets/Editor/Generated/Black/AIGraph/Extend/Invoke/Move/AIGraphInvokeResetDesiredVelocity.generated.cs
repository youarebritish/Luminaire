...
namespace Black.AIGraph.Extend.Invoke.Move
{
    public partial class AIGraphInvokeResetDesiredVelocity : SQEX.Ebony.AIGraph.Invoke.AIGraphInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Invoke.Move.AIGraphInvokeResetDesiredVelocity", 0, Black.AIGraph.Extend.Invoke.Move.AIGraphInvokeResetDesiredVelocity.ObjectType, Construct, properties, 0, 24);
        }
        ...
        {
            return new AIGraphInvokeResetDesiredVelocity();
        }
