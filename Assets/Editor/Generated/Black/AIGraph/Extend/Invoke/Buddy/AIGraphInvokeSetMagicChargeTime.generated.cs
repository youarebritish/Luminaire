...
namespace Black.AIGraph.Extend.Invoke.Buddy
{
    public partial class AIGraphInvokeSetMagicChargeTime : SQEX.Ebony.AIGraph.Invoke.AIGraphInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Invoke.Buddy.AIGraphInvokeSetMagicChargeTime", 0, Black.AIGraph.Extend.Invoke.Buddy.AIGraphInvokeSetMagicChargeTime.ObjectType, Construct, properties, 0, 24);
        }
        ...
        {
            return new AIGraphInvokeSetMagicChargeTime();
        }
