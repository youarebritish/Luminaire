...
namespace Black.AIGraph.Extend.Invoke.Enemy
{
    public partial class AIGraphInvokeUpdateHate : SQEX.Ebony.AIGraph.Invoke.AIGraphInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Invoke.Enemy.AIGraphInvokeUpdateHate", 0, Black.AIGraph.Extend.Invoke.Enemy.AIGraphInvokeUpdateHate.ObjectType, Construct, properties, 0, 24);
        }
        ...
        {
            return new AIGraphInvokeUpdateHate();
        }
