...
namespace Black.AIGraph.Extend.Invoke.Enemy
{
    public partial class AIGraphInvokeEnemyLinkAttackSeqCancel : SQEX.Ebony.AIGraph.Invoke.AIGraphInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Invoke.Enemy.AIGraphInvokeEnemyLinkAttackSeqCancel", 0, Black.AIGraph.Extend.Invoke.Enemy.AIGraphInvokeEnemyLinkAttackSeqCancel.ObjectType, Construct, properties, 0, 24);
        }
        ...
        {
            return new AIGraphInvokeEnemyLinkAttackSeqCancel();
        }
