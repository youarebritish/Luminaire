...
namespace Black.AIGraph.Extend.Invoke.Monster
{
    public partial class AIGraphInvokeSetFlinchArmor : SQEX.Ebony.AIGraph.Invoke.AIGraphInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Invoke.Monster.AIGraphInvokeSetFlinchArmor", 0, Black.AIGraph.Extend.Invoke.Monster.AIGraphInvokeSetFlinchArmor.ObjectType, Construct, properties, 0, 32);
        }
        ...
        {
            return new AIGraphInvokeSetFlinchArmor();
        }
