...
namespace Black.AIGraph.Extend.Invoke.Monster
{
    public partial class AIGraphInvokeIncStress : SQEX.Ebony.AIGraph.Invoke.AIGraphInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Invoke.Monster.AIGraphInvokeIncStress", 0, Black.AIGraph.Extend.Invoke.Monster.AIGraphInvokeIncStress.ObjectType, Construct, properties, 0, 32);
        }
        ...
        {
            return new AIGraphInvokeIncStress();
        }
