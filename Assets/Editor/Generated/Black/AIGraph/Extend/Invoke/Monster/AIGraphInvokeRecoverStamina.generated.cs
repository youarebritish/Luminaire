...
namespace Black.AIGraph.Extend.Invoke.Monster
{
    public partial class AIGraphInvokeRecoverStamina : SQEX.Ebony.AIGraph.Invoke.AIGraphInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Invoke.Monster.AIGraphInvokeRecoverStamina", 0, Black.AIGraph.Extend.Invoke.Monster.AIGraphInvokeRecoverStamina.ObjectType, Construct, properties, 0, 24);
        }
        ...
        {
            return new AIGraphInvokeRecoverStamina();
        }
