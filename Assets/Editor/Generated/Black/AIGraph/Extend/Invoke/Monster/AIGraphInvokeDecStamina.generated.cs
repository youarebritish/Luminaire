...
namespace Black.AIGraph.Extend.Invoke.Monster
{
    public partial class AIGraphInvokeDecStamina : SQEX.Ebony.AIGraph.Invoke.AIGraphInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Invoke.Monster.AIGraphInvokeDecStamina", 0, Black.AIGraph.Extend.Invoke.Monster.AIGraphInvokeDecStamina.ObjectType, Construct, properties, 0, 32);
        }
        ...
        {
            return new AIGraphInvokeDecStamina();
        }
