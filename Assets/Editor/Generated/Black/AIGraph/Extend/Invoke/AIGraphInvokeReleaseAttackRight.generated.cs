...
namespace Black.AIGraph.Extend.Invoke
{
    public partial class AIGraphInvokeReleaseAttackRight : SQEX.Ebony.AIGraph.Invoke.AIGraphInvokeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Extend.Invoke.AIGraphInvokeReleaseAttackRight", 0, Black.AIGraph.Extend.Invoke.AIGraphInvokeReleaseAttackRight.ObjectType, Construct, properties, 0, 24);
        }
        ...
        {
            return new AIGraphInvokeReleaseAttackRight();
        }
