...
namespace Black.AIGraph.Extend.Node.FSM
{
    public partial class AIGraphNodeFSMStateMindTaskTray : SQEX.Ebony.AIGraph.Node.FSM.AIGraphNodeFSMBase
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("id.propertyId_", 3123770551, "int", 200, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("id.indexOfLinkedProperty_", 3124156648, "int", 204, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("id.value_", 2062651460, "SQEX.Ebony.Std.Fixid", 216, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
