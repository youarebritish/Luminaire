...
namespace Black.AIGraph.CondNode.AI
{
    public partial class AILeafNodeCheckDestinationOfAnimation : SQEX.Ebony.AIGraph.Node.BT.Decorator.AIGraphNodeBTDecoratorCondition
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("animClipRowID_.propertyId_", 2468338287, "int", 352, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("animClipRowID_.indexOfLinkedProperty_", 3011325600, "int", 356, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("animClipRowID_.value_", 2779825004, "int", 368, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
