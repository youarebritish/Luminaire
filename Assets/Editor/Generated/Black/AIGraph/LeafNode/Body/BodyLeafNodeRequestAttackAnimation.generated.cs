...
namespace Black.AIGraph.LeafNode.Body
{
    public partial class BodyLeafNodeRequestAttackAnimation : Black.AIGraph.LeafNode.Body.BodyLeafNodeRegistAnimationMessage
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.Body.BodyLeafNodeRequestAttackAnimation", 0, Black.AIGraph.LeafNode.Body.BodyLeafNodeRequestAttackAnimation.ObjectType, Construct, properties, 0, 160);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("status", 3125508079, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyEnum", 56, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("animPlayThreshold", 1398097277, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyFloat", 88, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("bContinueMessageExecuting", 993456209, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyBool", 120, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
        ...
        {
            return new BodyLeafNodeRequestAttackAnimation();
        }
