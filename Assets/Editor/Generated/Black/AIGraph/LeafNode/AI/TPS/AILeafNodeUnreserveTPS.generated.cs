...
namespace Black.AIGraph.LeafNode.AI.TPS
{
    public partial class AILeafNodeUnreserveTPS : SQEX.Ebony.AIGraph.Node.Leaf.AIGraphNodeLeafBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.TPS.AILeafNodeUnreserveTPS", 0, Black.AIGraph.LeafNode.AI.TPS.AILeafNodeUnreserveTPS.ObjectType, Construct, properties, 0, 64);
        }
        ...
        {
            return new AILeafNodeUnreserveTPS();
        }
