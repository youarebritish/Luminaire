...
namespace Black.AIGraph.LeafNode.AI.Move.Nifl
{
    public partial class AILeafNodeApproachMoveToTeam : Black.AIGraph.LeafNode.AI.Move.AILeafNodeMoveBase
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveSpeed.propertyId_", 3239488168, "int", 608, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("moveSpeed.indexOfLinkedProperty_", 3346172701, "int", 612, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("moveSpeed.value_", 4070489165, "float", 624, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
