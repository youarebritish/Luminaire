...
namespace Black.AIGraph.LeafNode.AI.Move
{
    public partial class AILeafNodeAroundMove : Black.AIGraph.LeafNode.AI.Move.AILeafNodeMoveBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Move.AILeafNodeAroundMove", 0, Black.AIGraph.LeafNode.AI.Move.AILeafNodeAroundMove.ObjectType, Construct, properties, 0, 808);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("aroundType_.propertyId_", 2067460262, "int", 608, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("aroundType_.indexOfLinkedProperty_", 2003832451, "int", 612, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("aroundType_.value_", 1643225223, "int", 624, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("offsetNear_.propertyId_", 392590406, "int", 640, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("offsetNear_.indexOfLinkedProperty_", 3029972643, "int", 644, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("offsetNear_.value_", 690186855, "float", 656, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("offsetFar_.propertyId_", 1340937823, "int", 672, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("offsetFar_.indexOfLinkedProperty_", 1132891664, "int", 676, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("offsetFar_.value_", 3250874492, "float", 688, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("offsetAngleDeg_.propertyId_", 1144123915, "int", 704, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("offsetAngleDeg_.indexOfLinkedProperty_", 2659354132, "int", 708, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("offsetAngleDeg_.value_", 423204208, "float", 720, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
        ...
        {
            return new AILeafNodeAroundMove();
        }
