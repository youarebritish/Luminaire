...
namespace Black.AIGraph.LeafNode.AI.Move
{
    public partial class AILeafNodeHeatmapPathPlanMove : Black.AIGraph.LeafNode.AI.Move.AILeafNodeMoveBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Move.AILeafNodeHeatmapPathPlanMove", 0, Black.AIGraph.LeafNode.AI.Move.AILeafNodeHeatmapPathPlanMove.ObjectType, Construct, properties, 0, 776);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("arrivalDistance.propertyId_", 3467076142, "int", 576, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("arrivalDistance.indexOfLinkedProperty_", 3065874635, "int", 580, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("arrivalDistance.value_", 841308895, "float", 592, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("failedDistance.propertyId_", 4019839624, "int", 608, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("failedDistance.indexOfLinkedProperty_", 245271421, "int", 612, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("failedDistance.value_", 1241337965, "float", 624, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("heatHeuristicPower.propertyId_", 2005386525, "int", 672, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("heatHeuristicPower.indexOfLinkedProperty_", 660501238, "int", 676, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("heatHeuristicPower.value_", 4232648358, "float", 688, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("heatMapFixid_.propertyId_", 3683880571, "int", 704, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("heatMapFixid_.indexOfLinkedProperty_", 2213415620, "int", 708, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("heatMapFixid_.value_", 134711552, "SQEX.Ebony.Std.Fixid", 720, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("TPSfixid.propertyId_", 251804171, "int", 736, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("TPSfixid.indexOfLinkedProperty_", 2875891220, "int", 740, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("TPSfixid.value_", 560704880, "SQEX.Ebony.Std.Fixid", 752, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
        ...
        {
            return new AILeafNodeHeatmapPathPlanMove();
        }
