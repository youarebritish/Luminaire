...
namespace Black.AIGraph.LeafNode.AI.Move
{
    public partial class AILeafNodeTPSApproachMove : Black.AIGraph.LeafNode.AI.Move.AILeafNodeMoveBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Move.AILeafNodeTPSApproachMove", 0, Black.AIGraph.LeafNode.AI.Move.AILeafNodeTPSApproachMove.ObjectType, Construct, properties, 0, 800);
        }
        ...
        {
            return new AILeafNodeTPSApproachMove();
        }
