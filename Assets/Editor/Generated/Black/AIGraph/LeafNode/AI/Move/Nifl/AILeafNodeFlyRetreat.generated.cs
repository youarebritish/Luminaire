...
namespace Black.AIGraph.LeafNode.AI.Move.Nifl
{
    public partial class AILeafNodeFlyRetreat : Black.AIGraph.LeafNode.AI.Move.AILeafNodeMoveBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Move.Nifl.AILeafNodeFlyRetreat", 0, Black.AIGraph.LeafNode.AI.Move.Nifl.AILeafNodeFlyRetreat.ObjectType, Construct, properties, 0, 704);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("enableRetretDistanceOutsideCamera.propertyId_", 4016082102, "int", 576, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("enableRetretDistanceOutsideCamera.indexOfLinkedProperty_", 1740770579, "int", 580, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("enableRetretDistanceOutsideCamera.value_", 1108113911, "float", 592, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("enableRetretDistanceInsideCamera.propertyId_", 2172525167, "int", 608, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("enableRetretDistanceInsideCamera.indexOfLinkedProperty_", 2796678816, "int", 612, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("enableRetretDistanceInsideCamera.value_", 3459613548, "float", 624, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("enableRetreatMinimumAngle_.propertyId_", 1162169340, "int", 640, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("enableRetreatMinimumAngle_.indexOfLinkedProperty_", 2304876169, "int", 644, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("enableRetreatMinimumAngle_.value_", 2744639705, "float", 656, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("fadeOutTime.propertyId_", 2799449915, "int", 672, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("fadeOutTime.indexOfLinkedProperty_", 863358084, "int", 676, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("fadeOutTime.value_", 2958669248, "float", 688, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
        ...
        {
            return new AILeafNodeFlyRetreat();
        }
