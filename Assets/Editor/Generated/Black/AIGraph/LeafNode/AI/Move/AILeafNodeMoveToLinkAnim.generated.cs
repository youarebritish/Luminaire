...
namespace Black.AIGraph.LeafNode.AI.Move
{
    public partial class AILeafNodeMoveToLinkAnim : Black.AIGraph.LeafNode.AI.Move.AILeafNodeMoveBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Move.AILeafNodeMoveToLinkAnim", 0, Black.AIGraph.LeafNode.AI.Move.AILeafNodeMoveToLinkAnim.ObjectType, Construct, properties, 0, 752);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveSpeed.propertyId_", 3239488168, "int", 576, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("moveSpeed.indexOfLinkedProperty_", 3346172701, "int", 580, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("moveSpeed.value_", 4070489165, "float", 592, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("arrivalAngle.propertyId_", 1297794438, "int", 640, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("arrivalAngle.indexOfLinkedProperty_", 2942393571, "int", 644, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("arrivalAngle.value_", 851986599, "float", 656, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("failureDistance.propertyId_", 2107794153, "int", 672, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("failureDistance.indexOfLinkedProperty_", 741257018, "int", 676, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("failureDistance.value_", 1153459210, "float", 688, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("arrivalAngle", 1474944961, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyFloat", 632, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			fieldProperties.AddProperty(new Property("failureDistance", 423188462, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyFloat", 664, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
        ...
        {
            return new AILeafNodeMoveToLinkAnim();
        }
