...
namespace Black.AIGraph.LeafNode.AI.Move
{
    public partial class AILeafNodeRouteMove : Black.AIGraph.LeafNode.AI.Move.AILeafNodeMoveBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Move.AILeafNodeRouteMove", 0, Black.AIGraph.LeafNode.AI.Move.AILeafNodeRouteMove.ObjectType, Construct, properties, 0, 1136);
        }
        ...
        {
            return new AILeafNodeRouteMove();
        }
