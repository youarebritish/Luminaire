...
namespace Black.AIGraph.LeafNode.AI.Move.Levia
{
    public partial class AIGraphLeafNodeLeviaMoveToPoint : Black.AIGraph.LeafNode.AI.Move.Levia.AIGraphLeafNodeLeviaMovePointBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Move.Levia.AIGraphLeafNodeLeviaMoveToPoint", 0, Black.AIGraph.LeafNode.AI.Move.Levia.AIGraphLeafNodeLeviaMoveToPoint.ObjectType, Construct, properties, 0, 1248);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("point_.propertyId_", 3102841589, "int", 1064, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("point_.indexOfLinkedProperty_", 4223034222, "int", 1068, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("point_.value_", 4101311598, "Luminous.Math.VectorA", 1088, 16, 1, Property.PrimitiveType.Vector4, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("randRadiusInner_.propertyId_", 538528950, "int", 1128, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("randRadiusInner_.indexOfLinkedProperty_", 3756674323, "int", 1132, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("randRadiusInner_.value_", 1134868983, "float", 1144, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("randRadiusOuter_.propertyId_", 1691777543, "int", 1160, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("randRadiusOuter_.indexOfLinkedProperty_", 3795868088, "int", 1164, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("randRadiusOuter_.value_", 3316900532, "float", 1176, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("randHeightMin_.propertyId_", 2300911623, "int", 1192, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("randHeightMin_.indexOfLinkedProperty_", 1292843960, "int", 1196, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("randHeightMin_.value_", 2821080244, "float", 1208, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("randHeightMax_.propertyId_", 2048223269, "int", 1224, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("randHeightMax_.indexOfLinkedProperty_", 4098648286, "int", 1228, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("randHeightMax_.value_", 2577304574, "float", 1240, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
        ...
        {
            return new AIGraphLeafNodeLeviaMoveToPoint();
        }
