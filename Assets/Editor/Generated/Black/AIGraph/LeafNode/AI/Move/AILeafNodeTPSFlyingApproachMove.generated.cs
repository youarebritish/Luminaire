...
namespace Black.AIGraph.LeafNode.AI.Move
{
    public partial class AILeafNodeTPSFlyingApproachMove : Black.AIGraph.LeafNode.AI.Move.AILeafNodeTPSApproachMove
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Move.AILeafNodeTPSFlyingApproachMove", 0, Black.AIGraph.LeafNode.AI.Move.AILeafNodeTPSFlyingApproachMove.ObjectType, Construct, properties, 0, 832);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("arrivalDistance", 1703907641, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyFloat", 600, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("arrivalDistance.propertyId_", 3467076142, "int", 608, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("arrivalDistance.indexOfLinkedProperty_", 3065874635, "int", 612, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("arrivalDistance.value_", 841308895, "float", 624, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("failedDistance", 3021369375, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyFloat", 632, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("failedDistance.propertyId_", 4019839624, "int", 640, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("failedDistance.indexOfLinkedProperty_", 245271421, "int", 644, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("failedDistance.value_", 1241337965, "float", 656, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("useCurrentSpeed", 478586348, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyBool", 696, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("useCurrentSpeed.propertyId_", 3630274163, "int", 704, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("useCurrentSpeed.indexOfLinkedProperty_", 1255434204, "int", 708, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("useCurrentSpeed.value_", 4177597832, "bool", 720, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("isValidationFailure", 119062456, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyBool", 728, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("isValidationFailure.propertyId_", 1159519359, "int", 736, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("isValidationFailure.indexOfLinkedProperty_", 2298692656, "int", 740, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("isValidationFailure.value_", 2350499804, "bool", 752, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("isStopTPSValidationOnDeactivate_", 95834083, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyBool", 760, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("isStopTPSValidationOnDeactivate_.propertyId_", 4099686284, "int", 768, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("isStopTPSValidationOnDeactivate_.indexOfLinkedProperty_", 2729555481, "int", 772, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("isStopTPSValidationOnDeactivate_.value_", 1321815561, "bool", 784, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("heightOffset.propertyId_", 1627581882, "int", 808, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("heightOffset.indexOfLinkedProperty_", 873549551, "int", 812, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("heightOffset.value_", 3703871443, "float", 824, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
        ...
        {
            return new AILeafNodeTPSFlyingApproachMove();
        }
