...
namespace Black.AIGraph.LeafNode.AI.Move
{
    public partial class AILeafNodeHeatMapMove : Black.AIGraph.LeafNode.AI.Move.AILeafNodeMoveBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Move.AILeafNodeHeatMapMove", 0, Black.AIGraph.LeafNode.AI.Move.AILeafNodeHeatMapMove.ObjectType, Construct, properties, 0, 728);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("rangeLowerBound.propertyId_", 882250482, "int", 576, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("rangeLowerBound.indexOfLinkedProperty_", 2289560295, "int", 580, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("rangeLowerBound.value_", 3875452987, "float", 592, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("rangeUpperBound.propertyId_", 1107200353, "int", 608, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("rangeUpperBound.indexOfLinkedProperty_", 2425492466, "int", 612, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("rangeUpperBound.value_", 2460566770, "float", 624, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("ascendHeat.propertyId_", 2252076034, "int", 640, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("ascendHeat.indexOfLinkedProperty_", 2204850487, "int", 644, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("ascendHeat.value_", 1693701099, "bool", 656, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("mapDescriptorFixid.propertyId_", 1266262997, "int", 704, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("mapDescriptorFixid.indexOfLinkedProperty_", 689930318, "int", 708, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("mapDescriptorFixid.value_", 2972000782, "SQEX.Ebony.Std.Fixid", 720, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
        ...
        {
            return new AILeafNodeHeatMapMove();
        }
