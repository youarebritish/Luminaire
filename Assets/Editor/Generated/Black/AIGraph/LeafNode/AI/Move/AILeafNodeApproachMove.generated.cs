...
namespace Black.AIGraph.LeafNode.AI.Move
{
    public partial class AILeafNodeApproachMove : Black.AIGraph.LeafNode.AI.Move.AILeafNodeMoveBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Move.AILeafNodeApproachMove", 0, Black.AIGraph.LeafNode.AI.Move.AILeafNodeApproachMove.ObjectType, Construct, properties, 0, 832);
        }
        ...
        {
            return new AILeafNodeApproachMove();
        }
