...
namespace Black.AIGraph.LeafNode.AI.Move
{
    public partial class AILeafNodeRelativeTargetFlyingMove : Black.AIGraph.LeafNode.AI.Move.AILeafNodeRelativeTargetMove
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Move.AILeafNodeRelativeTargetFlyingMove", 0, Black.AIGraph.LeafNode.AI.Move.AILeafNodeRelativeTargetFlyingMove.ObjectType, Construct, properties, 0, 960);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("targetType_", 4725453, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyEnum", 568, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("searchLabel_", 3037400282, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyString", 600, 56, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("arrivalInnnerDistance_", 3211809926, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyFloat", 656, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("arrivalOuterDistance_", 185253379, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyFloat", 688, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("failedDistance_", 3209868480, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyFloat", 720, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveSpeed_", 113149984, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyFloat", 752, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("atLocationPreference", 1680432498, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyEnum", 784, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("height_.propertyId_", 1400383392, "int", 904, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("height_.indexOfLinkedProperty_", 1377118453, "int", 908, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("height_.value_", 1901463765, "float", 920, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("keepHeight_.propertyId_", 3077637435, "int", 936, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("keepHeight_.indexOfLinkedProperty_", 4241057412, "int", 940, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("keepHeight_.value_", 2251476928, "bool", 952, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
        ...
        {
            return new AILeafNodeRelativeTargetFlyingMove();
        }
