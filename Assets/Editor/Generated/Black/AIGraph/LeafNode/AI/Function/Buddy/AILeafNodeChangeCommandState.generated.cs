...
namespace Black.AIGraph.LeafNode.AI.Function.Buddy
{
    public partial class AILeafNodeChangeCommandState : SQEX.Ebony.AIGraph.Node.Leaf.AIGraphNodeLeafBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Function.Buddy.AILeafNodeChangeCommandState", 0, Black.AIGraph.LeafNode.AI.Function.Buddy.AILeafNodeChangeCommandState.ObjectType, Construct, properties, 0, 88);
        }
        ...
        {
            return new AILeafNodeChangeCommandState();
        }
