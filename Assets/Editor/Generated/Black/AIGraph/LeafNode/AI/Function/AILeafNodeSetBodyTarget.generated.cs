...
namespace Black.AIGraph.LeafNode.AI.Function
{
    public partial class AILeafNodeSetBodyTarget : SQEX.Ebony.AIGraph.Node.Leaf.AIGraphNodeLeafBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Function.AILeafNodeSetBodyTarget", 0, Black.AIGraph.LeafNode.AI.Function.AILeafNodeSetBodyTarget.ObjectType, Construct, properties, 0, 96);
        }
        ...
        {
            return new AILeafNodeSetBodyTarget();
        }
