...
namespace Black.AIGraph.LeafNode.AI.Function
{
    public partial class AIGraphNodeLeafBattleStatusEPI : SQEX.Ebony.AIGraph.Node.Leaf.AIGraphNodeLeafBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Function.AIGraphNodeLeafBattleStatusEPI", 0, Black.AIGraph.LeafNode.AI.Function.AIGraphNodeLeafBattleStatusEPI.ObjectType, Construct, properties, 0, 56);
        }
        ...
        {
            return new AIGraphNodeLeafBattleStatusEPI();
        }
