...
namespace Black.AIGraph.LeafNode.AI.Action.Buddy
{
    public partial class AILeafNodeShiftBreak : Black.AIGraph.LeafNode.AI.Action.AILeafNodeExecAction
    {
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("bCheckMPBurst.propertyId_", 4006822151, "int", 328, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("bCheckMPBurst.indexOfLinkedProperty_", 3580905144, "int", 332, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("bCheckMPBurst.value_", 593399732, "bool", 344, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
