...
namespace Black.AIGraph.LeafNode.AI.Action
{
    public partial class AILeafNodeShootingAttack : Black.AIGraph.LeafNode.AI.Action.AILeafNodeSendMessageWithCheckCanControl
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Action.AILeafNodeShootingAttack", 0, Black.AIGraph.LeafNode.AI.Action.AILeafNodeShootingAttack.ObjectType, Construct, properties, 0, 480);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("canThroughLineOfFire", 2035432221, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyBool", 416, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
        ...
        {
            return new AILeafNodeShootingAttack();
        }
