...
namespace Black.AIGraph.LeafNode.AI.Action
{
    public partial class AILeafNodeReturnToTerritory : Black.AIGraph.LeafNode.AI.Move.AILeafNodeMoveBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Action.AILeafNodeReturnToTerritory", 0, Black.AIGraph.LeafNode.AI.Action.AILeafNodeReturnToTerritory.ObjectType, Construct, properties, 0, 688);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("moveSpeed.propertyId_", 3239488168, "int", 656, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("moveSpeed.indexOfLinkedProperty_", 3346172701, "int", 660, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("moveSpeed.value_", 4070489165, "float", 672, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
        ...
        {
            return new AILeafNodeReturnToTerritory();
        }
