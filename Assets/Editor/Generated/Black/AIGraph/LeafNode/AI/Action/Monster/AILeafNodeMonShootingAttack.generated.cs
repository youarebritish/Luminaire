...
namespace Black.AIGraph.LeafNode.AI.Action.Monster
{
    public partial class AILeafNodeMonShootingAttack : Black.AIGraph.LeafNode.AI.Action.AILeafNodeShootingAttack
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.AI.Action.Monster.AILeafNodeMonShootingAttack", 0, Black.AIGraph.LeafNode.AI.Action.Monster.AILeafNodeMonShootingAttack.ObjectType, Construct, properties, 0, 544);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("canThroughLineOfFire", 2035432221, "SQEX.Ebony.AIGraph.Data.PropertyData.PropertyBool", 416, 32, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("canThroughLineOfFire.propertyId_", 996517538, "int", 424, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("canThroughLineOfFire.indexOfLinkedProperty_", 1901589975, "int", 428, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("canThroughLineOfFire.value_", 2715336651, "bool", 440, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
        ...
        {
            return new AILeafNodeMonShootingAttack();
        }
