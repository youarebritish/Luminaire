...
namespace Black.AIGraph.LeafNode.Test
{
    public partial class AIGraphLeafNodeMeleeAttackTest : Black.AIGraph.LeafNode.Test.AIGraphLeafNodeAttackBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.Test.AIGraphLeafNodeMeleeAttackTest", 0, Black.AIGraph.LeafNode.Test.AIGraphLeafNodeMeleeAttackTest.ObjectType, Construct, properties, 0, 352);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("atkType.propertyId_", 395894166, "int", 312, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("atkType.indexOfLinkedProperty_", 1777394547, "int", 316, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("atkType.value_", 1959011863, "int", 328, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
        ...
        {
            return new AIGraphLeafNodeMeleeAttackTest();
        }
