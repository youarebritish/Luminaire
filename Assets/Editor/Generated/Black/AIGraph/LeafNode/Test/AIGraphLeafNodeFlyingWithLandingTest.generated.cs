...
namespace Black.AIGraph.LeafNode.Test
{
    public partial class AIGraphLeafNodeFlyingWithLandingTest : Black.AIGraph.LeafNode.AI.Move.AILeafNodeMoveBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.Test.AIGraphLeafNodeFlyingWithLandingTest", 0, Black.AIGraph.LeafNode.Test.AIGraphLeafNodeFlyingWithLandingTest.ObjectType, Construct, properties, 0, 704);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("allowableDistanceError_.propertyId_", 1526070605, "int", 608, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("allowableDistanceError_.indexOfLinkedProperty_", 3446684326, "int", 612, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("allowableDistanceError_.value_", 1827228470, "float", 624, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("landingType.propertyId_", 568806251, "int", 640, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("landingType.indexOfLinkedProperty_", 210459508, "int", 644, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("landingType.value_", 52040464, "int", 656, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
        ...
        {
            return new AIGraphLeafNodeFlyingWithLandingTest();
        }
