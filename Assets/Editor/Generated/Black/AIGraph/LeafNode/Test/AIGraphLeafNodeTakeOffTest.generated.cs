...
namespace Black.AIGraph.LeafNode.Test
{
    public partial class AIGraphLeafNodeTakeOffTest : SQEX.Ebony.AIGraph.Node.Leaf.AIGraphNodeLeafBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.LeafNode.Test.AIGraphLeafNodeTakeOffTest", 0, Black.AIGraph.LeafNode.Test.AIGraphLeafNodeTakeOffTest.ObjectType, null, properties, 0, 96);
        }
