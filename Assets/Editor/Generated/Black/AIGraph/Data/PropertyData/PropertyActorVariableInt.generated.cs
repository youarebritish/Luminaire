...
namespace Black.AIGraph.Data.PropertyData
{
    public partial class PropertyActorVariableInt : Black.AIGraph.Data.PropertyData.PropertyActorVariableBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Data.PropertyData.PropertyActorVariableInt", 0, Black.AIGraph.Data.PropertyData.PropertyActorVariableInt.ObjectType, Construct, properties, 0, 40);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("kind_", 3595366932, "Black.Sequence.Actor.SequenceVariableActorInt.ValueKind", 32, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
        ...
        {
            return new PropertyActorVariableInt();
        }
