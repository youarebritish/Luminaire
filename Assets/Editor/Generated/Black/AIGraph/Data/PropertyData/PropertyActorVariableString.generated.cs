...
namespace Black.AIGraph.Data.PropertyData
{
    public partial class PropertyActorVariableString : Black.AIGraph.Data.PropertyData.PropertyActorVariableBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Data.PropertyData.PropertyActorVariableString", 0, Black.AIGraph.Data.PropertyData.PropertyActorVariableString.ObjectType, Construct, properties, 0, 40);
        }
        ...
        {
            return new PropertyActorVariableString();
        }
