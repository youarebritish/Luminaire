...
namespace Black.AIGraph.Data.PropertyData
{
    public partial class PropertyMemoryVariableEnum : Black.AIGraph.Data.PropertyData.PropertyMemoryVariableBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Data.PropertyData.PropertyMemoryVariableEnum", 0, Black.AIGraph.Data.PropertyData.PropertyMemoryVariableEnum.ObjectType, Construct, properties, 0, 40);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("kind_", 3595366932, "Black.AI.Recog.TargetMemoryAccessor.ValueKindEnum", 32, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
        ...
        {
            return new PropertyMemoryVariableEnum();
        }
