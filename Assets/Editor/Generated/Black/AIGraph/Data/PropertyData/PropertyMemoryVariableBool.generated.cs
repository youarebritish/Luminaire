...
namespace Black.AIGraph.Data.PropertyData
{
    public partial class PropertyMemoryVariableBool : Black.AIGraph.Data.PropertyData.PropertyMemoryVariableBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Data.PropertyData.PropertyMemoryVariableBool", 0, Black.AIGraph.Data.PropertyData.PropertyMemoryVariableBool.ObjectType, Construct, properties, 0, 40);
        }
        ...
        {
            return new PropertyMemoryVariableBool();
        }
