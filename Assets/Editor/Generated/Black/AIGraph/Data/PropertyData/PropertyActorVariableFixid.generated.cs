...
namespace Black.AIGraph.Data.PropertyData
{
    public partial class PropertyActorVariableFixid : Black.AIGraph.Data.PropertyData.PropertyActorVariableBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Data.PropertyData.PropertyActorVariableFixid", 0, Black.AIGraph.Data.PropertyData.PropertyActorVariableFixid.ObjectType, Construct, properties, 0, 40);
        }
        ...
        {
            return new PropertyActorVariableFixid();
        }
