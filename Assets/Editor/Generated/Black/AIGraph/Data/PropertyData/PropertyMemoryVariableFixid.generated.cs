...
namespace Black.AIGraph.Data.PropertyData
{
    public partial class PropertyMemoryVariableFixid : Black.AIGraph.Data.PropertyData.PropertyMemoryVariableBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.AIGraph.Data.PropertyData.PropertyMemoryVariableFixid", 0, Black.AIGraph.Data.PropertyData.PropertyMemoryVariableFixid.ObjectType, Construct, properties, 0, 40);
        }
        ...
        {
            return new PropertyMemoryVariableFixid();
        }
