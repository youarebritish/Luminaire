...
namespace Black.Actor
{
    public partial class ActorMergedStaticMap : Black.Actor.ActorPosition
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Actor.ActorMergedStaticMap", 0, Black.Actor.ActorMergedStaticMap.ObjectType, Construct, properties, 59, 832);
        }
        ...
        {
            return new ActorMergedStaticMap();
        }
