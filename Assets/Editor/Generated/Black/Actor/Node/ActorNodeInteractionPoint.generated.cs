...
namespace Black.Actor.Node
{
    public partial class ActorNodeInteractionPoint : Black.Actor.Node.ActorNodeTargetPoint
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Actor.Node.ActorNodeInteractionPoint", 0, Black.Actor.Node.ActorNodeInteractionPoint.ObjectType, Construct, properties, 59, 1072);
        }
        ...
        {
            return new ActorNodeInteractionPoint();
        }
