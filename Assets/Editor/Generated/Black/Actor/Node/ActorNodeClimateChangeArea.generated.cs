...
namespace Black.Actor.Node
{
    public partial class ActorNodeClimateChangeArea : Black.Actor.Node.ActorNodeTriggerBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Actor.Node.ActorNodeClimateChangeArea", 0, Black.Actor.Node.ActorNodeClimateChangeArea.ObjectType, Construct, properties, 59, 1376);
        }
        ...
        {
            return new ActorNodeClimateChangeArea();
        }
