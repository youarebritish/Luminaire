...
namespace Black.Actor.Node
{
    public partial class ActorNodePoint : Black.Actor.ActorPosition
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Actor.Node.ActorNodePoint", 0, Black.Actor.Node.ActorNodePoint.ObjectType, Construct, properties, 59, 912);
        }
