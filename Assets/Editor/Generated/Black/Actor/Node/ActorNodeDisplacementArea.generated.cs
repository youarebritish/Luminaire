...
namespace Black.Actor.Node
{
    public partial class ActorNodeDisplacementArea : Black.Actor.Node.ActorNodeTriggerBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Actor.Node.ActorNodeDisplacementArea", 0, Black.Actor.Node.ActorNodeDisplacementArea.ObjectType, Construct, properties, 59, 1200);
        }
        ...
        {
            return new ActorNodeDisplacementArea();
        }
