...
namespace Black.Actor.Node
{
    public partial class ActorNodeSpawnPoint : Black.Actor.Node.ActorNodePoint
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Actor.Node.ActorNodeSpawnPoint", 0, Black.Actor.Node.ActorNodeSpawnPoint.ObjectType, Construct, properties, 59, 1024);
        }
        ...
        {
            return new ActorNodeSpawnPoint();
        }
