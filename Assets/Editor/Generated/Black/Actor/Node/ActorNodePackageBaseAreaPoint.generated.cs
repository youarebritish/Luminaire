...
namespace Black.Actor.Node
{
    public partial class ActorNodePackageBaseAreaPoint : Black.Actor.Node.ActorNodeTrigger
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Actor.Node.ActorNodePackageBaseAreaPoint", 0, Black.Actor.Node.ActorNodePackageBaseAreaPoint.ObjectType, Construct, properties, 59, 1360);
        }
        ...
        {
            return new ActorNodePackageBaseAreaPoint();
        }
