...
namespace Black.Actor.Node
{
    public partial class ActorNodeDamageArea : Black.Actor.Node.ActorNodeTrigger
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Actor.Node.ActorNodeDamageArea", 0, Black.Actor.Node.ActorNodeDamageArea.ObjectType, Construct, properties, 59, 1360);
        }
        ...
        {
            return new ActorNodeDamageArea();
        }
