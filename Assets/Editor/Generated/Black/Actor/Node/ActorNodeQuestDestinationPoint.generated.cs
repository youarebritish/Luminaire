...
namespace Black.Actor.Node
{
    public partial class ActorNodeQuestDestinationPoint : Black.Actor.Node.ActorNodePoint
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Actor.Node.ActorNodeQuestDestinationPoint", 0, Black.Actor.Node.ActorNodeQuestDestinationPoint.ObjectType, Construct, properties, 59, 944);
        }
        ...
        {
            return new ActorNodeQuestDestinationPoint();
        }
