...
namespace Black.Actor.Node
{
    public partial class ActorNodeInspirationTrigger : Black.Actor.Node.ActorNodeTrigger
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Actor.Node.ActorNodeInspirationTrigger", 0, Black.Actor.Node.ActorNodeInspirationTrigger.ObjectType, Construct, properties, 59, 1328);
        }
        ...
        {
            return new ActorNodeInspirationTrigger();
        }
