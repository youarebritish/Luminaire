...
namespace Black.Actor.Node
{
    public partial class ActorNodeCameraPoint : Black.Actor.Node.ActorNodePoint
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Actor.Node.ActorNodeCameraPoint", 0, Black.Actor.Node.ActorNodeCameraPoint.ObjectType, Construct, properties, 59, 976);
        }
        ...
        {
            return new ActorNodeCameraPoint();
        }
