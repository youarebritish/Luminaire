...
namespace Black.Actor.Node
{
    public partial class ActorNodeFreeRunPoint : Black.Actor.Node.ActorNodePoint
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("Black.Actor.Node.ActorNodeFreeRunPoint", 0, Black.Actor.Node.ActorNodeFreeRunPoint.ObjectType, Construct, properties, 59, 928);
        }
        ...
        {
            return new ActorNodeFreeRunPoint();
        }
