...
namespace SQEX.Ebony.Framework.Sequence.Variable.Conversion
{
    public partial class SequenceConversionIntToFloat : SQEX.Ebony.Framework.Sequence.Operator.SequenceOperator
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.Conversion.SequenceConversionIntToFloat", 0, SQEX.Ebony.Framework.Sequence.Variable.Conversion.SequenceConversionIntToFloat.ObjectType, null, properties, 0, 264);
        }
