...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceConstString : SQEX.Ebony.Framework.Sequence.Variable.SequenceConstBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceConstString", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceConstString.ObjectType, Construct, properties, 0, 192);
        }
        ...
        {
            return new SequenceConstString();
        }
