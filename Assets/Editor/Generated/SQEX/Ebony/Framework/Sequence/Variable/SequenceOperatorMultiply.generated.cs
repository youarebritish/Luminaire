...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceOperatorMultiply : SQEX.Ebony.Framework.Sequence.Operator.SequenceOperator
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorMultiply", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorMultiply.ObjectType, Construct, properties, 0, 352);
        }
        ...
        {
            return new SequenceOperatorMultiply();
        }
