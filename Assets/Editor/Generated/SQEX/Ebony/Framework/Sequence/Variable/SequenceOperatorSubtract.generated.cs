...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceOperatorSubtract : SQEX.Ebony.Framework.Sequence.Operator.SequenceOperator
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorSubtract", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorSubtract.ObjectType, Construct, properties, 0, 352);
        }
        ...
        {
            return new SequenceOperatorSubtract();
        }
