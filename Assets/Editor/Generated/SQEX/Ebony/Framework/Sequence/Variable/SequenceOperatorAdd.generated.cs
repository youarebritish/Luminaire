...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceOperatorAdd : SQEX.Ebony.Framework.Sequence.Operator.SequenceOperator
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorAdd", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorAdd.ObjectType, Construct, properties, 0, 352);
        }
        ...
        {
            return new SequenceOperatorAdd();
        }
