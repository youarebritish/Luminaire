...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceConstFixid : SQEX.Ebony.Framework.Sequence.Variable.SequenceConstBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceConstFixid", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceConstFixid.ObjectType, Construct, properties, 0, 192);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("data_.value_", 3112534122, "SQEX.Ebony.Std.Fixid", 184, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("data_", 3067826062, "SQEX.Ebony.Framework.Sequence.Variable.Primitive.SequenceFlexibleFixidData", 176, 16, 1, Property.PrimitiveType.ClassField, 0, (char)0));
