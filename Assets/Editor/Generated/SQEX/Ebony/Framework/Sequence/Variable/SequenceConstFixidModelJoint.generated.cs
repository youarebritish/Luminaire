...
{
    public partial class SequenceConstFixidModelJoint : SQEX.Ebony.Framework.Sequence.Variable.SequenceConstBase
    {
        new public static ObjectType ObjectType { get; private set; }
        private static PropertyContainer fieldProperties;
		
		public SQEX.Ebony.Framework.Node.GraphVariableOutputPin out_;
		public uint fixidModelJoint_;
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceConstFixidModelJoint();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceConstFixidModelJoint", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceConstFixidModelJoint.ObjectType, Construct, properties, 0, 184);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("SQEX.Ebony.Framework.Sequence.Variable.SequenceConstFixidModelJoint", base.GetFieldProperties(), -2117976983, 1948908925);
			...
			fieldProperties.AddProperty(new Property("fixidModelJoint_", 2379108715, "SQEX.Ebony.Std.Fixid", 176, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
        ...
        {
            return new SequenceConstFixidModelJoint();
        }
