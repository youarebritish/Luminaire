...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceOperatorNot : SQEX.Ebony.Framework.Sequence.Operator.SequenceOperator
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorNot", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorNot.ObjectType, Construct, properties, 0, 264);
        }
        ...
        {
            return new SequenceOperatorNot();
        }
