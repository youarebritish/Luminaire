...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceConstBool : SQEX.Ebony.Framework.Sequence.Variable.SequenceConstBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceConstBool", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceConstBool.ObjectType, Construct, properties, 0, 184);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("value_", 273093519, "bool", 176, 1, 1, Property.PrimitiveType.Bool, 0, (char)0));
