...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceConstantEntityGroup : SQEX.Ebony.Framework.Sequence.SequenceVariable
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceConstantEntityGroup", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceConstantEntityGroup.ObjectType, Construct, properties, 0, 184);
        }
        ...
        {
            return new SequenceConstantEntityGroup();
        }
