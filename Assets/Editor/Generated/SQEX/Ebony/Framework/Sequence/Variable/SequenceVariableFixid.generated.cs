...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceVariableFixid : SQEX.Ebony.Framework.Sequence.SequenceVariable
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceVariableFixid", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceVariableFixid.ObjectType, Construct, properties, 0, 280);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("data_.value_", 3112534122, "SQEX.Ebony.Std.Fixid", 272, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
        ...
        {
            return new SequenceVariableFixid();
        }
