...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceVariableFloat : SQEX.Ebony.Framework.Sequence.SequenceVariable
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceVariableFloat", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceVariableFloat.ObjectType, Construct, properties, 0, 272);
        }
        ...
        {
            return new SequenceVariableFloat();
        }
