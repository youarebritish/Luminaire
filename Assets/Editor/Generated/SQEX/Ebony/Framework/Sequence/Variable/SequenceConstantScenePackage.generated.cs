...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceConstantScenePackage : SQEX.Ebony.Framework.Sequence.Variable.SequenceConstantEntityGroup
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceConstantScenePackage", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceConstantScenePackage.ObjectType, Construct, properties, 0, 184);
        }
        ...
        {
            return new SequenceConstantScenePackage();
        }
