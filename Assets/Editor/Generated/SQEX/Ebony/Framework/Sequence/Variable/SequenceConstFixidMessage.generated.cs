...
{
    public partial class SequenceConstFixidMessage : SQEX.Ebony.Framework.Sequence.Variable.SequenceConstBase
    {
        new public static ObjectType ObjectType { get; private set; }
        private static PropertyContainer fieldProperties;
		
		public SQEX.Ebony.Framework.Node.GraphVariableOutputPin out_;
		public uint fixidMessage_;
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceConstFixidMessage();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceConstFixidMessage", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceConstFixidMessage.ObjectType, Construct, properties, 0, 184);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("SQEX.Ebony.Framework.Sequence.Variable.SequenceConstFixidMessage", base.GetFieldProperties(), 2088640855, -511839798);
			...
			fieldProperties.AddProperty(new Property("fixidMessage_", 3150612321, "SQEX.Ebony.Std.Fixid", 176, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
        ...
        {
            return new SequenceConstFixidMessage();
        }
