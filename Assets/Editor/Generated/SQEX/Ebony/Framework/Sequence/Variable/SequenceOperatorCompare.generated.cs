...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceOperatorCompare : SQEX.Ebony.Framework.Sequence.Operator.SequenceOperator
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorCompare", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorCompare.ObjectType, Construct, properties, 0, 360);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddIndirectlyProperty(new Property("in2_.pinName_", 3970046424, "Base.String", 96, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("in2_.name_", 667560819, "Base.String", 112, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			fieldProperties.AddIndirectlyProperty(new Property("in2_.connections_", 3920991323, "SQEX.Ebony.Std.DynamicArray< SQEX.Ebony.Framework.Node.GraphPin* >", 128, 16, 1, Property.PrimitiveType.PointerArray, 0, (char)1));
			fieldProperties.AddIndirectlyProperty(new Property("in2_.pinValueType_", 2360544550, "Base.String", 160, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			...
			fieldProperties.AddIndirectlyProperty(new Property("in1_.pinValueType_", 1995431457, "Base.String", 248, 16, 1, Property.PrimitiveType.String, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("in2_", 4277667841, "SQEX.Ebony.Framework.Node.GraphVariableInputPin", 88, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			fieldProperties.AddProperty(new Property("in1_", 1056909446, "SQEX.Ebony.Framework.Node.GraphVariableInputPin", 176, 88, 1, Property.PrimitiveType.ClassField, 0, (char)0));
			...
			fieldProperties.AddProperty(new Property("operator_", 305375494, "SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorCompare.CompareOperator", 352, 4, 1, Property.PrimitiveType.Enum, 0, (char)0));
        ...
        {
            return new SequenceOperatorCompare();
        }
