...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceOperatorDivide : SQEX.Ebony.Framework.Sequence.Operator.SequenceOperator
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorDivide", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorDivide.ObjectType, Construct, properties, 0, 352);
        }
        ...
        {
            return new SequenceOperatorDivide();
        }
