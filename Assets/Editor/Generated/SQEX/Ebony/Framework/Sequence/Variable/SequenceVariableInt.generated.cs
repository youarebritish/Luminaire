...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceVariableInt : SQEX.Ebony.Framework.Sequence.SequenceVariable
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceVariableInt", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceVariableInt.ObjectType, Construct, properties, 0, 272);
        }
        ...
        {
            return new SequenceVariableInt();
        }
