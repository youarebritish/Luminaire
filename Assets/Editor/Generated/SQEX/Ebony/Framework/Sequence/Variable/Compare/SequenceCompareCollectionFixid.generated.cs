...
namespace SQEX.Ebony.Framework.Sequence.Variable.Compare
{
    public partial class SequenceCompareCollectionFixid : SQEX.Ebony.Framework.Sequence.Variable.Compare.SequenceCompareCollectionBase
    {
		...
		public IList<SQEX.Ebony.Framework.Sequence.Variable.Compare.SequenceCompareFixid> conditions_= new List<SQEX.Ebony.Framework.Sequence.Variable.Compare.SequenceCompareFixid>();
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.Compare.SequenceCompareCollectionFixid", 0, SQEX.Ebony.Framework.Sequence.Variable.Compare.SequenceCompareCollectionFixid.ObjectType, null, properties, 0, 24);
        }
