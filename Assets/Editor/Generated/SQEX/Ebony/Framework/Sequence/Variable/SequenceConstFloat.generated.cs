...
namespace SQEX.Ebony.Framework.Sequence.Variable
{
    public partial class SequenceConstFloat : SQEX.Ebony.Framework.Sequence.Variable.SequenceConstBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceConstFloat", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceConstFloat.ObjectType, Construct, properties, 0, 184);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("value_", 273093519, "float", 176, 4, 1, Property.PrimitiveType.Float, 0, (char)0));
