...
{
    public partial class SequenceOperatorIsNoneValue : SQEX.Ebony.Framework.Sequence.Operator.SequenceOperator
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceOperatorIsNoneValue();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorIsNoneValue", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorIsNoneValue.ObjectType, Construct, properties, 0, 264);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("SQEX.Ebony.Framework.Sequence.Variable.SequenceOperatorIsNoneValue", base.GetFieldProperties(), 1373350651, 331646546);
        ...
        {
            return new SequenceOperatorIsNoneValue();
        }
