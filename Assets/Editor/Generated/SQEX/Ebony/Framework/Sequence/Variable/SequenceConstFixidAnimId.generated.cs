...
{
    public partial class SequenceConstFixidAnimId : SQEX.Ebony.Framework.Sequence.Variable.SequenceConstBase
    {
        new public static ObjectType ObjectType { get; private set; }
        private static PropertyContainer fieldProperties;
		
		public SQEX.Ebony.Framework.Node.GraphVariableOutputPin out_;
		public uint fixidAnimId_;
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceConstFixidAnimId();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.Variable.SequenceConstFixidAnimId", 0, SQEX.Ebony.Framework.Sequence.Variable.SequenceConstFixidAnimId.ObjectType, Construct, properties, 0, 184);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
            ...
            fieldProperties = new PropertyContainer("SQEX.Ebony.Framework.Sequence.Variable.SequenceConstFixidAnimId", base.GetFieldProperties(), 1056467927, -1987058375);
			...
			fieldProperties.AddProperty(new Property("fixidAnimId_", 3119912310, "SQEX.Ebony.Std.Fixid", 176, 4, 1, Property.PrimitiveType.Fixid, 0, (char)0));
        ...
        {
            return new SequenceConstFixidAnimId();
        }
