...
namespace SQEX.Ebony.Framework.Sequence
{
    public partial class SequenceValue
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            var dummy = new SequenceValue();
            var properties = dummy.GetFieldProperties();

            ObjectType = new ObjectType("SQEX.Ebony.Framework.Sequence.SequenceValue", 0, SQEX.Ebony.Framework.Sequence.SequenceValue.ObjectType, null, properties, 0, 48);
        }
