...
namespace SQEX.Ebony.Framework.TimeControl
{
    public partial class AnchorPointList : BaseObject
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.Framework.TimeControl.AnchorPointList", 0, SQEX.Ebony.Framework.TimeControl.AnchorPointList.ObjectType, null, properties, 0, 24);
        }
