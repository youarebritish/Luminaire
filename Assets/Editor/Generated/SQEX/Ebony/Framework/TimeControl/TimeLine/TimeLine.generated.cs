...
namespace SQEX.Ebony.Framework.TimeControl.TimeLine
{
    ...
    public partial class TimeLine : SQEX.Ebony.Framework.TimeControl.TimeLine.TrackBase
    {
		...
		[UnityEngine.SerializeReference] public List<SQEX.Ebony.Framework.Sequence.Action.TimeLine.Struct.TimeLineReferenceValue> subTimeLineList_= new List<SQEX.Ebony.Framework.Sequence.Action.TimeLine.Struct.TimeLineReferenceValue>();
		[UnityEngine.SerializeReference] public List<SQEX.Ebony.Framework.Sequence.Action.TimeLine.Struct.TimeLineReferenceValue> mainTimeLineList_= new List<SQEX.Ebony.Framework.Sequence.Action.TimeLine.Struct.TimeLineReferenceValue>();
