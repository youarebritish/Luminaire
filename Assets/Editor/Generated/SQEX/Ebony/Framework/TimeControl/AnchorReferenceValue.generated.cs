...
namespace SQEX.Ebony.Framework.TimeControl
{
    ...
    public partial class AnchorReferenceValue : BaseObject
    {
		...
		[UnityEngine.SerializeReference] public object dependencyProperty_;
		[UnityEngine.SerializeReference] public bool dependencyPropertyEnable_;
		public int elementIndex_;
		public bool curveEnable_;
		public float maxValue_;
		public float minValue_;
		[UnityEngine.SerializeReference] public List<SQEX.Ebony.Framework.TimeControl.AnchorPoint> anchorPoints_= new List<SQEX.Ebony.Framework.TimeControl.AnchorPoint>();
