...
namespace SQEX.Ebony.AIGraph.Node.BT.Behavior
{
    public partial class AIGraphNodeBTBehaviorLeaf : SQEX.Ebony.AIGraph.Node.BT.Behavior.AIGraphNodeBTBehaviorBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.AIGraph.Node.BT.Behavior.AIGraphNodeBTBehaviorLeaf", 0, SQEX.Ebony.AIGraph.Node.BT.Behavior.AIGraphNodeBTBehaviorLeaf.ObjectType, Construct, properties, 0, 224);
        }
        ...
        protected override PropertyContainer GetFieldProperties()
        {
			...
			fieldProperties.AddProperty(new Property("leafIndex_", 2052148300, "int", 216, 4, 1, Property.PrimitiveType.Int32, 0, (char)0));
        ...
        {
            return new AIGraphNodeBTBehaviorLeaf();
        }
