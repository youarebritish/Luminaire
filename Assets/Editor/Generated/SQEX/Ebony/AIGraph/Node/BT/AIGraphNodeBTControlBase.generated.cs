...
namespace SQEX.Ebony.AIGraph.Node.BT
{
    public partial class AIGraphNodeBTControlBase : SQEX.Ebony.AIGraph.Node.BT.AIGraphNodeBTBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.AIGraph.Node.BT.AIGraphNodeBTControlBase", 0, SQEX.Ebony.AIGraph.Node.BT.AIGraphNodeBTControlBase.ObjectType, Construct, properties, 0, 200);
        }
        ...
        {
            return new AIGraphNodeBTControlBase();
        }
