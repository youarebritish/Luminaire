...
namespace SQEX.Ebony.AIGraph.Node.BT.Composite
{
    public partial class AIGraphNodeBTCompositeParallel : SQEX.Ebony.AIGraph.Node.BT.Composite.AIGraphNodeBTCompositeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.AIGraph.Node.BT.Composite.AIGraphNodeBTCompositeParallel", 0, SQEX.Ebony.AIGraph.Node.BT.Composite.AIGraphNodeBTCompositeParallel.ObjectType, Construct, properties, 0, 216);
        }
        ...
        {
            return new AIGraphNodeBTCompositeParallel();
        }
