...
namespace SQEX.Ebony.AIGraph.Node.BT.Composite
{
    public partial class AIGraphNodeBTCompositeAllPassParallel : SQEX.Ebony.AIGraph.Node.BT.Composite.AIGraphNodeBTCompositeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.AIGraph.Node.BT.Composite.AIGraphNodeBTCompositeAllPassParallel", 0, SQEX.Ebony.AIGraph.Node.BT.Composite.AIGraphNodeBTCompositeAllPassParallel.ObjectType, null, properties, 0, 208);
        }
