...
namespace SQEX.Ebony.AIGraph.Node.BT.Composite
{
    public partial class AIGraphNodeBTCompositePriorityUpActiveSelector : SQEX.Ebony.AIGraph.Node.BT.Composite.AIGraphNodeBTCompositeActiveSelector
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.AIGraph.Node.BT.Composite.AIGraphNodeBTCompositePriorityUpActiveSelector", 0, SQEX.Ebony.AIGraph.Node.BT.Composite.AIGraphNodeBTCompositePriorityUpActiveSelector.ObjectType, Construct, properties, 0, 216);
        }
        ...
        {
            return new AIGraphNodeBTCompositePriorityUpActiveSelector();
        }
