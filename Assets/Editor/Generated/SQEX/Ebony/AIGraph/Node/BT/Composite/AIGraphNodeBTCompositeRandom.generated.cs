...
namespace SQEX.Ebony.AIGraph.Node.BT.Composite
{
    public partial class AIGraphNodeBTCompositeRandom : SQEX.Ebony.AIGraph.Node.BT.Composite.AIGraphNodeBTCompositeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.AIGraph.Node.BT.Composite.AIGraphNodeBTCompositeRandom", 0, SQEX.Ebony.AIGraph.Node.BT.Composite.AIGraphNodeBTCompositeRandom.ObjectType, Construct, properties, 0, 224);
        }
        ...
        {
            return new AIGraphNodeBTCompositeRandom();
        }
