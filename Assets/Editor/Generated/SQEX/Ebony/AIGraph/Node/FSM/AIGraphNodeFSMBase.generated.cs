...
namespace SQEX.Ebony.AIGraph.Node.FSM
{
    public partial class AIGraphNodeFSMBase : SQEX.Ebony.AIGraph.Node.AIGraphNodeBase
    {
        ...
        new public static void SetupObjectType()
        {
            ...
            ObjectType = new ObjectType("SQEX.Ebony.AIGraph.Node.FSM.AIGraphNodeFSMBase", 0, SQEX.Ebony.AIGraph.Node.FSM.AIGraphNodeFSMBase.ObjectType, Construct, properties, 0, 192);
        }
