...
namespace Black.Save.AbilityTree
{
    ...
    public partial class SaveAbilityTreeStruct
    {
		...
		[UnityEngine.SerializeReference] public List<Black.Save.AbilityTree.SaveAbilityTreeEntityStruct> enableAbilityTreeEntityList= new List<Black.Save.AbilityTree.SaveAbilityTreeEntityStruct>();
		[UnityEngine.SerializeReference] public List<uint> releaseBlockAbilityTreeEntityIdList= new List<uint>();
