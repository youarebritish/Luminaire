...
namespace Black.Sequence.Actor.AI.Monster
{
    ...
    public partial class SequenceActionAIChangeEmotion : Black.Sequence.Actor.SequenceActionActorBase
    {
		...
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableInputPin tensionPinValue_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
