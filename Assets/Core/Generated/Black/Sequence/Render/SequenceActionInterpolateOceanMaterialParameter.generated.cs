...
namespace Black.Sequence.Render
{
    ...
    public partial class SequenceActionInterpolateOceanMaterialParameter : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
		...
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableInputPin interpolationTimePin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
		public float interpolationTime_;
		[UnityEngine.SerializeReference] public List<Black.Entity.Material.MaterialParameterColor> materialParamColor_= new List<Black.Entity.Material.MaterialParameterColor>();
		[UnityEngine.SerializeReference] public List<Black.Entity.Material.MaterialParameterValue1> materialParamValue1_= new List<Black.Entity.Material.MaterialParameterValue1>();
		[UnityEngine.SerializeReference] public List<Black.Entity.Material.MaterialParameterValue4> materialParamValue4_= new List<Black.Entity.Material.MaterialParameterValue4>();
