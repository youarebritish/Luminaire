...
namespace Black.Sequence.Action.Quest
{
    ...
    public partial class SequenceActionQuestLottery : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
		...
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableOutputPin fixIdPin_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableInputPin incidencePin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
