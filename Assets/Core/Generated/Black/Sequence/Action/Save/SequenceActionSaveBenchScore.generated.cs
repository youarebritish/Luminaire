...
namespace Black.Sequence.Action.Save
{
    ...
    public partial class SequenceActionSaveBenchScore : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
		...
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableInputPin timeSpanPin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableInputPin scorePin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
