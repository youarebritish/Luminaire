...
namespace Black.Sequence.Action.Level.Nifl
{
    ...
    public partial class SequenceActionSearchNoctis : Black.Sequence.Actor.SequenceActionActorBase
    {
		...
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableInputPin searchActorList_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
		[UnityEngine.SerializeReference] public SQEX.Ebony.Framework.Node.GraphVariableOutputPin perceivedActor_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
