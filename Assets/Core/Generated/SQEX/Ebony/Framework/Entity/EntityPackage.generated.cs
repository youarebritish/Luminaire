...
namespace SQEX.Ebony.Framework.Entity
{
    ...
    public partial class EntityPackage : SQEX.Ebony.Framework.Entity.EntityPackageReference
    {
		...
		[UnityEngine.SerializeReference] public List<Luminous.Core.Object.Object> loadedObjects_= new List<Luminous.Core.Object.Object>();
		[UnityEngine.SerializeReference] public List<string> loadedObjectNames_= new List<string>();
		[UnityEngine.SerializeReference] public List<string> loadedObjectPaths_= new List<string>();
		public int sequenceUpdateOrderPreset_;
		public short sequenceUpdateOrderDirect_;
		[UnityEngine.SerializeReference] public List<SQEX.Ebony.Framework.Entity.EntityPackageSharedRefItem> entityPackageSharedChildPathList_= new List<SQEX.Ebony.Framework.Entity.EntityPackageSharedRefItem>();
